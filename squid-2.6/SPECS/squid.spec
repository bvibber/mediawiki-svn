...
ln -s %{_datadir}/squid/errors/Wikimedia $RPM_BUILD_ROOT/etc/squid/errors
...
if [ $1 = 0 ]; then
  ln -snf %{_datadir}/squid/errors/Wikimedia /etc/squid/errors
fi
...
- Change handling of Wikimedia error pages; fetch the latest ones from
  ...
  include a new language directory 'Wikimedia'.

* Sat Apr 29 2006 Mark Bergsma <mark@nedworks.org> 7:2.5.STABLE13-5.WM
