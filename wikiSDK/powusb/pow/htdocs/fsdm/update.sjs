...
//php update query
//$upQuery = "UPDATE  $table SET $updata WHERE id=\"$pickrow\"";
//example
// UPDATE Person
...
document.write("</table><br><INPUT TYPE='SUBMIT' Name='submit' VALUE='Update Row with ID of "+ uprow +"'></form><hr/>");
document.write("");
document.write("");
document.write("");
