 ...
 */
public abstract class ExtractorApp<S extends WikiWordConceptStoreBuilder<? extends WikiWordConcept>> extends CliApp<S> {
	...
	public ExtractorApp(String agendaTask, boolean allowGlobal, boolean allowLocal) { //TODO: agenda-params!
