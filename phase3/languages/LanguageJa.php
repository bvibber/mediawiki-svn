...
'editing' => '$1 を編集中',
'editingsection'=>'(セクション)',
'editingcomment'=>'(新規コメント)',
'editconflict' => '編集競合:',
...
'viewdeletedpage' => '削除された記事の削除記録と履歴',
...
'undeletehistorynoadmin' => 'このページは削除されたことがあります。削除の理由と、削除される前の履歴が下に示されています。削除された各版の内容は管理者のみが閲覧できます。',
