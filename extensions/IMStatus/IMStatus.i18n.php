...
$messages['en'] = array(
        'imstatus_desc' => 'Adds tags to show various IM online status (AIM, Google Talk, ICQ, MSN/Live Messenger, Skype, Xfire, Yahoo)',
        ...
        'imstatus_aim_presence' => '$1 shows your status with a link that will launch AIM (provided the user has it installed) to send you an IM.',
        ...
        'imstatus_gtalk_height' => 'height of the box, in pixel.',
        'imstatus_gtalk_width' => 'width of the box, in pixel.',
...
<a href="$1">your live messenger options</a>. The id you need to provide is the numbers and letters between "$2" and "$3".',
 
        'imstatus_skype_nbstyle' => 'NB: if you choose a style which is also an action, your action choice will be overridden by the action matching your chosen style.',
...
$messages['de'] = array(
        'imstatus_desc' => 'Fügt Tags hinzu um den Online-Status verschiedener Instant-Messenger anzuzeigen (AIM, Google Talk, ICQ, MSN/Live Messenger, Skype, Xfire, Yahoo)',
        'imstatus_syntax' => 'Syntax',
        ...
        'imstatus_aim_api' => '$1 zeigt deinen Status mit einem Link der eine <b>Browser</b>, JavaScript Version von AIM startet um die eine nachricht zu senden.',
