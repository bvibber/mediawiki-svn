...
<p>המנצח בהצבעה ייקבע באמצעות שיטת שולץ.</p>
...
<li><a href=\"http://en.wikipedia.org/wiki/Schulze_method\" class=\"external\">שיטת שולץ</a></li></ul>",
	'boardvote_intro_change'  => "<p>כבר הצבעתם בעבר. עם זאת, באפשרותכם לשנות את הצבעתכם באמצעות הטופס שלמטה. אנא דרגו את המועמדים בהתאם לרצונכם, כאשר מספר קטן יותר מבטא העדפה רבה יותר למועמד זה.</p>",
