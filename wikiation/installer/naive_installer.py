...
class Naive_Installer_Exception(Extension_Installer_Exception):
	pass

class Unsupported_Exception(Exception):
	pass

class Naive_Installer(Installation_System):
	...
	def is_installed(self, installer_name):
		if self.revision==None:
			raise Naive_Installer_Exception("no revision specified ... did you try doing   ...  in <Revision> ?")
