...
if(range.endContainer!=body||range.endOffset==0){post+="\n";}}
...
var startNode=s.node;var startDepth=s.depth;if(s.offset>0){startNode=startNode.splitText(s.offset);}
while(startNode.nodeName=='BR'){start++;s=context.fn.getOffset(start);startNode=s.node;startDepth=s.depth;}
var end=markers[i].end;var e=context.fn.getOffset(end);if(!e){continue;}
var endNode=e.node;var endDepth=e.depth;if(e.offset<e.length-1){endNode.splitText(e.offset+1);}
