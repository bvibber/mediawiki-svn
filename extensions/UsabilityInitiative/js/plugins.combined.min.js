...
var markers=context.modules.highlight.markers;markers.sort(function(a,b){return a.start-b.start||a.end-b.end;});var pos=0;var node=context.$content.get(0);var next=null;var i=0;var startNode=null;var depth=0,nextDepth=0,startDepth=null;while(node.firstChild){node=node.firstChild;depth++;}
...
next=p;if(node.nodeName!='#text'){if(node.nodeName=='BR')
pos++;node=next;depth=nextDepth;continue;}
...
if(ca1&&ca2){var newNode=markers[i].wrapElement;if(typeof newNode=='function')
newNode=newNode();if(newNode.jquery)
newNode=newNode.get(0);var commonAncestor=ca1.parentNode;var nextNode=ca2.nextSibling;var n=ca1;while(n!=nextNode){var ns=n.nextSibling;newNode.appendChild(n);n=ns;}
if(nextNode)
commonAncestor.insertBefore(newNode,nextNode);else
