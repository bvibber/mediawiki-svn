...
/**
 * Report generates a list of long content pages
 *
 * @addtogroup Reports
 * @author Rob Church <robchur@gmail.com>
 */
class LongPagesReport extends Report {
	...
	public function getHeader() {
		global $wgUser, $wgLongPagesThreshold;
		return wfMsgExt( 'longpages-header', 'parse',
			$wgUser->getSkin()->formatSize( $wgLongPagesThreshold ) );
	}
	...
	public function getExtraConditions( $dbr ) {
		return array(
			'page_len > ' . intval( $GLOBALS['wgLongPagesThreshold'] )
		);
	}
