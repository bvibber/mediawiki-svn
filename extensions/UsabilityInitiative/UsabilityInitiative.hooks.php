...
class UsabilityInitiativeHooks {
	...
	private static $styleFiles = array(
		'base_sets' => array(
			...
			'combined' => array(
				array( 'src' => 'css/combined.css', 'version' => 77 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
			'minified' => array(
				array( 'src' => 'css/combined.min.css', 'version' => 77 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
		)
	);
	...
	private static $scriptFiles = array(
		...
		'base_sets' => array(
			'raw' => array(
				...
				array( 'src' => 'js/plugins/jquery.wikiEditor.js', 'version' => 177 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.highlight.js', 'version' => 51 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.toolbar.js', 'version' => 52 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.dialogs.js', 'version' => 21 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.toc.js', 'version' => 97 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.preview.js', 'version' => 11 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.templateEditor.js', 'version' => 67 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.publish.js', 'version' => 4 ),
			),
			'combined' => array(
				array( 'src' => 'js/plugins.combined.js', 'version' => 354 ),
			),
			'minified' => array(
				array( 'src' => 'js/plugins.combined.min.js', 'version' => 354 ),
			),
		),
	);
