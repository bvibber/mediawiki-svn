...
/* From: (Loreley) Id: access.h 18025 2006-11-30 07:11:05Z river */
/* $Id$ */
...
struct access_list {
	 ...
	 * \throws invalid_prefix if the prefix could not be parsed.
	 */
	void	allow	(std::string const &pfx, uint16_t flags = 0);
	 ...
	 * \throws invalid_prefix if the prefix could not be parsed.
	 */
	void	deny	(std::string const &pfx, uint16_t flags = 0);
