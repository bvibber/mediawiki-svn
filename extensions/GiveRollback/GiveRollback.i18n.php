...
'ar' => array(
	...
	'giverollback-header' => '\'\'\'بيروقراط محلي يمكن أن يستخدم هذه الصفحة لمنح أو سحب [[{{MediaWiki:Giverollback-page}}|صلاحيات الاسترجاع]] لحساب مستخدم آخر.\'\'\'<br />هذا يمكن أن يستخدم للسماح لغير الإداريين باسترجاع التخريب سريعا. هذا يجب أن ينفذ بالتوافق مع السياسات المطبقة.',
