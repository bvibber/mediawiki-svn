...
$j(this).find('[rel]').each(function(){$j(this).text(gM($j(this).attr('rel')));});$j('#wikieditor-toolbar-link-int-target, #wikieditor-toolbar-link-int-text').focus(function(){if($j(this).val()==$j(this).prev('label').text())
$j(this).val('').removeClass('wikieditor-toolbar-dialog-hint');}).bind('blur change',function(){if($j(this).val()=='')
$j(this).val($j(this).prev('label').text()).addClass('wikieditor-toolbar-dialog-hint');}).trigger('focus').prev('label').css('display','none');$j('#wikieditor-toolbar-link-int-target').bind('change keydown paste cut',function(){setTimeout(function(){if(isExternalLink($j('#wikieditor-toolbar-link-int-target').val()))
