...
$options = getopt( 'b:e:h' );

if ( isset( $options['h'] ) ) {
	$line = "bugzilla_report.php: usage bugzilla_report.php [-b|-e] \n";
	$line .= "	-b start date\n";
	$line .= "	-e end date\n";
