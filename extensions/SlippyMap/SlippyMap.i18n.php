 ...
 */
$messages['ru'] = array(
	'slippymap_desc' => 'Позволяет использовать тег <tt><nowiki>&lt;slippymap&gt;</nowiki></tt> для отображения карт OpenLayers. Карты с [http://openstreetmap.org openstreetmap.org]',
	'slippymap_latmissing' => 'Отсутствует значение lat (для широты).',
	'slippymap_lonmissing' => 'отсутствует значение lon (для долготы).',
	'slippymap_zoommissing' => 'Отсутствует значение z (для масштаба).',
	'slippymap_longdepreciated' => 'Пожалуйста, используйте «lon» вместо «long» (параметр переименован).',
	'slippymap_widthnan' => 'значение ширины (width, w) «%1» не является целым числом',
	'slippymap_heightnan' => 'значение высоты (height, h) «%1» не является целым числом',
	'slippymap_zoomnan' => 'значение масштаб (zoom, z) «%1» не является целым числом',
	'slippymap_latnan' => 'значение широты (latitude, lat) «%1» не является целым числом',
	'slippymap_lonnan' => 'значение долготы (longitude, lon) «%1» не является целым числом',
	'slippymap_widthbig' => 'значение ширины (width, w) не может быть больше 1000',
	'slippymap_widthsmall' => 'значение ширины (width, w) не может быть меньше 100',
	'slippymap_heightbig' => 'значение высоты (height, h) не может быть больше 1000',
	'slippymap_heightsmall' => 'значение высоты (height, h) не может быть меньше 100',
	'slippymap_latbig' => 'значение широты (latitude, lat) не может быть больше 90',
	'slippymap_latsmall' => 'значение широты (latitude, lat) не может быть меньше -90',
	'slippymap_lonbig' => 'значение долготы (longitude, lon) не может быть больше 180',
	'slippymap_lonsmall' => 'значение долготы (longitude, lon) не может быть меньше -180',
	'slippymap_zoomsmall' => 'значение масштаба (zoom, z) не может быть меньше 0',
	'slippymap_zoom18' => "значение масштаба (zoom, z) не может быть больше 17. Заметьте, что этот перехватчик расширения MediaWiki внедряется в слой  OpenStreetMap 'osmarender', который не выходит за уровень масштабирования 17. Слой Mapnik, доступный на on openstreetmap.org, доходит до масштаба 18.",
	'slippymap_zoombig' => 'значение масштаба (zoom, z) не может быть больше 17.',
	'slippymap_invalidlayer' => 'Неверное значение «%1» для «layer»',
