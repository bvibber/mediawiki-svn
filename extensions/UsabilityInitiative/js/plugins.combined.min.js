...
return cacheSupport(true);},'isRequired':function(module,req){if(typeof $.wikiEditor.modules[module]['req']!=='undefined'){for(req in $.wikiEditor.modules[module]['req']){if($.wikiEditor.modules[module]['req'][req]=='iframe'){return true;}}}
