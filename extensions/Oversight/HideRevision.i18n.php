...
$messages['ru'] = array(
	...
	'right-oversight'             => 'просмотр ранее скрытых правок',
	...
	'hiderevision-text'           => "Данная страница должна использоваться '''только''' в случае разглашения личной информации —''реальные имя и фамилия, домашние адреса и номера телефонов, паспортов, и т. п.''.

'''Злоупотребление данной системой повлечёт за собой лишение прав ревизора.'''

Скрытые версии страниц не будут видны через интерфейс MediaWiki, но они записываются в журнал и могут быть восстановлены администратором базы данных, если вы случайно сделаете ошибку.",
	...
	'hiderevision-error-current'  => 'Невозможно скрыть текущую версию страницы. Сначала откатите изменения',
...
*Скрытая версия была первой',
	...
	'oversight'                   => 'Журнал скрытия правок',
	...
	'oversight-header'            => 'Ниже приведены правки, которые недавно были скрыты. Распространение данной информации может повлечь лишение прав ревизора.',
);
