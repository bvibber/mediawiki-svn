...
$messages['ml'] = array(
	...
	'imagemap_no_image' => 'പിശക്: ഒന്നാമത്തെ വരിയില്‍ ഒരു ചിത്രത്തിന്റെ പേരു വേണം',
	'imagemap_invalid_image' => 'പിശക്: ചിത്രം അസാധുവാണ്‌ അല്ലെങ്കില്‍ നിലവിലില്ല',
	'imagemap_bad_image' => 'പിശക്: ഈ താളിൽ ചിത്രം കരിമ്പട്ടികയിലാണ്',
	'imagemap_no_link' => 'പിശക്: $1-മത്തെ വരിയുടെ അവസാനം സാധുവായ കണ്ണി കാണുന്നില്ല',
	'imagemap_invalid_title' => 'പിശക്: $1 വരിയില്‍ അസാധുവായ തലക്കെട്ട്',
	'imagemap_missing_coord' => 'പിശക്: $1 വരിയില്‍ രൂപത്തിന് ആവശ്യമുള്ളത്ര നിര്‍ദ്ദേശാങ്കങ്ങള്‍ നിര്‍‌വചിച്ചിട്ടില്ല.',
	'imagemap_unrecognised_shape' => 'പിശക്: $1 വരിയില്‍ മനസ്സിലാക്കാന്‍ പറ്റാത്ത രൂപം. ഓരോ വരിയും ഇനി പറയുന്ന ഒന്നു കൊണ്ടു വേണം തുടങ്ങാന്‍: default, rect, circle അഥവാ poly',
	'imagemap_no_areas' => 'പിശക്: കുറഞ്ഞത് ഒരു വിസ്തീര്‍ണ്ണ നിര്‍ദ്ദേശമെങ്കിലും കൊടുത്തിരിക്കണം',
	'imagemap_invalid_coord' => 'പിശക്: $1 വരിയില്‍ അസാധുവായ നിര്‍ദ്ദേശാങ്കം. നിര്‍ബന്ധമായും അത് ഒരു സംഖ്യയായിരിക്കണം.',
	'imagemap_invalid_desc' => 'പിശക്: അസാധുവായ വിവരണ നിര്‍ദ്ദേശം. ഇനി പറയുന്ന ഇനങ്ങളില്‍ ഒന്നായിരിക്കണം: <tt>$1</tt>',
