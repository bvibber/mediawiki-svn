...
$messages['be-tarask'] = array(
	...
	'tablemod-error-headcount' => 'Гэты тэг падтрымлівае толькі табліцы з загалоўкам у адзін слупок пад час выдаленьня.',
...
$messages['hsb'] = array(
	...
	'tablemod-error-headcount' => 'Tuta taflička podpěruje jenož jednotliwe špaltowe hłowy pži wotstronjenju.',
...
$messages['ja'] = array(
	...
	'tablemod-error-headcount' => 'このタグは、除去操作に関して、ヘッダーの各列が複数のセルにまたがらないテーブルにのみ対応します。',
...
$messages['mk'] = array(
	...
	'tablemod-error-headcount' => 'Оваа ознака поддржува само едноколонски колон-цифри (заглавија) при отстранување.',
