...
$wgMessageCache->addMessages(
	array(
		...
		'tasks_create_header' => 'Crééer une nouvelle tâche',
		...
		'tasks_here' => 'ici',
		'tasks_returnto' => 'Vous allez être redirigés maintenant. Si vous ne l\'êtes pas, cliquez $1.',
		'tasks_see_page_tasks' => '(tâches de la page)',
		'tasks_task_is_assigned' => '(assignée)',
		'tasks_plain_text_only' => '(texte brute seulement)',
...
//		'tasks_link_your_assignments' => "open assignments",
		...
		'tasks_search_no_tasks_chosen_note' => '(Aucune selection, recherche de tout types de tâches.)',
