 ...
 */
$messages['ru'] = array(
	'slippymap_desc' => 'Позволяет использовать тег <tt><nowiki>&lt;slippymap&gt;</nowiki></tt> для отображения карт OpenLayers. Карты из [http://openstreetmap.org openstreetmap.org]',
	'slippymap_latmissing' => 'Отсутствует значение lat (для широты).',
	'slippymap_lonmissing' => 'отсутствует значение lon (для долготы).',
	'slippymap_zoommissing' => 'Отсутствует значение z (для уровня приближения).',
	'slippymap_longdepreciated' => "Пожалуйста, используйте 'lon' вместо 'long' (параметр переименован).",
	'slippymap_widthnan' => "значение width (w) '%1' не является верным целым числом",
	'slippymap_heightnan' => "значение height (h) '%1' не является верным целым числом",
	'slippymap_zoomnan' => "значение zoom (z) '%1' не является верным целым числом",
	'slippymap_latnan' => "значение latitude (lat) '%1' не является верным целым числом",
	'slippymap_lonnan' => "значение longitude (lon) '%1' не является верным целым числом",
	'slippymap_widthbig' => 'значение width (w) не может быть больше 1000',
	'slippymap_widthsmall' => 'значение width (w) не может быть меньше 100',
	'slippymap_heightbig' => 'значение height (h) не может быть больше 1000',
	'slippymap_heightsmall' => 'значение height (h) не может быть меньше 100',
	'slippymap_latbig' => 'значение latitude (lat) не может быть больше 90',
	'slippymap_latsmall' => 'значение latitude (lat) не может быть меньше -90',
