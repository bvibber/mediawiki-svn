...
/* private */ $wgValidSpecialPagesZh = array(
	"Userlogin"		=> "",
	"Userlogout"	=> "",
	"Preferences"	=> "设置我的用户参数", /* Set my user preferences */
	"Watchlist"		=> "我的查看列表", /* My watchlist */
	"Recentchanges" => "近期改动页面",  /* Recently updated pages */
	"Upload"		=> "上载图像文件",  /* Upload image files */
...
/* private */ $wgSysopSpecialPagesZh = array(
	...
	"Undelete"		=> "查看并恢复被删页面"  /* View and restore deleted pages */
);
