...
class ImageMap {
	...
	static function render( $input, $params, $parser ) {
		global $wgScriptPath, $wgUser, $wgUrlProtocols, $wgNoFollowLinks, $wgAllowExternalImages;
		...
		foreach ( $lines as $line ) {
			...
			} elseif ( in_array( substr( $link , 1 , strpos($link, '//' )+1 ) , $wgUrlProtocols ) || in_array( substr( $link , 1 , strpos($link, ':' ) ) , $wgUrlProtocols ) && $wgAllowExternalImages ) {
