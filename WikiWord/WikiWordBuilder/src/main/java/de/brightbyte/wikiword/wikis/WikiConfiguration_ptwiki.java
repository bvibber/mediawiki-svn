...
public class WikiConfiguration_ptwiki extends WikiConfiguration {
	...
	public WikiConfiguration_ptwiki() {
		...
		resourceTypeSensors.add( new HasTemplateLikeSensor<ResourceType>(ResourceType.BAD, "^(Elimina\u00e7\u00e3o_r\u00e1pida|Er1|Apagar2|VDA2|Copyright2)$", 0));
		
	   //resourceTypeSensors.add( new HasTemplateLikeSensor<ResourceType>(ResourceType.BAD, "^ambox$", 0, ....));
	}
