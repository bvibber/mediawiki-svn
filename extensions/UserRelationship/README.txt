...
require_once("$IP/extensions/UserRelationship/SpecialAddRelationship.php");
require_once("$IP/extensions/UserRelationship/SpecialRemoveRelationship.php");
require_once("$IP/extensions/UserRelationship/SpecialViewRelationshipRequests.php");
require_once("$IP/extensions/UserRelationship/SpecialViewRelationships.php");
$wgAutoloadClasses["UserRelationship"] = "$IP/extensions/UserRelationship/UserRelationshipClass.php";
