 ...
 * install and upgrade. So you shouldn't put normal messages here.
 */
...
* [http://www.mediawiki.org/wiki/Manual:FAQ FAQ]",
	...
	'config-imagemagick'              => 'Found ImageMagick: <tt>$1</tt>.
	...
	'config-dir-not-writable'         => "<strong>Error:</strong> Can't write config file. Installation aborted.
	...
	<br/><br/>
	In <b>binary mode</b>, MediaWiki stores UTF-8 text to the database in binary fields.
	This is more efficient than MySQL's UTF-8 mode, and allows you to use the full range of Unicode characters.
	In <b>UTF-8 mode</b>, MySQL will know what character set your data is in, and can present and convert it appropriately,
	...
	'config-db-schema-help'           => 'The above schemas are usually correct. Only change them if you know you need to.',
	...
	'config-unknown-collation'        => '<strong>Warning:</strong> Datbase is using unrecognised collation.',
	...
	'config-email-auth-help'          => "If this option is enabled, users have to confirm their e-mail address using a magic link sent to them whenever they set or change it, and only authenticated e-mail addresses can receive mails from other users or
	change notification mails. Setting this option is '''recommended''' for public wikis because of potential abuse of the e-mail features.",
	...
	'config-cache-help'               => 'Object caching is used to improve the speed of MediaWiki by caching frequently used data. Medium to large sites
