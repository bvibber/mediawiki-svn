...
[[Special:Boardvote/entry|Tilbake]]',
	...
	'boardvote_notloggedin'  => 'Du er ikke logget inn. Du må bruke en konto med minst $1&nbsp;redigeringer før $2, og må ha redigert før $3 for å stemme.',
...
* [[Special:Boardvote/dump|Переглянути зашифрований запис голосів]]',
	'boardvote_intro'        => '<p>Ласкаво просимо на другі вибори до Ради Опікунів Вікімедіа. Ми голосуємо за двох чоловік що представлятимуть спільноту користувачів усіх проектів Вікімедіа. Вони, особисто і як члени групи, допомагатимуть визначити напрями майбутнього розвитку проектів Вікімедіа, та представлятимуть <em>Ваші</em> інтереси та турботи Раді Опікунів. Вони також прийматимуть рішення стосовно шляхів отримання коштів та їх використання.</p> <p>Перед тим як проголосувати, будь-ласка ознайомтесь із програмами кандидатів та їх відповідями на запитання що були їм задані протягом ознайомчого періоду. Кожен із кандидатів є поважаним користувачем, кожен із них пожертвував значний час та зусилля щоб створити сприятливе оточення у цих проектах для поширення та накопичення людських знань.</p> <p>Ви можете проголосувати за стількох кандидатів за скількох бажаєте. Кандидат із найбільшою підтримкою на кожну позицію стане переможцем для цієї позиції. У випадку нічиєї, буде призначено другий тур виборів.</p> <p>Щоб отримати додаткову інформацію, див.:</p> <ul><li><a href="http://meta.wikipedia.org/wiki/Election_FAQ_2006" class="external">ЧаП Виборів</a></li> <li><a href="http://meta.wikimedia.org/wiki/Election_candidates_2006/Uk" class="external">Кандидати</a></li></ul>',
	'boardvote_entered'      => 'Дякуємо, Ваш голос прийнято. Якщо бажаєте, Ви можете записати наступні подродиці що стосуються Вашого голосу. Номер запису Вашого голосування: <pre>$1</pre> Його зашифровано із публічним ключем Розпорядників Виборів: <pre>$2</pre> Зашифрована версія наводиться нижче. Вона буде загальнодоступною на [[Special:Boardvote/dump]]. <pre>$3</pre> [[Special:Boardvote/entry|Назад]]',
	'boardvote_nosession'    => "Я не можу ідентифікувати Вас як користувача Вікімедіа. Будь-ласка увійдійть до вікі в котрій Ви кваліфіковані для голосування та відвідайте <nowiki>[[Special:Boardvote]]</nowiki>. Голосувати можуть ті хто зробив щонайменше $1 внесків не пізніше $2, а перше редагуванн було не пізніше $3. Зауважте, Ви повинні налаштувати свого оглядача веб-сторінок так, щоб він дозволив cookies нашому зовнішньому серверу голосування: '''wikimedia.spi-inc.org'''.",
	'boardvote_notloggedin'  => 'Ви не ввійшли в систему. Щоб проголосувати, Вами повинно бути зроблено щонайменше $1 редагувань до $2.',
	'boardvote_notqualified' => 'Перепрошуємо, але Вам належить тільки $1 редагувань зроблених до $2. Ви повинні мати щонайменше $3 редагувань щоб мати право голосу. Або Ваше перше редагування на українській Вікіпедії було $4, а має бути до $5.',
...
У зашифрованому вигляді вони доступні $1.</p>',
	'boardvote_dumplink'     => 'Натисніть тут',
	...
	'boardvote_redirecting'  => "З метою запобігти можливі маніпулювання та підвищити прозорість ходу виборів, вирішено проводити процес голосування на зовнішньому незалежно контрольованому сервері. Через 20 секунд Ви будете перенаправлені на цей сервер. [$1 Клацніть сюди], якщо Ви хочете перейти негайно. Можливо з'явиться попередження про непідписаний сертифікат безпеки.",
);
