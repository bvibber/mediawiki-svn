...
$messages['ja'] = array(
	...
	'changeauthor-explanation-single' => 'このフォームから特定版投稿者を変更することができます。利用者名を下のリストから選択し、編集内容の要約を付記し（任意です）、変更ボタンを押してください。',
	...
	'changeauthor-logentry' => '$1 の$2の投稿者を $3 から $4 へ変更しました',
