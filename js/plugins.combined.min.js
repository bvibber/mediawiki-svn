...
$element.trigger('scrollToTop');},'beforeSelection':function(class,strict){if(typeof class=='undefined'){class='';}
...
e=newE||e;}
var classStr=' '+class+' ';while(e){if(!strict&&(!class||(' '+e.className+' ').indexOf(classStr)!=-1)){return $(e);}
