...
while(oldParent.firstChild){startNode.parentNode.insertBefore(oldParent.firstChild,afterStart);}}else{if(lastP!=t.inP){startNode.parentNode.appendChild(startNode.ownerDocument.createElement('br'));}
while(oldParent.firstChild){startNode.parentNode.appendChild(oldParent.firstChild);}}
