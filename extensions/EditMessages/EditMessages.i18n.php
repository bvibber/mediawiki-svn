...
$messages['en'] = array(
	...
	'editmsg-warning-file'     => '* File read errors were encountered for the following {{PLURAL:$2|language|languages}}: $1',
	'editmsg-warning-mismatch' => '* The original text did not have the expected value for the following {{PLURAL:$2|language|languages}}: $1',
...
$messages['de'] = array(
	...
	'editmsg-warning-file' => '* Es ist ein Dateilesefehler für die {{PLURAL:$2|folgende Sprache|folgenden Sprachen}} aufgetreten: $1',
	'editmsg-warning-mismatch' => '* Der Originaltext hat nicht den erwarteten Wert für die {{PLURAL:$2|folgende Sprache|folgenden Sprachen}}: $1',
...
$messages['fr'] = array(
	...
	'editmsg-warning-file' => 'Des erreurs de lecture du fichier ont été relevées pour {{PLURAL:$2|la langue suivante|les langues suivantes}} : $1',
	'editmsg-warning-mismatch' => '* Le texte original n’a pas pris la valeur attendue pour {{PLURAL:$2|la langue suivante|les langues suivantes}} : $1',
...
$messages['grc'] = array(
	...
	'editmsg-get-patch' => 'Παράγειν συρραφήν',
	'editmsg-new-search' => 'Νέα ζήτησις',
	'editmsg-warning-parse1' => '* Συνήθης ἔκφρασις ὀνομάτων μηνυμάτων μὴ ἀντιστοιχoῦσα: $1',
	'editmsg-warning-parse2' => '* Χαρακτὴρ παραθέσεων ἀναμενόμενος μετὰ τὴν σειράν: $1',
	'editmsg-warning-parse3' => '* Τὸ πέρας τοῦ ὁρμαθοῦ τιμῶν μὴ εὑρεθὲν ἐστίν: $1',
	'editmsg-warning-file' => '* Σφάλματα ἀναγνώσεως ἀρχείων ἀπηντήθησαν διὰ {{PLURAL:$2|τήν ἀκόλουθον γλῶσσαν|τὰς ἀκολούθους γλώσσας}}: $1',
	'editmsg-warning-mismatch' => '* Τὸ πρωτότυπον κείμενον δὲν εἶχε τὴν ἀναμενομένην τιμὴν διὰ {{PLURAL:$2|τήν ἀκόλουθον γλῶσσαν|τὰς ἀκολούθους γλώσσας}}: $1',
	'editmsg-apply-patch' => 'Ὲφαρμόττειν συρραφήν',
	'editmsg-no-patch' => 'Ἀδύνατος ἡ ἐκτέλεσις τῆς ἐντολῆς "συρράφειν"',
	'editmsg-patch-failed' => 'Ἡ συρραφὴ ἀπετεύχθη μετὰ καταστάσεως ἐξόδου $1',
...
$messages['he'] = array(
	...
	'editmsg-warning-file' => '* אירעו שגיאות קריאת קובץ ב{{PLURAL:$2|שפה הבאה|שפות הבאות}}: $1',
	'editmsg-warning-mismatch' => '* לטקסט המקורי אין את הערך הצפוי ב{{PLURAL:$2|שפה הבאה|שפות הבאות}}: $1',
...
$messages['ia'] = array(
	...
	'editmsg-warning-file' => '* Errores de lectura de files se incontrava pro le sequente {{PLURAL:$2|lingua|linguas}}: $1',
	'editmsg-warning-mismatch' => '* Le texto original non habeva le valor expectate pro le sequente {{PLURAL:$2|lingua|linguas}}: $1',
...
$messages['nl'] = array(
	...
	'editmsg-warning-file' => '* Er zijn fouten gevonden bij het lezen van de volgende {{PLURAL:$2|taal|talen}}: $1',
	'editmsg-warning-mismatch' => '* De oorspronkelijke tekst had niet de verwachte waarde voor de volgende {{PLURAL:$2|taal|talen}}: $1',
...
$messages['pt'] = array(
	...
	'editmsg-apply-patch' => 'Aplicar correcção',
	'editmsg-no-patch' => 'Não foi possível executar comando de correcção "patch"',
	'editmsg-patch-failed' => 'Aplicação de correcção falhou com estado de saída $1',
...
$messages['sk'] = array(
	...
	'editmsg-warning-file' => '* Vyskytli sa chyby pri čítaní súborov {{PLURAL:$2|nasledovného jazyka|nasledovných jazykov}}: $1',
	'editmsg-warning-mismatch' => '* Pôvodný text neobsahoval očakávanú hodnotu v {{PLURAL:$2|nasledovnom jazyku|nasledovných jazykoch}}: $1',
...
$messages['vi'] = array(
	...
	'editmsg-warning-file' => '* Lỗi đọc tập tin đối với {{PLURAL:$2|ngôn ngữ|các ngôn ngữ}} sau: $1',
	'editmsg-warning-mismatch' => '* Văn bản gốc không có giá trị mong đợi cho {{PLURAL:$2|ngôn ngữ|các ngôn ngữ}} sau: $1',
