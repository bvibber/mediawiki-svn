...
$j(this).find('[rel]').each(function(){$j(this).text(gM($j(this).attr('rel')));});$j('#wikieditor-toolbar-link-int-target, #wikieditor-toolbar-link-int-text').each(function(){if($j(this).val()=='')
$j(this).val($j(this).prev('label').text()).addClass('wikieditor-toolbar-dialog-hint').prev('label').css('display','none');}).focus(function(){$j(this).removeClass('wikieditor-toolbar-dialog-hint');if($j(this).val()==$j(this).prev('label').text())
$j(this).val('');}).bind('blur change',function(){if($j(this).val()=='')
$j(this).val($j(this).prev('label').text()).addClass('wikieditor-toolbar-dialog-hint');else
