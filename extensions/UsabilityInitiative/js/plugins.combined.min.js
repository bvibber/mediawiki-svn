...
return cacheSupport(true);},'isRequired':function(module,reqirement){if(typeof $.wikiEditor.modules[module]['req']!=='undefined'){for(req in $.wikiEditor.modules[module]['req']){if($.wikiEditor.modules[module]['req'][req]==reqirement){return true;}}}
...
$(this).data('marker').unwrap(this);if($(this).children().size()>0){$(this).replaceWith($(this).children());}else{$(this).replaceWith($(this).html());}});}}};})(jQuery);(function($){$.wikiEditor.modules.preview={'browsers':{'ltr':{'msie':[['>=',7]],'firefox':[['>=',3]],'opera':[['>=',9.6]],'safari':[['>=',4]]},'rtl':{'msie':[['>=',8]],'firefox':[['>=',3]],'opera':[['>=',9.6]],'safari':[['>=',4]]}},fn:{create:function(context,config){if('initialized'in context.modules.preview){return;}
