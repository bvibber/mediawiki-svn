...
$messages['zh-hans'] = array(
	'replacetext' => '替换文字',
	'replacetext-desc' => '提供[[Special:ReplaceText|特殊页面]]以利管理员以「寻找及替换」的方式更改所有文章页面内的内容。',
	...
	'replacetext_choosepagesformove' => '对以下页面的名称进行替换：',
	...
	'replacetext_success' => '已将$3个页面内的「$1」替换为「$2」。',
	...
	'replacetext_blankwarning' => '因为替换字串是空白的，这将造成难以复原的结果！您要继续吗？',
