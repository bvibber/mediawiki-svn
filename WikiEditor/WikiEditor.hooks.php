...
class WikiEditorHooks {
	...
	static $scripts = array(
		'raw' => array(
			array( 'src' => 'Modules/Highlight/Highlight.js', 'version' => 5 , 'class' => 'wikiEditor.config.highlight' ),
			array( 'src' => 'Modules/Preview/Preview.js', 'version' => 6 , 'class' => 'wikiEditor.config.preview'),
			array( 'src' => 'Modules/Publish/Publish.js', 'version' => 6 , 'class' => 'wikiEditor.config.publish'),
			array( 'src' => 'Modules/Toc/Toc.js', 'version' => 7 , 'class' => 'wikiEditor.config.toc'),
			array( 'src' => 'Modules/Toolbar/Toolbar.js', 'version' => 89, 'class' => 'wikiEditor.config.toolbar' ),
			array( 'src' => 'Modules/TemplateEditor/TemplateEditor.js', 'version' => 6, 'class' => 'wikiEditor.config.templateEditor' ),
			array( 'src' => 'Modules/Templates/Templates.js', 'version' => 1, 'class' => 'wikiEditor.config.templates' ),
		),
		'combined' => array(
