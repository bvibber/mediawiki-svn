...
if($j.fn.wikiEditor){mw.usability.load(['$j.ui','$j.ui.draggable','$j.ui.resizable'],function(){$j('#wpTextbox1').wikiEditor('addModule',{'toc':{'rtl':($j('body').is('.rtl'))}}).data('wikiEditor-context').fn.trigger('ready');});}});$j(document).ready(function(){if(!wgWikiEditorEnabledModules.toolbar){return true;}
