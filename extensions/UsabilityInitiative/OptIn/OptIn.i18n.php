...
$messages['en'] = array(
	...
	'optin-desc' => 'Allow users to try Açai Beta, the Usability Initiative\'s latest usability enhancements.',
	'optin-title-optedout' => 'Try Açai Beta',
...
You can try it out again at anytime by clicking the "Try Açai Beta" link on the top right of the screen.',
	...
	'optin-submit-out' => 'Leave Açai Beta',
	'optin-try' => 'Try Açai Beta',
	'optin-leave' => 'Leave Açai Beta',
...
$messages['be-tarask'] = array(
	...
	'optin-desc' => 'Дазваляе ўдзельнікам паспрабаваць Açai Beta, апошняе паляпшэньне, зробленае ў рамках ініцыятывы па паляпшэньню зручнасьці і прастаты выкарыстаньня',
	'optin-title-optedout' => 'Паспрабаваць Açai Beta',
	'optin-title-optedin' => 'Пакінуць Açai Beta',
	'optin-title-justoptedin' => 'Вітаем у Açai Beta',
	'optin-title-justoptedout' => 'Дзякуй за спробу выкарыстаньня Açai Beta',
	'optin-needlogin' => 'Вам неабходна [$1 увайсьці ў сыстэму] каб далучыцца да Açai Beta',
	'optin-intro' => 'У рамках ініцыятывы па паляпшэньню зручнасьці і прастаты выкарыстаньня Вікіпэдыі была праведзеная буйная праца па паляпшэньню зручнасьці і прастаты выкарыстаньня Вікіпэдыі. Вы жадаеце паспрабаваць Açai Beta?',
	'optin-success-in' => 'Цяпер Вы прымаеце ўдзел у выпрабаваньні Açai Beta.
Вы можаце пакінуць выпрабаваньне ў любы час націснуўшы кнопку «Пакінуць Açai Beta» у правым верхнім куце экрана.',
	'optin-success-return' => 'Вярнуцца да [[$1]]',
	'optin-leave-cancel' => 'Калі Вы жадаеце працягваць выкарыстаньне Açai Beta, Вы можаце вярнуцца да [[$1]]',
	'optin-success-out' => 'Вы пасьпяхова пакінулі Açai Beta.
Вы можаце зноў паспрабаваць яе націснуўшы кнопку «Паспрабаваць Açai Beta» у правым верхнім куце экрана.',
	'optin-accept-short' => 'Зрабіць гэта!',
	'optin-accept-long' => 'Паспрабаваць Açai Beta',
	'optin-deny-short' => 'Не, дзякуй',
	'optin-deny-long' => 'вярнуцца да папярэдняй старонкі',
	'optin-submit-out' => 'Пакінуць Açai Beta',
	'optin-try' => 'Паспрабаваць Açai Beta',
	'optin-leave' => 'Пакінуць Açai Beta',
	'optin-survey-yes' => 'Так',
	'optin-survey-no' => 'Не',
	'optin-survey-intro' => 'Дзякуй за выпрабаваньне Açai Beta.
...
Мы жадаем ведаць, што Вы мяркуеце пра новы інтэрфэйс, з-за гэтага мы былі б удзячныя, калі б Вы прынялі ўдзел у неабавязковым апытаньні, перад тым як Вы націсьніце «[[#leave|{{int:optin-submit-out}}]]».',
	'optin-survey-question-likedislike' => 'Што Вам спадабалася ў Açai Beta? Што Вам не спадабалася ў Açai Beta?',
	...
	'optin-survey-question-techfail' => 'Вы сутыкнуліся з якімі-небудзь тэхнічнымі праблемамі пад час выкарыстаньня Açai Beta?',
...
Ясна пазначаны стан «чытаньне» ці «рэдагаваньне» старонкі на якой Вы знаходзіцеся.
Поле пошуку перанесена з левай навігацыйнай панэлі ў верхні правы вугал для палягчэньня і паскарэньня пошуку.
<div style="clear:both;"></div>

[[File:UsabilityToolbar.png|right]]
;Паляпшэньне панэлі рэдагаваньняў
Адчыняемая панэль рэдагаваньня хавае значкі рэдка выкарыстоўваемых прыладаў.
Вопытныя ўдзельнікі могуць адчыніць панэльдля доступу да спэцыяльных значкоў.
У панэлі знаходзіцца дапаможная спасылка (шпаргалка).
Значкі панэлі дапрацаваныя з выкарыстаньнем значкоў Tango і Gnome.
<div style="clear:both;"></div>

[[File:UsabilitySearch.png|right]]
;Паляпшэньне інтэрфэйсу пошуку
У выніку таго, што старонка вынікаў пошуку часта зьяўляецца ўваходнай кропкай у артыкул, палепшана нагляднасьць загалоўкаў вынікаў пошуку, выдалена рэдка выкарыстоўваемая інфармацыя.
<div style="clear:both;"></div>',
);
...
$messages['bs'] = array(
	...
	'optin-desc' => 'Omogućuje korisnicima da isprobaju Açai Beta, posljednje poboljšanje upotrebljivosti putem Inicijative upotrebljivosti.',
	'optin-title-optedout' => 'Isprobaj Açai Beta',
	'optin-title-optedin' => 'Napusti Açai Beta',
	'optin-title-justoptedin' => 'Dobrodošli na Açai Beta',
	'optin-title-justoptedout' => 'Hvala što isprobavate Açai Beta',
	'optin-needlogin' => 'Morate se [$1 prijaviti] da biste mogli isprobati Açai Beta.',
	'optin-intro' => 'Wikipedia Inicijativa upotrebljivosti radi na poboljšanju upotrebljivosti Wikipedije. Da li želite isprobati Açai Beta?',
	'optin-success-in' => 'Uspješno ste se prijavili na Açai Beta.
Možete se bilo kada odjaviti putem klikanja na link "Leave Açai Beta" u gornje desnom uglu ekrana.',
	'optin-success-return' => 'Vrati se na [[$1]]',
	'optin-success-out' => 'Uspješno ste se odjavili sa Açai Beta.
Možete se bilo kada ponovno prijaviti putem klika na link "Try Açai Beta" na gornjem desnom uglu ekrana.',
	'optin-accept-short' => 'Započni!',
	'optin-accept-long' => 'Isprobajte Açai Beta',
	'optin-deny-short' => 'Ne hvala',
	'optin-deny-long' => 'nazad na prethodnu stranicu',
	'optin-submit-out' => 'Napusti Açai Beta',
	'optin-try' => 'Isprobajte Açai Beta',
	'optin-leave' => 'Napusti Açai Beta',
	'optin-survey-yes' => 'Da',
	'optin-survey-no' => 'Ne',
	'optin-survey-intro' => 'Hvala Vam za isprobavanje Açai Beta.
...
$messages['de'] = array(
	...
	'optin-desc' => 'Erlaubt Benutzern, Açai Beta auszuprobieren, aktuellste Benutzerfreundlichkeitsverbesserungen der Benutzerfreundlichkeitsinitiative.',
	'optin-title-optedout' => 'Açai Beta ausprobieren',
	'optin-title-optedin' => 'Açai Beta verlassen',
	'optin-title-justoptedin' => 'Willkommen bei Açai Beta',
	'optin-title-justoptedout' => 'Vielen Dank, dass du Açai Beta ausprobierst',
	'optin-needlogin' => 'Du musst dich [$1 anmelden], um Açai Beta auszuprobieren',
...
Möchtest du Açai Beta ausprobieren?',
	'optin-success-in' => 'Du probierst jetzt Açai Beta aus.
Du kannst es jederzeit verlassen, indem du den Link „Açai Beta verlassen“ oben rechts anklickst.',
	'optin-success-return' => 'Zurück zu [[$1]]',
	'optin-leave-cancel' => 'Wenn du Açai Beta weiter verwenden willst, kannst du zu [[$1]] zurückkehren',
	'optin-success-out' => 'Du hast Açai Beta erfolgreich verlassen.
Du kannst es jederzeit wieder ausprobieren, indem du den Link „Açai Beta ausprobieren“ oben rechts anklickst.',
	'optin-accept-short' => 'Los!',
	'optin-accept-long' => 'Açai Beta ausprobieren',
	'optin-deny-short' => 'Nein, danke',
	'optin-deny-long' => 'Zurück zur letzten Seite',
	'optin-submit-out' => 'Açai Beta verlassen',
	'optin-try' => 'Açai Beta ausprobieren',
	'optin-leave' => 'Açai Beta verlassen',
	'optin-survey-yes' => 'Ja',
	'optin-survey-no' => 'Nein',
	'optin-survey-intro' => 'Danke, dass du Açai Beta ausprobierst.
Wir möchten gerne erfahren, was du über unsere neue Schnittstelle denkst. Wir begrüßen es, wenn du die optionale Umfrage unten beantwortest, bevor du auf „[[#leave|{{int:optin-submit-out}}]]“ klickst.',
	'optin-survey-question-likedislike' => 'Was magst du an Açai Beta? Was magst du nicht an Açai Beta?',
	...
	'optin-survey-answer-whyoptout-notpredictable' => 'Es funktioniert nicht wie vorgesehen.',
	...
	'optin-survey-question-techfail' => 'Hast du beim Ausprobieren von Açai Beta irgendwelche technischen Fehler entdeckt?',
 ...
 */
$messages['el'] = array(
	'optin-title-optedout' => 'Δοκιμάστε την Açai Beta',
	'optin-title-optedin' => 'Εγκαταλείψτε την Açai Beta',
	'optin-title-justoptedin' => 'Καλωσήρθατε στην Açai Beta',
	'optin-needlogin' => 'Πρέπει να [$1 συνδεθείς] για να δοκιμάσεις την Açai Beta',
	'optin-success-return' => 'Επιστροφή στο [[$1]]',
	'optin-accept-short' => 'Ας το κάνουμε!',
	'optin-accept-long' => 'Δοκιμάστε την Açai Beta',
	'optin-deny-short' => 'Όχι, ευχαριστώ.',
	'optin-deny-long' => 'Επιστροφή στην προηγούμενη σελίδα',
	'optin-submit-out' => 'Εγκαταλείψτε την Açai Beta',
	'optin-try' => 'Δοκιμάστε την Açai Beta',
	'optin-leave' => 'Εγκαταλείψτε την Açai Beta',
...
$messages['es'] = array(
	...
	'optin-desc' => 'Permite a los usuarios probar Açai Beta, los últimos mejoramientos de usabilidad de la iniciativa de Usabilidad.',
	'optin-title-optedout' => 'Probar Açai Beta',
	'optin-title-optedin' => 'Abandonar Açai Beta',
	'optin-title-justoptedin' => 'Bienvenido a Açai Beta',
	'optin-title-justoptedout' => 'Gracias por probar Açai Beta',
	'optin-needlogin' => 'Necesitas [$1 iniciar sesión] para probar Açai Beta',
	'optin-intro' => 'La Iniciativa de usabilidad de Wikipedia ha estado trabajando duro para mejorar la usabilidad de Wikipedia.
Te gustaría probar Açai Beta?',
	'optin-success-in' => 'Estás probando ahora Açai Beta.
Puedes volver a dejar de formar parte en cualquier momento haciendo click en el vínculo "Abandonar Açai Beta" en la parte superior derecha de la pantalla.',
	'optin-success-return' => 'Regresar a [[$1]]',
	'optin-leave-cancel' => 'Si te gustaría continuar usando Açai Beta, puedes regresar a [[$1]]',
	'optin-success-out' => 'Has abandonado exitosamente Açai Beta.
Puedes probarlo nuevamente en cualquier momento haciendo click en el vínculo "Probar Açai Beta" en la parte superior derecha de la pantalla.',
	'optin-accept-short' => 'Hagámoslo!',
	'optin-accept-long' => 'Probar Açai Beta',
	'optin-deny-short' => 'No gracias',
	'optin-deny-long' => 'regresar a la página anterior',
	'optin-submit-out' => 'Abandonar Açai Beta',
	'optin-try' => 'Probar Açai Beta',
	'optin-leave' => 'Abandonar Açai Beta',
	'optin-survey-yes' => 'Sí',
	'optin-survey-no' => 'No',
	'optin-survey-question-likedislike' => 'Qué te gustó de Açai Beta? Qué no te gustó de Açai Beta?',
	...
	'optin-survey-question-techfail' => 'Experimentaste alguna dificultad técnica cuando usaste Açai Beta?',
...
$messages['fi'] = array(
	...
	'optin-title-optedout' => 'Kokeile Açai Betaa',
	'optin-title-optedin' => 'Jätä Açai Beta',
	'optin-title-justoptedin' => 'Tervetuloa Açai Betaan',
	'optin-title-justoptedout' => 'Kiitos, kun kokeilit Açai Betaa',
...
Voit poistaa parannukset käytöstä milloin tahansa ”{{int:optin-submit-out}}” -painikkeesta.',
	'optin-leave-cancel' => 'Jos haluat edelleen käyttää Açai Betaa, voit palata kohteeseen [[$1]]',
...
Haluaisimme tietää mitä mieltä olet uudesta käyttöliittymästä, joten arvostaisimme jos täyttäisit vapaaehtoisen kyselyn ennen ”{{int:optin-submit-out}}” -painikkeen napsautusta.',
	'optin-survey-question-likedislike' => 'Mistä pidit Açai Betassa? Mistä et pitänyt Açai Betassa?',
	...
	'optin-survey-question-techfail' => 'Koitko teknisiä häiriöitä käyttäessäsi Açai Betaa?',
...
Voulez-vous essayer la bêta Açai ?",
	'optin-success-in' => "Vous participez dès maintenant la bêta Acai.
Vous pouvez ne plus participer à tout moment en cliquant sur « Quitter la bêta Acai » en haut à droite de l'écran.",
	'optin-success-return' => 'Revenir à [[$1]]',
	'optin-leave-cancel' => 'Si vous voulez continuer à utiliser la bêta Acai, vous pouvez revenir à [[$1]]',
	'optin-success-out' => "Vous participez plus à la bêta Acai
Vous pouvez de nouveau participer à tout moment en cliquant sur le lien « Essayer la bêta Acai » en haut à droite de l'écran.",
...
$messages['gl'] = array(
	...
	'optin-desc' => 'Permite que os usuarios proben a beta Açai, as últimas melloras da Iniciativa de usabilidade',
	'optin-title-optedout' => 'Probar a beta Açai',
	'optin-title-optedin' => 'Deixar a beta Açai',
	'optin-title-justoptedin' => 'Benvido á beta Açai',
	'optin-title-justoptedout' => 'Grazas por probar a beta Açai',
	'optin-needlogin' => 'Ten que [$1 acceder ao sistema] para probar a beta Açai',
	'optin-intro' => 'A Iniciativa de usabilidade da Wikipedia traballou duro para mellorar a usabilidade da Wikipedia.
Quere probar a beta Açai?',
	'optin-success-in' => 'Xa está probando a beta Açai.
Pode saír en calquera momento facendo clic na ligazón "{{int:optin-submit-out}}" que aparecerá no canto superior dereito da pantalla.',
	'optin-success-return' => 'Voltar a "[[$1]]"',
	'optin-leave-cancel' => 'Se quere seguir usando a beta Açai, pode voltar a "[[$1]]"',
	'optin-success-out' => 'Deixou de probar a beta Açai.
Pode participar nas probas en calquera momento facendo clic na ligazón "{{int:optin-submit-in}}" que aparecerá no canto superior dereito da pantalla.',
	'optin-accept-short' => 'Fagámolo!',
	'optin-accept-long' => 'Probar a beta Açai',
	'optin-deny-short' => 'Non, grazas',
	'optin-deny-long' => 'voltar á páxina anterior',
	'optin-submit-out' => 'Deixar a beta Açai',
	'optin-try' => 'Probar a beta Açai',
	'optin-leave' => 'Deixar a beta Açai',
	'optin-survey-yes' => 'Si',
	'optin-survey-no' => 'Non',
	'optin-survey-intro' => 'Grazas por probar a beta Açai.
Gustaríanos saber o que pensa sobre a nosa nova interface, de forma que lle agradeceriamos que enchese a enquisa opcional de embaixo antes de premer en "[[#leave|{{int:optin-submit-out}}]]".',
	'optin-survey-question-likedislike' => 'Que é o que lle gusta da beta Açai? E que non?',
	...
	'optin-survey-question-techfail' => 'Atopouse con algún fallo técnico durante a utilización da beta Açai?',
	...
	'optin-survey-question-different' => 'Que poderiamos ter feito diferente para que seguise usando a nosa beta?',
...
$messages['gsw'] = array(
	...
	'optin-desc' => 'Benutzer erlaube Açai Beta z uuszprobiere, di nejschte Verbesserige vu dr Benutzerfrejndligkeits-Initiative.',
	'optin-title-optedout' => 'Açai Beta uusprobiere',
	'optin-title-optedin' => 'Açai Beta verloo',
	'optin-title-justoptedin' => 'Willchuu bi Açai Beta',
	'optin-title-justoptedout' => 'Dankschen, ass du Açai Beta uusprobiersch',
	'optin-needlogin' => 'Du muesch Di [$1 aamälde] go Açai Beta uuszprobiere',
...
Witt Açai Beta uusprobiere?',
	'optin-success-in' => 'Du probiersch jetz Açai Beta uus.
Du chasch s wider ruckgängig mache dur e Klick uf „Açai Beta verloo“ ober rächts uf dr Benutzeroberflächi.',
	'optin-success-return' => 'Zruck zue [[$1]]',
	'optin-leave-cancel' => 'Wänn du Açai Beta wyter witt verwände, chasch zruck goh zue [[$1]]',
	'optin-success-out' => 'Du hesch Açai Beta erfolgrych verloo.
Du chasch s wider uusprobiere dur e Klick uf „Açai Beta“ obe rächts uf dr Benutzeroberflächi.',
	'optin-accept-short' => 'Los goht s!',
	'optin-accept-long' => 'Açai Beta uusprobiere',
	'optin-deny-short' => 'Nei dankschen',
	'optin-deny-long' => 'zruck zue dr letschte Syte',
	'optin-submit-out' => 'Açai Beta verloo',
	'optin-try' => 'Açai Beta uusprobiere',
	'optin-leave' => 'Açai Beta verloo',
	'optin-survey-yes' => 'Jo',
	'optin-survey-no' => 'Nei',
	'optin-survey-intro' => 'Dankschen, ass Du Açai Beta uusprobiert hesch.
...
Mir wisste gärn, was Du iber di nej Benutzeroberflächi dänksch. Wäge däm deete mer is freie, wänn Du di frejwillig Umfrog deetsch uusfille, voreb Du uf „[[#leave|{{int:optin-submit-out}}]]“ klicksch.',
	'optin-survey-question-likedislike' => 'Was het dir an Açai Beta gfalle? Was het dir an Açai Beta nit gfalle?',
	...
	'optin-survey-question-techfail' => 'Hesch du tächnischi Fähler feschtgstellt, wu du Açai Beta brucht hesch?',
...
$messages['hsb'] = array(
	...
	'optin-desc' => 'Zmóžnja wužiwarjam Açai Beta spytać, najnowše polěpšenja wužiwajomnosće iniciatiwy wužiwajomnosće.',
	'optin-title-optedout' => 'Açai Beta spytać',
	'optin-title-optedin' => 'Açai Beta wopušćić',
	'optin-title-justoptedin' => 'Witaj do Açai Beta',
	'optin-title-justoptedout' => 'Dźakujemy so, zo sy Açai Beta wuprobował',
	'optin-needlogin' => 'Dyrbiš so [$1 přizjewić], zo by Açai Beta wuprobował',
	...
	'optin-success-return' => 'Wróćo k [[$1]]',
	'optin-leave-cancel' => 'Jeli rady chceš Açai Beta dale wužiwać, móžeš so k [[$1]] wróćić.',
	...
	'optin-accept-long' => 'Açai Beta wuprobować',
	'optin-deny-short' => 'Ně, dźakujemy so',
	'optin-deny-long' => 'wróćo k předchadnej stronje',
	'optin-submit-out' => 'Açai Beta wopušćić',
	'optin-try' => 'Açai Beta wuprobować',
	'optin-leave' => 'Açai Beta wopušćić',
...
$messages['ia'] = array(
	...
	'optin-desc' => 'Permitte al usatores de probar Açai Beta, le ultime meliorationes del Initiativa de Usabilitate.',
	'optin-title-optedout' => 'Probar Açai Beta',
	'optin-title-optedin' => 'Quitar Açai Beta',
	'optin-title-justoptedin' => 'Benvenite a Açai Beta',
	'optin-title-justoptedout' => 'Gratias pro probar Açai Beta',
	'optin-needlogin' => 'Tu debe [$1 aperir un session] pro probar Açai Beta',
	'optin-intro' => 'Le Initiativa de Usabilitate de Wikipedia ha laborate duro pro augmentar le usabilitate de Wikipedia.
Vole tu probar Açai Beta?',
	'optin-success-in' => 'Tu ha ora comenciate a probar Açai Beta.
Tu pote disactivar lo a omne tempore con le ligamine "Quitar Açai Beta" in alto a derecta del schermo.',
	'optin-success-return' => 'Retornar a [[$1]]',
	'optin-leave-cancel' => 'Si tu vole continuar a usar Açai Beta, tu pote retornar a [[$1]]',
	'optin-success-out' => 'Tu ha con successo quitate Açai Beta.
Tu pote reactivar lo a omne tempore con le ligamine "Probar Açai Beta" in alto a derecta del schermo.',
	'optin-accept-short' => 'In avante!',
	'optin-accept-long' => 'Probar Açai Beta',
	'optin-deny-short' => 'No, gratias',
	'optin-deny-long' => 'retornar al previe pagina',
	'optin-submit-out' => 'Quitar Açai Beta',
	'optin-try' => 'Probar Açai Beta',
	'optin-leave' => 'Quitar Açai Beta',
	'optin-survey-yes' => 'Si',
	'optin-survey-no' => 'No',
	'optin-survey-intro' => 'Gratias pro essayar Açai Beta.
Nos volerea saper lo que tu pensa super nostre nove interfacie, e nos appreciarea si tu completa le sequente questionario optional ante de cliccar super "[[#leave|{{int:optin-submit-out}}]]".',
	'optin-survey-question-likedislike' => 'Que te placeva in Açai Beta? Que non te placeva in Açai Beta?',
	...
	'optin-survey-question-techfail' => 'Experimentava tu alcun fallimentos technic durante le uso de Açai Beta?',
 ...
 */
$messages['it'] = array(
	'optin-desc' => "Consente agli utenti di provare Açai Beta, gli ultimi miglioramenti dell'iniziativa di usabilità.",
	'optin-title-optedout' => 'Prova Açai Beta',
	'optin-title-optedin' => 'Lascia Açai Beta',
	'optin-title-justoptedin' => 'Benvenuto in Açai Beta',
	'optin-title-justoptedout' => 'Grazie per aver provato Açai Beta',
	'optin-needlogin' => "È necessario [$1 effettuare l'accesso] per provare Açai Beta",
	'optin-intro' => "L'iniziativa di usabilità di Wikipedia sta lavorando intensamente per migliorare l'usabilità di Wikipedia.
Si desidera provare Açai Beta?",
	'optin-success-return' => 'Torna a [[$1]]',
	'optin-leave-cancel' => 'Se si desidera continuare a usare Açai Beta è possibile tornare a [[$1]]',
	'optin-success-out' => 'Açai Beta è stato lasciato con successo.
È possibile provarlo nuovamente in qualsiasi momento facendo clic sul collegamento "Prova Açai Beta" in alto a destra dello schermo.',
	'optin-deny-long' => 'Torna alla pagina precedente',
	'optin-submit-out' => 'Lascia Açai Beta',
	'optin-try' => 'Prova Açai Beta',
	'optin-leave' => 'Lascia Açai Beta',
	'optin-survey-yes' => 'Sì',
	'optin-survey-no' => 'No',
	...
	'optin-survey-question-techfail' => 'Si sono verificati problemi tecnici usando Açai Beta?',
...
$messages['ja'] = array(
	...
	'optin-desc' => 'ユーザビリティ改善プロジェクトによる最新のユーザビリティー改善案、アーサイー・ベータの試用を可能にする',
	'optin-title-optedout' => 'アーサイー・ベータを試す',
	'optin-title-optedin' => 'アーサイー・ベータを止める',
	'optin-title-justoptedin' => 'アーサイー・ベータにようこそ',
	'optin-title-justoptedout' => 'アーサイー・ベータをお試しいただきありがとうございます',
	'optin-needlogin' => 'アーサイー・ベータを試すには[$1 ログイン]する必要があります。',
	'optin-intro' => 'ウィキペディア・ユーザビリティ改善プロジェクトでは、ウィキペディアの使いやすさを改善するために活動しています。アーサイー・ベータを試してみますか？',
	'optin-success-in' => 'アーサイー・ベータの試用を開始しました。画面右上の「{{int:optin-title-optedin}}」のリンクをクリックすると、いつでも試用をやめることができます。',
	'optin-success-return' => '[[$1]]に戻る',
	'optin-leave-cancel' => 'アーサイー・ベータの試用を続ける場合、[[$1]]に戻ることができます。',
	'optin-success-out' => 'アーサイー・ベータを停止しました。画面右上の「{{int:optin-title-optedout}}」のリンクをクリックすると、いつでもまた試用することができます。',
	'optin-accept-short' => 'やりましょう！',
	'optin-accept-long' => 'アーサイー・ベータを試す',
	'optin-deny-short' => 'いいえ結構です',
	'optin-deny-long' => '前のページに戻る',
	'optin-submit-out' => 'アーサイー・ベータを止める',
	'optin-try' => 'アーサイー・ベータを試す',
	'optin-leave' => 'アーサイー・ベータを止める',
	'optin-survey-yes' => 'はい',
	'optin-survey-no' => 'いいえ',
	'optin-survey-intro' => 'アーサイー・ベータをお試しいただきありがとうございます。よろしければこの新しいインタフェースについてご意見をお聞かせください。 [[#leave|{{int:optin-submit-out}}]]をクリックする前に以下の任意調査にご協力いただければ幸いです。',
	'optin-survey-question-likedislike' => 'アーサイー・ベータのどのような点が気に入りましたか。どのような点が気に入りませんでしたか。',
	'optin-survey-question-whyoptout' => 'なぜこのベータの試用をおやめになるのですか（あてはまるものをすべてお選びください）。',
	'optin-survey-answer-whyoptout-hard' => '使いこなせませんでした。',
	'optin-survey-answer-whyoptout-didntwork' => 'それは正常に機能しませんでした。',
	'optin-survey-answer-whyoptout-notpredictable' => '予想通りに機能しませんでした。',
	...
	'optin-survey-question-techfail' => 'アーサイー・ベータの使用中に技術的なトラブルがありましたか。',
	'optin-survey-question-techfail-ifyes' => 'もしそうならば、詳しく説明してください。',
	'optin-survey-question-usedtoolbar' => '展開に対応した新しいページ編集用ツールバーを使ってみましたか？',
...
$messages['ka'] = array(
	...
	'optin-desc' => 'აძლევს მომხმარებლებს უფლებას გამოიყენონ Açai Beta, იუზაბილითის ინიციატივის ბოლო ხელსაწყო',
	'optin-title-optedout' => 'Açai Beta ტესტირება',
	'optin-title-optedin' => 'Açai Beta-ს გათიშვა',
	'optin-title-justoptedin' => 'მოგესალმებით Açai Beta-ში',
	'optin-title-justoptedout' => 'მადლობას გიხდით Açai Beta-ს შემოწმებისთვის',
	'optin-needlogin' => 'თქვენ უნდა [$1 წარადგინოთ თავი] Açai Beta-ს გამოყენებისთვის',
	'optin-intro' => 'იუზაბილითის ინიციატივის ფარგლებში განხორციელდა ვიკიპედიის გამოყენების გამარტივებასთან დაკავშირებული სამუშაო.
გსურთ Açai Beta-ს ტესტირება?',
	'optin-success-in' => 'ახლა თქვენ შეგიძლიათ მიიღოთ მონაწილეობა Açai Beta-ს ტესტირებაში.
თქვენ შეგიძიათ შეწყვიტოთ მონაწილეობის მიღება "Açai Beta-ს დატოვება"-ს ღილაკზე დაჭერისას.',
	'optin-success-return' => 'დაბრუნდი [[$1]]-ზე.',
	'optin-leave-cancel' => 'თუ თქვენ გსურთ Açai Beta-ს გამოყენება, შეგიძლიათ დაბრუნდეთ  [[$1]]-ზე.',
	'optin-success-out' => 'თქვენ წარმატებით გათიშეთ Açai Beta.
თქვენ კიდევ ერთხელ შეგიძლიათ ამ სისტემის ტესტირება ბმულის დაჭერით «Açai Beta-ს ჩართვა» ეკრანის მარჯვენა კუთხეში.',
	'optin-accept-short' => 'წავედით!',
	'optin-accept-long' => 'Açai Beta-ს გასინჯვა',
	'optin-deny-short' => 'არა, გმადლობთ',
	'optin-deny-long' => 'წინა გვერდზე დაბრუნება',
	'optin-submit-out' => 'Açai Beta-ს გათიშვა',
	'optin-try' => 'Açai Beta-ს გასინჯვა',
	'optin-leave' => 'Açai Beta-ს გათიშვა',
	'optin-survey-yes' => 'ჰო',
	'optin-survey-no' => 'არა',
	'optin-survey-intro' => 'გმადლობთ Açai Beta-ს შემოწმებისთვის.
ჩვენ გვაინტერესებს, რას ფიქრობთ ახალ ინტერფეისზე და მადლობელნი ვიქნებით თუ თქვენ მიღიებთ მონაწილეობას გამოკითხვაში მანამ, სანამ დააჭერთ «[[#leave|{{int:optin-submit-out}}]]».',
	'optin-survey-question-likedislike' => 'რა მოგწონთ Açai Beta-ში? რა არა?',
	...
	'optin-survey-question-techfail' => 'თქვენ დაესწარით ტექნიკურ პრობლემებს Açai Beta-ს ტესტირებისას?',
...
$messages['ksh'] = array(
	...
	'optin-desc' => 'Määt et müjjelesch för de Metmaacher, <i lang="en">Açai Beta</i>, de <i lang="en">Usability Initiative</i> ier neuste Verschöönerunge ußzeprobeere.',
	'optin-title-optedout' => '<i lang="en">Açai Beta</i> ußprobeere',
	'optin-title-optedin' => '<i lang="en">Açai Beta</i> verlohße',
	'optin-title-justoptedin' => 'Wellkumme bei <i lang="en">Açai Beta</i>',
	'optin-title-justoptedout' => 'Merßi, datt De <i lang="en">Açai Beta</i> ußprobeere deihß.',
	'optin-needlogin' => 'Do mööts alld [$1 enjelogg senn], öm <i lang="en">Açai Beta</i> för Desch enschallde ze künne.',
...
Wells de <i lang="en">Açai Beta</i> ußprobeere?',
...
Do kanns doh emmer wider eruß kumme, endämm dat De onge op „{{int:optin-submit-out}}“ klecks.',
	'optin-success-return' => 'Jangk retuur noh [[$1]]',
	'optin-leave-cancel' => 'Wann De <i lang="en">Açai Beta</i> wigger bruche wells, kanns De noh  [[$1]] retuur jonn.',
...
Do kanns emmer wider zerök kumme, endämm dat De onge op „{{int:optin-submit-in}}“ klecks.',
	...
	'optin-accept-long' => '<i lang="en">Açai Beta</i> ußprobeere',
	'optin-deny-short' => 'Nää, dat wulle mer nit',
	'optin-deny-long' => 'retuur op de vörijje Sigg',
	'optin-submit-out' => '<i lang="en">Açai Beta</i> verlohße',
	'optin-try' => '<i lang="en">Açai Beta</i> ußprobeere',
	'optin-leave' => '<i lang="en">Açai Beta</i> verlohße',
...
Mer dääte jähn weße wat De övver uns neu Ovverflääsch meins. Dröm dääte mer uns freue, wann de unge op e paa kleine Froore antwoote dääts, ih dat de op „{{int:optin-submit-out}}“ klecks.',
	'optin-survey-question-likedislike' => 'Wat hät Der aam <i lang="en">Açai Beta</i> jefalle?
Wat hät Der aam <i lang="en">Açai Beta</i> nit jefalle?',
	'optin-survey-question-whyoptout' => 'Woröm deihß de hee di Ovverflääsch nit (mieh) bruche? (Beß esu joot, un jif alles aan, wat för Desch shtemme deiht)',
...
$messages['lb'] = array(
	...
	'optin-desc' => 'Erlaabt et de Benotzer fir Açai Beta auszeprobéieren, déi lescht Verbesserunge vun der Benotzerfrëndlechkeets-Initiative.',
	'optin-title-optedout' => 'Probéiert Açai Beta aus',
	'optin-title-optedin' => 'Açai Beta verlossen',
	'optin-title-justoptedin' => 'Wëllkomm bäi Açai Beta',
	'optin-title-justoptedout' => 'Merci datt Dir Açai Beta ausprobéiert',
	'optin-needlogin' => 'Dir musst Iech [$1 alogge] fir Açai Beta auszeprobéieren.',
...
Wëllt Dir Açai Beta ausprobéieren?",
	'optin-success-in' => 'Dir probéiert elo Açai Beta aus.
Dir kënnt dës zu jidder Zäit nees ausschalten an deem datt Dir op "Açai Beta verlooossen" Link ueweriets klickt.',
	'optin-success-return' => 'Zréck op [[$1]]',
	'optin-leave-cancel' => 'Wann Dir Açai Beta weiderbenotze wëllt, kënnt Dir op [[$1]] zréckgoen',
	'optin-success-out' => 'Dir hutt Açai Beta verlooss.
Dir kënnt dës zu jidder Zäit nees aschalten an deem datt Dir op den "Açai Beta ausprobéiere"-Link ueweriets um Schierm klickt.',
	'optin-accept-short' => 'Kommt mir maachen et!',
	'optin-accept-long' => 'Probéiert Açai Beta aus',
	'optin-deny-short' => 'Kee Merci',
	'optin-deny-long' => 'Zréck op déi Säit virdrun',
	'optin-submit-out' => 'Açai Beta verloossen',
	'optin-try' => 'Probéiert Açai Beta aus',
	'optin-leave' => 'Açai Beta verloosen',
	'optin-survey-yes' => 'Jo',
	'optin-survey-no' => 'Neen',
	'optin-survey-intro' => 'Merci datt Dir Açai Beta ausprobéiert.
Mir wiere frou fir ze wëssen wat Dir vun deem neien Interface denkt, dofir wiere mir frou wann Dir déi fräiwëlleg Ëmfro hei ënnendrënner géift ausfëllen ier Dir op "[[#leave|{{int:optin-submit-out}}]]" klickt.',
	'optin-survey-question-likedislike' => 'Wat hutt dir bäi Açai Beta gutt finnt? Wat huet Iech un Açai Beta net gefall?',
	...
	'optin-survey-question-techfail' => 'Hat Dir technesch Schwieregkeete beim Benotze vun Açai Beta?',
 ...
 */
$messages['lt'] = array(
	'optin-title-optedout' => 'Pabandykite Açai Beta',
	'optin-title-optedin' => 'Palikite Açai Beta',
	'optin-title-justoptedin' => 'Sveiki atvykę į Açai Beta',
	'optin-title-justoptedout' => 'Dėkojame, kad bandote Açai Beta',
	'optin-needlogin' => 'Jums reikia [$1 prisijungti], norint bandyti Açai Beta',
...
Norite pabandyti Açai beta versiją?',
	'optin-try' => 'Pabandyti Açai Beta',
	'optin-leave' => 'Palikti Açai Beta',
...
$messages['nl'] = array(
	...
	'optin-desc' => 'Maakt het mogelijk voor gebruikers om Açai Beta, de verbeteringen van het Bruikbaarheidsinitiatief, in te schakelen',
	'optin-title-optedout' => 'Açai Beta uitproberen',
	'optin-title-optedin' => 'Açai Beta uitschakelen',
	'optin-title-justoptedin' => 'Welkom bij Açai Beta',
	'optin-title-justoptedout' => 'Bedankt voor het uitproberen van Açai Beta',
	'optin-needlogin' => 'U moet [$1 aanmelden] voordat u Açai Beta kunt inschakelen.',
...
Wilt u Açai Beta uitproberen?',
	'optin-success-in' => 'U maakt nu gebruik van Açai Beta.
U kunt deze instellingen op elk gewenst moment weer verwijderen door op de knop "{{int:optin-submit-out}}" te klikken.',
	'optin-success-return' => 'Terugkeren naar [[$1]]',
	'optin-leave-cancel' => 'Als u Açai Beta wilt blijven gebruiken, kunt u terugkeren naar [[$1]]',
	'optin-success-out' => 'U hebt Açai Beta uitgeschakeld.
U kunt deze functionaliteit op elk gewenst moment weer inschakelen door op de knop {{int:optin-submit-in}} te klikken.',
	...
	'optin-accept-long' => 'Açai Beta inschakelen',
	'optin-deny-short' => 'Nee, bedankt',
	'optin-deny-long' => 'Terug naar de vorige pagina',
	'optin-submit-out' => 'Açai Beta uitschakelen',
	'optin-try' => 'Açai Beta inschakelen',
	'optin-leave' => 'Açai Beta uitschakelen',
	'optin-survey-yes' => 'Ja',
	'optin-survey-no' => 'Nee',
	'optin-survey-intro' => 'Dank u wel voor het uitproberen van Açai Beta.
We willen graag weten wat u vindt van deze nieuwe interface, dus wilt u alstublieft de korte vragenlijst hieronder invullen voordat u op "[[#leave|{{int:optin-submit-out}}]]" klikt?',
	'optin-survey-question-likedislike' => 'Wat vond u goed aan Açai Beta?
Wat vond u niet goed aan Açai Beta?',
...
Selecteer alstublieft alle redenen die van toepassing zijn.',
	...
	'optin-survey-question-techfail' => 'Hebt u technische fouten ondervonden bij het gebruik van Açai Beta?',
	...
	'optin-survey-question-different' => 'Wat had er anders gedaan moeten worden zodat u Açai Beta was blijven gebruiken?',
...
$messages['oc'] = array(
	...
	'optin-desc' => "Permet als utilizaires d'ensajar la bêta Açai, los melhoraments de l'initiativa d'utilisabilitat",
	'optin-title-optedout' => 'Ensajar la bêta Açai',
	'optin-title-optedin' => 'Quitar la bêta Açai',
	'optin-title-justoptedin' => 'Benvenguda a la bêta Açai',
	'optin-title-justoptedout' => 'Mercés per vòstra participacion a la bêta Açai',
	'optin-needlogin' => 'Vos cal vos [$1 connectar] per ensajar la beta Açai',
	'optin-intro' => "L'iniciativa d'utilizabilitat de Wikipèdia a trabalhat dur per melhorar l'utilisabilitat de Wikipèdia.
Volètz ensajar la bêta Açai ?",
	'optin-success-in' => "Participatz tre ara a la beta Acai.
Podètz participar pas mai a tot moment en clicant sus « Quitar la beta Açai » en naut a drecha de l'ecran.",
	'optin-success-return' => 'Tornar a [[$1]]',
	'optin-leave-cancel' => 'Se volètz contunhar a utilizar la beta Açai, podètz tornar a [[$1]]',
	'optin-success-out' => "Participatz pas mai a la beta Acai.
Podètz participar tornamai a tot moment en clicant sul ligam « Ensajar la beta Açai » en naut a drecha de l'ecran.",
	'optin-accept-short' => 'Anem !',
	'optin-accept-long' => 'Ensajar la beta Açai',
	'optin-deny-short' => 'Non mercés',
	'optin-deny-long' => 'Tornar a la pagina precedenta',
	'optin-submit-out' => 'Quitar Açai Beta',
	'optin-try' => 'Ensajar la beta Açai',
	'optin-leave' => 'Quitar la beta Açai',
	'optin-survey-yes' => 'Òc',
	'optin-survey-no' => 'Non',
	'optin-survey-intro' => "Mercés per ensajar la beta Açai.
...
Nos agradariá de saber çò que pensatz de nòstra interfàcia novèla, nos agradariá s'emplenèssetz l'escandalhatge opcional abans de clicar sus « [[#leave|{{int:optin-submit-out}}]] ».",
	'optin-survey-question-likedislike' => 'Qué vos a agradat dins la beta Acai ? Qué vos a pas agradat dins la beta Açai ?',
	...
	'optin-survey-question-techfail' => 'Avètz rencontrat de problèmas tecnics en utilizant la beta Açai ?',
 ...
 */
$messages['pdc'] = array(
	'optin-title-justoptedin' => 'Wilkum zu Açai Beta',
	'optin-success-return' => 'Zerick zu [[$1]]',
...
$messages['ru'] = array(
	...
	'optin-desc' => 'Позволяет участникам опробовать Açai Beta, последнее улучшение, сделанное в рамках Инициативы юзабилити',
	'optin-title-optedout' => 'Опробовать Açai Beta',
	'optin-title-optedin' => 'Покинуть Açai Beta',
	'optin-title-justoptedin' => 'Добро пожаловать в Açai Beta',
	'optin-title-justoptedout' => 'Благодарим вас за проверку Açai Beta',
	'optin-needlogin' => 'Вам нужно [$1 представиться] чтобы опробовать Açai Beta',
	'optin-intro' => 'В рамках Инициативы юзабилити была проведена работа по улучшению удобства использования Википедии.
Вы хотите опробовать Açai Beta?',
	'optin-success-in' => 'Теперь вы принимаете участие в опробовании Açai Beta.
В можете отключиться от программы в любое время, нажав  на ссылку «Покинуть Açai Beta» в правом верхнем углу экрана.',
	'optin-success-return' => 'Вернуться к [[$1]]',
	'optin-leave-cancel' => 'Если вы хотите завершить использовать Açai Beta, вы можете вернуться к [[$1]]',
	'optin-success-out' => 'Вы успешно покинули Açai Beta.
В можете ещё раз попробовать эту систему, нажав ссылку «Опробовать Açai Beta» в правом верхнем углу экрана.',
	'optin-accept-short' => 'Поехали!',
	'optin-accept-long' => 'Опробовать Açai Beta',
	'optin-deny-short' => 'Нет, спасибо',
	'optin-deny-long' => 'вернуться на предыдущую страницу',
	'optin-submit-out' => 'Покинуть Açai Beta',
	'optin-try' => 'Опробовать Açai Beta',
	'optin-leave' => 'Покинуть Açai Beta',
	'optin-survey-yes' => 'Да',
	'optin-survey-no' => 'Нет',
	'optin-survey-intro' => 'Благодарим вас за опробование Açai Beta.
Нам бы хотелось знать что вы думаете о новом интерфейсе, поэтому мы были бы признательны, если бы вы приняли участие в приведённом ниже опросе, перед тем, как нажмёте «[[#leave|{{int:optin-submit-out}}]]».',
	'optin-survey-question-likedislike' => 'Что вам нравится в Açai Beta? Что вам не нравится в Açai Beta?',
	...
	'optin-survey-question-techfail' => 'Вы столкнулись с какими-либо техническими сбоями при использовании Açai Beta?',
...
$messages['sk'] = array(
	...
	'optin-desc' => 'Umožňuje používateľom skúsiť Açai Beta, najnovšie rozšírenia použiteľnosti Iniciatívy použiteľnosti',
	'optin-title-optedout' => 'Skúsiť Açai Beta',
	'optin-title-optedin' => 'Opustiť Açai Beta',
	'optin-title-justoptedin' => 'Vitajte v Açai Beta',
	'optin-title-justoptedout' => 'Ďakujeme, že ste skúsili Açai Beta',
	'optin-needlogin' => 'Ak sa chcete skúsiť Açai Beta, musíte sa najskôr [$1 prihlásiť].',
	'optin-intro' => 'Iniciatíva použiteľnosti projektu Wikipédia pracuje s cieľom vylepšiť použiteľnosť Wikipédie. Chcete skúsiť Açai Beta?',
	'optin-success-in' => 'Teraz skúšate Açai Beta.
Kedykoľvek môžete skúšanie opustiť kliknutím na „{{int:optin-submit-out}}“ v pravom hornom rohu.',
	'optin-success-return' => 'Späť na [[$1]]',
	'optin-leave-cancel' => 'Ak si želáte pokračovať v používaní Açai Beta, môžete sa vrátiť späť na [[$1]]',
	'optin-success-out' => 'Úspešne ste opustili Açai Beta.
Kedykoľvek ho môžete znova vyskúšať kliknutím na „{{int:optin-submit-in}}“ v pravom hornom rohu.',
	'optin-accept-short' => 'Urobme to!',
	'optin-accept-long' => 'Vyskúšať Açai Beta',
	'optin-deny-short' => 'Nie, ďakujem',
	'optin-deny-long' => 'späť na predošlú stránku',
	'optin-submit-out' => 'Opustiť Açai Beta',
	'optin-try' => 'Skúsiť Açai Beta',
	'optin-leave' => 'Opustiť Açai Beta',
	'optin-survey-yes' => 'Áno',
	'optin-survey-no' => 'Nie',
	'optin-survey-intro' => 'Ďakujeme, že ste skúsili Açai Beta.
Chceli by sme vedieť, čo si myslíte o novom rozhraní, takže by sme ocenili keby ste vyplnili tento nepovinný dotazník predtým, než kliknete na „[[#leave|{{int:optin-submit-out}}]]“ nižšie.',
	'optin-survey-question-likedislike' => 'Čo sa vám na Açai Beta páčilo? Čo sa vám nepáčilo?',
	...
	'optin-survey-question-techfail' => 'Nastali u vás nejaké technické problémy súvisiace s používaním Açai Beta?',
	...
	'optin-survey-question-different' => 'Čo sme mohli spraviť inak aby ste neprestali používať testovacie rozhranie Açai Beta?',
...
$messages['tr'] = array(
	...
	'optin-desc' => "Kullanıcıların Açai Beta'yı, Kullanılabilirlik Girişimi'nin en son kullanılabilirlik geliştirmelerini, denemelerine izin verir",
	'optin-title-optedout' => 'Açai Beta Deneyin',
	'optin-title-optedin' => "Açai Beta'dan Çık",
	'optin-title-justoptedin' => "Açai Beta'ya Hoşgeldiniz",
	'optin-title-justoptedout' => "Açai Beta'yı denediğiniz için teşekkür ederiz",
	'optin-needlogin' => "Açai Beta'yı denemek için [$1 giriş yapmalısınız].",
...
Açai Beta'yı denemek ister misiniz?",
	'optin-success-in' => 'Şu anda Açai Beta\'yı deniyorsunuz.
Ekranın sağ üst kısmındaki "{{int:optin-submit-out}}" linkine tıklayarak istediğiniz zaman ayrılabilirsiniz.',
	'optin-success-return' => '[[$1]] sayfasına geri dön',
	'optin-leave-cancel' => "Eğer Açai Beta'yı kullanmaya devam etmek isterseniz, [[$1]] sayfasına geri dönebilirsiniz",
	'optin-success-out' => 'Açai Beta\'dan başarıyla kayrıldınız.
Ekranin sağ üst kısmındaki "{{int:optin-submit-in}}" linkine tıklayarak istediğiniz zaman tekrar katılabilirsiniz.',
...
Yeni arayüzümüz konusunda ne düşündüğünüzü bilmek isteriz, o yüzden "[[#leave|{{int:optin-submit-out}}]]" düğmesine tıklamadan önce isteğe bağlı anketimizi doldurursanız memnun kalırız.',
	'optin-survey-question-likedislike' => "Açai Beta'nın beğendiğiniz yönleri nelerdir? Açai Beta'nın sevmediğiniz yönleri nelerdir?",
	...
	'optin-survey-question-techfail' => "Açai Beta'yı kullanırken herhangi bir teknik arıza ile karşılaştınız mı?",
