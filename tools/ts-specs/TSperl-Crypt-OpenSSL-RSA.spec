...
Name:		TSperl-Crypt-OpenSSL-RSA
Summary:	Crypt::OpenSSL::RSA module for Perl
Version:	0.25
...
Requires: TSperl
Requires: TSperl-Crypt-OpenSSL-Random
BuildRequires: TSperl
BuildRequires: TSperl-Crypt-OpenSSL-Random
...
/opt/TSperl/bin/perl Makefile.PL INSTALLDIRS=vendor INC=-I/usr/sfw/include LIBS='-L/usr/sfw/lib -R/usr/sfw/lib -lssl -lcrypto'
make
