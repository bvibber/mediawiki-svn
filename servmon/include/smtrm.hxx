...
basrt.install("show irc server %s", cmd_irc_showserver(), "Describe a configured server");
basrt.install("show irc server", cmd_irc_showserver(), "Describe all configured servers");
basrt.install("show monitor", "Show monitoring information");
basrt.install("show monitor server", cmd_monit_showservers(), "Show monitored servers");
basrt.install("show monitor server %s", cmd_monit_showservers(), "Show information for a particular server");
basrt.install("show monitor intervals", cmd_monit_showintervals(), "Show monitoring intervals");
basrt.install("show querybane", "Show QueryBane information");
basrt.install("show querybane rule", "Show a specific rule");
basrt.install("show querybane rule %s", cmd_qb_show_rule(), "Rule name");
basrt.install("show querybane rules", cmd_qb_show_rule(), "Show all QueryBane rules");
basrt.install("show memcache", "Show memcache client information");
basrt.install("show memcache server-list-command", cmd_mc_show_server_list_command(), "Show server list command");
...
eblrt.install("debug", "Runtime debugging functions");
eblrt.install("debug mysql", "Debug MySQL functions");
eblrt.install("debug mysql connect", cmd_debug_mysql_connect(), "Debug MySQL connections");
eblrt.install("debug mysql query", cmd_debug_mysql_query(), "Debug MySQL queries");
eblrt.install("debug mysql monitoring", cmd_debug_mysql_monitoring(), "Debug MySQL server monitoring");
eblrt.install("debug irc", cmd_debug_irc(), "Debug IRC connections");
eblrt.install("no debug", "Runtime debugging functions");
eblrt.install("no debug mysql", "Debug MySQL functions");
eblrt.install("no debug mysql connect", cmd_no_debug_mysql_connect(), "Debug MySQL connections");
eblrt.install("no debug mysql query", cmd_no_debug_mysql_query(), "Debug MySQL queries");
eblrt.install("no debug mysql monitoring", cmd_no_debug_mysql_monitoring(), "Debug MySQL server monitoring");
eblrt.install("no debug irc", cmd_no_debug_irc(), "Debug IRC connections");
