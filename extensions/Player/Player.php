...
$wgHooks['LoadAllMessages'][] = 'loadPlayerI18n';

$wgAutoloadClasses['Player'] = dirname( __FILE__ ) . '/PlayerClass.php';
$wgAutoloadClasses['SpecialPlayer'] = dirname( __FILE__ ) . '/SpecialPlayer.php';
...
/**
* load the Player internationalization file
*/
function loadPlayerI18n() {
