<?sjs
if(pow_server.REMOTE_HOST != "127.0.0.1") { pow_exit(); }
/*
if( !pow_bc_pass_protected()) { 
  document.writeln("You must password protect this server to use the debugging interface.");
  pow_exit(); 
} 
*/
