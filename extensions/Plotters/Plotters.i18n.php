...
$messages['ru'] = array(
	...
	'plotters-pagetext' => 'Ниже список служебных плоттеров, которые могут использовать участники в тегах jsplot, определённые в [[MediaWiki:Plotters-definition]].
...
Пожалуйста, укажите препроцессор, чьё имя не превышает 255 символов.',
	'plotters-excessively-long-name' => 'Название плоттера слишком длинный.
...
Пожалуйста, определите класс таблицы не больше 255 символов.',
