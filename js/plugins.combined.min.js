...
context.history.push({'html':newHTML,'sel':newSel});while(context.history.length>10){context.history.shift();}}else if(context.oldDelayedSel!=newSel&&context.historyPosition==-1){context.oldDelayedSel=newSel;context.history[context.history.length+context.historyPosition].sel=newSel;}
