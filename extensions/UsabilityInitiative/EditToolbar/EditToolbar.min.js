...
var insertText='';var whitespace=$j('#edittoolbar-link-dialog').data('whitespace');var target=$j('#edittoolbar-link-int-target').val();var text=$j('#edittoolbar-link-int-text').val();if(text==''){alert(gM('edittoolbar-tool-link-empty'));return;}
...
var replaceStr=$j('#edittoolbar-replace-replace').val();var flags='';var matchCase=$j('#edittoolbar-replace-case').is(':checked');var isRegex=$j('#edittoolbar-replace-regex').is(':checked');if(!matchCase){flags+='i';}
