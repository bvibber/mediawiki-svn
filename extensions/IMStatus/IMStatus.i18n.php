...
В id должны быть буквы и цифры от «$2» до «$3».',
	'imstatus_skype_nbstyle' => 'Примечание: если вы выбрали стиль, который является также действием, ваши действия будут переопредлены действием, соответствующим выбранному вами стилю.',
