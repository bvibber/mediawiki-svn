...
for(boundary in boundaries){if('begin'in boundaries[boundary]&&'end'in boundaries[boundary]){if(!(boundaries[boundary].begin in markers)){markers[boundaries[boundary].begin]=[];}
if(!(boundaries[boundary].end in markers)){markers[boundaries[boundary].end]=[];}
