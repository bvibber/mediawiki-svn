...
$wgUserBoard = true;
$wgExtensionFunctions[] = 'wfSpecialViewUserBoard';


function wfSpecialViewUserBoard(){
	global $wgUser,$IP;
				...
				foreach ($messages as $message) {
					...
					$output .= "<div class=\"user-board-message\" style=\"width:550px\">
						...
						<div class=\"user-board-message-time\">
							posted " . $b->getTimeAgo($message["timestamp"])." ago
						</div>	
	...
	SpecialPage::addPage( new ViewUserBoard );
	global $wgMessageCache,$wgOut;
	$wgMessageCache->addMessage( 'userboard', 'User Board' );
}
