...
$messages['en'] = array(
	'autoincrement-desc' => 'A variable hook that adds the autoincrementing variable <nowiki>{{AUTOINCREMENT}}</nowiki>',
);
 ...
 */
$messages['it'] = array(
	'autoincrement-desc' => 'Un hook variabile che aggiunge la variabile autoincrementale <nowiki>{{AUTOINCREMENT}}</nowiki>',
);
