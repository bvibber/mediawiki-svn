...
if($j.wikiEditor){$j('textarea#wpTextbox1').wikiEditor('addModule','toc');}});mw.addOnloadHook(function(){if(!wgWikiEditorPreferences||!(wgWikiEditorPreferences.toolbar&&wgWikiEditorPreferences.toolbar.enable)){return true;}
