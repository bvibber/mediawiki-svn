...
mw.addOnloadHook(function(){if(!wgWikiEditorEnabledModules.highlight){return true;}
if($j.fn.wikiEditor){$j('textarea#wpTextbox1').wikiEditor('addModule','highlight');}});mw.addOnloadHook(function(){if(!wgWikiEditorEnabledModules.preview){return true;}
if($j.fn.wikiEditor){$j('textarea#wpTextbox1').wikiEditor('addModule','preview');}});mw.addOnloadHook(function(){if(!wgWikiEditorEnabledModules.preview){return true;}
if($j.fn.wikiEditor){$j('textarea#wpTextbox1').wikiEditor('addModule','publish');}});mw.addOnloadHook(function(){if(!wgWikiEditorPreferences||!(wgWikiEditorPreferences.toc&&wgWikiEditorPreferences.toc.enable)){return true;}
if($j.fn.wikiEditor){$j('textarea#wpTextbox1').wikiEditor('addModule',{'toc':{'rtl':($j('body').is('.rtl'))}});}});mw.addOnloadHook(function(){if(!wgWikiEditorEnabledModules.toolbar){return true;}
...
var dialog=$j(this).closest('.ui-dialog');$j(this).data('context').$textarea.bind('keypress.srdialog',function(e){if((e.keyCode||e.which)==13){var button=dialog.data('dialogaction')||dialog.find('button:first');button.click();e.preventDefault();}});},close:function(){$j(this).data('context').$textarea.unbind('keypress.srdialog').focus();$j(this).closest('.ui-dialog').data('dialogaction',false);}}}}});}});mw.addOnloadHook(function(){if(!wgWikiEditorEnabledModules.templateEditor){return true;}
