...
$defaultNames = array(
	...
	'wgCopyUploadTimeout' => "Timeout to copy files, when using upload by url on Special:Upload",
	...
	'wgInvalidUsernameCharacter' => "Characters to prevent during new account creations.",
