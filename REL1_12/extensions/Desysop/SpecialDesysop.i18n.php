...
$messages['ar'] = array(
	...
	'desysopsetrights'     => 'اضبط صلاحيات مستخدم',
	'desysoprightsfail'    => '<b>لم يتم ضبط الصلاحيات للمستخدم "$1". (هل أدخلت الاسم بصورة صحيحة?)</b>',
	'desysop'              => 'عزل مستخدم',
...
$messages['cs'] = array(
	...
	'desysopsetrights'     => 'Nastavit práva',
	'desysoprightsfail'    => '<b>Práva uživatele „$1“ nemohla být nastavena. (Zadali jste správně jméno?)</b>',
...
$messages['de'] = array(
	...
	'desysopsetrights'     => 'Administratorstatus entziehen',
	'desysoprightsfail'    => '<b>Benutzerrechte für „$1“ konnten nicht gesetzt werden. Hast du den Namen korrekt eingegeben?</b>',
...
$messages['eo'] = array(
	...
	'desysopsetrights'     => 'Ŝanĝu uzantorajtojn',
	'desysoprightsfail'    => '<b>Uzantorajtoj por "$1" ne povis esti difinataj. (Ĉu vi entajpis la nomon korekte?)</b>',
...
$messages['he'] = array(
	...
	'desysopsetrights'     => 'קבל הרשאות משתמש',
	'desysoprightsfail'    => '\'\'\'שינוי הרשאות המשתמש "$1" נכשל.\'\'\' (האם הקלדתם נכונה את שם המשתמש?)',
...
$messages['hsb'] = array(
	...
	'desysopsetrights'     => 'Wužiwarske prawa zrjadować',
	'desysoprightsfail'    => '<b>Prawa za wužiwarja „$1” njedadźa so nastajić. (Sće mjeno prawje zapisał(a)?)</b>',
	'desysop'              => 'Desysop',
...
$messages['id'] = array(
	...
	'desysopsetrights'     => 'Mengatur hak pengguna',
	'desysoprightsfail'    => "<b>Hak pengguna untuk \"$1\" tidak berhasil diatur. (Apakah Anda telah memasukkan nama yang tepat?)</b>",
...
$messages['it'] = array(
	...
	'desysopsetrights'     => "Imposta permessi utente",
	'desysoprightsfail'    => "<b>Impossibile impostare i permessi per l'utente \"$1\". Assicurarsi che il nome sia stato digitato correttamente.</b>",
...
$messages['ja'] = array(
	...
	'desysopsetrights'     => '利用者権限の設定',
	'desysoprightsfail'    => "<b>利用者 \"$1\" の権限を設定できませんでした。利用者名を正しく入力したか確認してください。</b>",
	'desysop'              => '管理者権限の取り消し',
...
$messages['nl'] = array(
	...
	'desysopsetrights'     => 'Gebruikersrechten aanpassen',
	'desysoprightsfail'    => '<b>Gebruikersrechten voor "$1" konden niet worden aangepast. Heeft u de naam juist ingevoerd?</b>',
...
$messages['no'] = array(
	...
	'desysopsetrights'     => 'Sett brukerrettigheter',
	'desysoprightsfail'    => '<b>Brukerrettigheter for «$1» kunne ikke settes. (Skrev du navnet riktig?)</b>',
...
$messages['oc'] = array(
	...
	'desysopsetrights'     => 'Aplicar los dreches a l’utilizaire',
	'desysoprightsfail'    => '<b>Los dreches de l’utilizaire « $1 » an pas pogut èsser meses a jorn. (Avètz picat lo nom corrèctament ?)<b>',
...
$messages['pms'] = array(
	...
	'desysopsetrights'     => 'Deje sò drit a j\'utent',
...
$messages['ro'] = array(
	...
	'desysopsetrights'     => 'Acordă drepturi de utilizator',
	'desysoprightsfail'    => '<b>Nu au putut fi acordate drepturi de utilizator lui "$1". (Ai introdus numele corect?)</b>',
...
$messages['ru'] = array(
	...
	'desysopsetrights'     => 'Установить права участника',
	'desysoprightsfail'    => "<b>Невозможно установить права для участника $1. (Проверьте, правильно ли введено его имя.)</b>",
...
$messages['sk'] = array(
	...
	'desysopsetrights'     => 'Nastav redaktorove práva',
	'desysoprightsfail'    => '<b>Redaktorove práva pre "$1" nemohli byť nastavené. (zadali ste meno správne?)</b>',
...
$messages['sr-ec'] = array(
	...
	'desysopsetrights'     => 'Постави корисничка права',
	'desysoprightsfail'    => "<b>Корисничка права за корисника \"$1\" је немогуће поставити. (Да ли сте унели корисничко име исправно??)</b>",
...
$messages['sr-el'] = array(
	...
	'desysopsetrights'     => 'Postavi korisnička prava',
	'desysoprightsfail'    => "<b>Korisnička prava za korisnika \"$1\" je nemoguće postaviti. (Da li ste uneli korisničko ime ispravno??)</b>",
...
$messages['su'] = array(
	...
	'desysopsetrights'     => 'Setél kawenangan pamaké',
...
$messages['yue'] = array(
	...
	'desysopname'          => '用戶名：',
	'desysopok'            => "<b>用戶\"$1\"已經唔再係操作員喇</b>",
	'desysopsetrights'     => '設定用戶權限',
	'desysoprightsfail'    => "<b>\"$1\"嘅用戶權限無法設定。（您係咪已經輸入咗正確嘅名？）</b>",
...
$messages['zh-hans'] = array(
	...
	'desysopsetrights'     => '设置用户权限',
	'desysoprightsfail'    => "<b>\"$1\"的用户权限无法设置。（您是否已经输入正确的名称？）</b>",
...
$messages['zh-hant'] = array(
	...
	'desysopsetrights'     => '設定用戶權限',
	'desysoprightsfail'    => "<b>\"$1\"的用戶權限無法設定。（您是否已經輸入正確的名稱？）</b>",
