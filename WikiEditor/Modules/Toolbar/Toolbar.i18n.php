 ...
 */
$messages['af'] = array(
	'wikieditor-toolbar' => 'Wysigings-werksbalk',
	...
	'wikieditor-toolbar-tool-italic-example' => 'Skuins gedrukte teks',
	...
	'wikieditor-toolbar-tool-link-int-target-status-loading' => 'Kontroleer of die bladsy al reeds bestaan...',
	'wikieditor-toolbar-tool-link-int-invalid' => 'Die titel wat u verskaf het is ongeldig.',
	'wikieditor-toolbar-tool-link-lookslikeinternal' => "Die URL wat u verskaf het lyk asof dit bedoel is as skakel na 'n ander wikibladsy. Wil u dit na 'n interne skakel verander?",
	...
	'wikieditor-toolbar-group-baseline' => 'Basislyn',
...
| ry 2, sel 3',
	...
	'wikieditor-toolbar-help-content-xlink-result' => "<a href='#' class='external'>Skakel se etiket</a><br /><a href='#' class='external autonummering'>[1]</a><br /><a href='#' class='external'>http://www.voorbeeld.org</a>",
...
$messages['ar'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'أدخل عنوان الصفحة',
...
$messages['be-tarask'] = array(
	...
	'wikieditor-toolbar-tool-link-empty' => 'Вы не ўвялі нічога для спасылкі',
	...
	'wikieditor-toolbar-tool-indent-example' => 'Радок абзаца',
...
| ред 2, клетка 3',
	...
	'wikieditor-toolbar-help-content-heading1-description' => 'Заглавие от първо ниво',
	'wikieditor-toolbar-help-content-heading1-syntax' => '= Текст на заглавието =',
	'wikieditor-toolbar-help-content-heading1-result' => '<h1>Текст на заглавието</h1>',
	...
	'wikieditor-toolbar-help-content-file-syntax' => '[[{{ns:file}}:Example.png|мини|Текст под картинка]]',
	...
	'wikieditor-toolbar-help-content-indent-syntax' => 'Нормален текст<br />:Текст с отстъп<br />::Текст с отстъп',
	'wikieditor-toolbar-help-content-indent-result' => 'Нормален текст<dl><dd>Текст с отстъп<dl><dd>Текст с отстъп</dd></dl></dd></dl>',
);
...
$messages['br'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Ebarzhit titl ar bajenn',
	'wikieditor-toolbar-tool-link-int-text' => 'Testenn al liamm :',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => 'Ebarzhit an destenn a zlefe bezañ diskwelet',
	...
	'wikieditor-toolbar-tool-indent-example' => 'Linenn endantadur',
...
| linenn 2, kellig 3',
	...
	'wikieditor-toolbar-tool-table-invalidnumber' => "N'ho peus ket lakaet un niver mat a linennoù hag a golonennoù.",
...
$messages['bs'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Unesite naslov stranice',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'URL koji ste naveli izgleda da je prepoznat kao link na drugu wiki stranicu. Da li želite napraviti interni link?',
...
$messages['cs'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Zadejte název stránky',
	'wikieditor-toolbar-tool-link-int-text' => 'Text odkazu:',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => 'Zadejte text, který se má zobrazit',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'Uvedené URL vypadá jako odkaz na jinou stránku této wiki. Chcete z něj tedy udělat vnitřní odkaz?',
...
$messages['cy'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Gosodwch deitl y dudalen',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => "Mae'n ymddangos bod yr URL a osodwyd yn arwain at dudalen arall yn y wici. Ydych chi am ei osod ar ffurf cyswllt mewnol?",
...
$messages['de'] = array(
	...
	'wikieditor-toolbar-dialogs-preference' => 'Dialoge aktivieren für das Einfügen von Links, Tabellen und mehr',
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Seitentitel eingeben',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'Die angegebene URL sieht so aus, als ob sie auf eine andere Wikiseite verlinken würde. Möchtest du daraus einen internen Link machen?',
...
$messages['diq'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'URLyo ke şıma nişan kerdo, pelê yewna wikiyi re gıre biyo aseno. şıma wazeni no gıre yew gıreyo daxili bıbo?',
	...
	'wikieditor-toolbar-group-size' => 'endam/bejn/qam',
	...
	'wikieditor-toolbar-group-baseline' => 'temel/bıngeh',
...
| satır 2, hucre 3',
	...
	'wikieditor-toolbar-tool-replace-close' => 'ibtal',
	...
	'wikieditor-toolbar-help-content-heading1-description' => 'sernameyê seviyeya 1.',
	'wikieditor-toolbar-help-content-heading1-syntax' => '= sernamêyê metni =',
	'wikieditor-toolbar-help-content-heading1-result' => 'sernameyê metni',
...
$messages['dsb'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Titel boka zapódaś',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'URL, kótaryž sy pódał, wuglěda, ako by był za wótkaz k drugemu wikibokoju. Coš jen do internego wótkaza psétwóriś?',
...
$messages['eo'] = array(
	...
	'wikieditor-toolbar-dialogs-preference' => 'Ŝalti dialogujojn por aldoni ligilojn, tabelojn, kaj pliaĵojn',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'La URL, kiun vi specifis, aspektas kvazaŭ ĝi estus ligilo al alia vikipaĝo. Ĉu vi volas refari ĝin kiel internan ligilon?',
	'wikieditor-toolbar-tool-link-lookslikeinternal-int' => 'Interna ligilo',
	'wikieditor-toolbar-tool-link-lookslikeinternal-ext' => 'Ekstera ligilo',
...
| vico 2, ĉelo 3',
	...
	'wikieditor-toolbar-tool-table-toomany' => 'Enmetante tabelon kun pli ol $1 ĉeloj ne eblas per ĉi tiu dialogujo.',
	'wikieditor-toolbar-tool-table-invalidnumber' => 'Vi ne enigis validan nombron de vicoj aŭ kolumnoj.',
	'wikieditor-toolbar-tool-table-zero' => 'Vi ne eblas enigi tabelon kun nul vicoj aŭ kolumnoj.',
	...
	'wikieditor-toolbar-tool-replace-button-findnext' => 'Trovi poste',
	'wikieditor-toolbar-tool-replace-button-replacenext' => 'Anstataŭigi poste',
	...
	'wikieditor-toolbar-tool-replace-emptysearch' => 'Vi ne enigis iun ajn por serĉi.',
	'wikieditor-toolbar-tool-replace-invalidregex' => 'La regula esprimo kiun vi enigis estas malvalida: $1',
...
$messages['es'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal-int' => 'Vínculo interno',
	'wikieditor-toolbar-tool-link-lookslikeinternal-ext' => 'Vínculo externo',
...
$messages['eu'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Idatzi orriaren izenburua',
...
$messages['fr'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => "L'URL que vous avez spécifié semble lier vers une autre page du wiki. Voulez-vous utiliser un lien interne à la place ?",
...
$messages['frp'] = array(
	...
	'wikieditor-toolbar-help-content-heading3-description' => 'Titro de 3<sup>o</sup> nivél',
	...
	'wikieditor-toolbar-help-content-heading4-description' => 'Titro de 4<sup>o</sup> nivél',
	...
	'wikieditor-toolbar-help-content-heading5-description' => 'Titro de 5<sup>o</sup> nivél',
...
$messages['gl'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Insira o título da páxina',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'O enderezo URL que especificou semella ser unha ligazón cara a outra páxina do wiki. Quere converter ese enderezo nunha ligazón interna?',
...
$messages['gsw'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'D URL, wu Du yygee hesch, siht uus wie ne Gleich zuen ere andre Wikisyte. Wettsch e intärn Gleich setze?',
...
| שורה 2, תא 3',
	...
	'wikieditor-toolbar-tool-replace-button-replacenext' => 'החלפת הבא',
...
$messages['hsb'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'URL, kotryž sy podał, wupada kaž by jako wotkaz k druhej wikistronje měrjeny był. Chceš jón do interneho wotkaza přetworić?',
...
$messages['hu'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'Úgy tűnik, hogy a megadott URL másik wiki lapra mutató hivatkozás akart lenni. Szeretnéd belső hivatkozássá alakítani?',
...
$messages['hy'] = array(
	...
	'wikieditor-toolbar-tool-file' => 'Ներդրված ֆայլ',
	...
	'wikieditor-toolbar-group-list' => 'Ցանկ',
	...
	'wikieditor-toolbar-group-baseline' => 'Տողահիմք',
...
| տող 2, սյունակ 3',
	...
	'wikieditor-toolbar-help-page-file' => 'Ֆայլեր',
	...
	'wikieditor-toolbar-help-content-heading1-description' => '1-ին մակարդակի վերնագիր',
	'wikieditor-toolbar-help-content-heading1-syntax' => '= Վերնագրի տեքստ =',
	'wikieditor-toolbar-help-content-heading1-result' => '<h1>Վերնագրի տեքստ</h1>',
...
$messages['ia'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Entra le titulo del pagina',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'Le URL que tu specificava pare esser intendite como ligamine a un altere pagina wiki. Vole tu facer lo un ligamine interne?',
...
$messages['id'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Masukkan judul halaman',
...
$messages['it'] = array(
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => "La URL che hai indicato sembra un link verso un'altra pagina wiki. Vuoi che sia un link interno?",
...
$messages['ja'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'ページ名を入力してください',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => '指定された URL は別のウィキページへのリンクのようです。これを内部リンクにしますか？',
...
$messages['ko'] = array(
	...
	'wikieditor-toolbar-dialogs-preference' => '링크와 표 등을 쉽게 추가할 수 있는 명령을 사용하기',
...
| 2행 3열',
	...
	'wikieditor-toolbar-tool-replace-close' => '취소',
...
$messages['lb'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Gitt den Titel vun der Säit an',
...
$messages['mk'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Внесете наслов на страницата',
	...
	'wikieditor-toolbar-tool-link-empty' => 'Не внесовте дестинација за врската.',
...
| ред 2, ќелија 3',
	...
	'wikieditor-toolbar-tool-replace-close' => 'Откажи',
...
$messages['ml'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'താളിന്റെ തലക്കെട്ട് നൽകുക',
	...
	'wikieditor-toolbar-group-list' => 'ലിസ്റ്റ്',
...
| വരി 2, കളം 3',
	...
	'wikieditor-toolbar-help-content-heading1-description' => 'പ്രഥമ തല തലക്കെട്ട്',
	'wikieditor-toolbar-help-content-heading1-syntax' => '= തലക്കെട്ട് എഴുത്ത് =',
	'wikieditor-toolbar-help-content-heading1-result' => '<h1>തലക്കെട്ട് എഴുത്ത്</h1>',
...
$messages['nl'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target' => 'Paginanaam:',
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Voer de paginanaam in',
	'wikieditor-toolbar-tool-link-int-text' => 'Beschrijving verwijzing:',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => 'Voer de weer te geven tekst in',
...
$messages['nn'] = array(
	...
	'wikieditor-toolbar-tool-link-title' => 'Set inn lenke',
	...
	'wikieditor-toolbar-tool-link-insert' => 'Set inn lenke',
	...
	'wikieditor-toolbar-tool-link-empty' => 'Du skreiv ikkje inn noko å lenka til.',
	'wikieditor-toolbar-tool-file-example' => 'Døme.jpg',
	'wikieditor-toolbar-tool-reference' => 'Referanse',
	'wikieditor-toolbar-tool-reference-example' => 'Set inn fotnotetekst her',
	...
	'wikieditor-toolbar-tool-small-example' => 'Nummerert liste',
	'wikieditor-toolbar-group-baseline' => 'Grunnlinje',
...
{{ns:file}}:Døme.jpg|Bilettekst2',
	...
	'wikieditor-toolbar-tool-table-toomany' => 'Det er ikkje mogleg å setja inn meir enn $1 celler med denne boksen',
...
$messages['oc'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Entratz lo títol de la pagina',
...
$messages['pdc'] = array(
	...
	'wikieditor-toolbar-help-content-heading1-syntax' => '= Iwwerschrift =',
	'wikieditor-toolbar-help-content-heading1-result' => '<h1>Iwwerschrift</h1>',
...
$messages['pl'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Wpisz tytuł strony',
...
$messages['pms'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => "Ch'a anserissa ël tìtol dla pàgina",
	...
	'wikieditor-toolbar-group-size' => 'Grandëssa',
	'wikieditor-toolbar-tool-big' => 'Grand',
	...
	'wikieditor-toolbar-group-baseline' => 'Linia ëd base',
...
| linia 2, casela 3',
	...
	'wikieditor-toolbar-tool-replace-close' => 'Scancelé',
	...
	'wikieditor-toolbar-help-content-heading1-description' => 'Antestassion ëd 1<sup>m</sup> livel',
	'wikieditor-toolbar-help-content-heading1-syntax' => "= Test ëd l'antestassion =",
	'wikieditor-toolbar-help-content-heading1-result' => "<h1>Test ëd l'antestassion</h1>",
...
$messages['pt'] = array(
	...
	'wikieditor-toolbar-tool-link-title' => 'Inserir uma ligação',
	'wikieditor-toolbar-tool-link-int' => 'Para uma página wiki',
	'wikieditor-toolbar-tool-link-int-target' => 'Título da página:',
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Introduza o título da página',
	...
	'wikieditor-toolbar-tool-link-int-target-status-loading' => 'A verificar existência da página...',
...
| linha 2, coluna 3',
	...
	'wikieditor-toolbar-tool-replace-case' => 'Maiúsculas distintas de minúsculas',
...
$messages['ro'] = array(
	...
	'wikieditor-toolbar-preference' => 'Activaţi modificarea ridicată a barei de instrumente',
	'wikieditor-toolbar-dialogs-preference' => 'Activează bare pentru a insera legături, tabele şi altele',
	...
	'wikieditor-toolbar-tool-link-title' => 'Adaugă legătură',
	'wikieditor-toolbar-tool-link-int' => 'Către o pagină wiki',
	'wikieditor-toolbar-tool-link-int-target' => 'Pagina ţintă sau URL:',
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Introduceţi titlul paginii',
	'wikieditor-toolbar-tool-link-int-text' => 'Text afişat:',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => 'Introduceţi textul care ar trebui afişat',
	...
	'wikieditor-toolbar-tool-link-insert' => 'Introduceţi legătură',
	...
	'wikieditor-toolbar-tool-link-int-target-status-loading' => 'Verific existenţa paginii...',
	'wikieditor-toolbar-tool-link-int-invalid' => 'Titlul specificat nu este corect.',
	'wikieditor-toolbar-tool-link-lookslikeinternal' => 'URL-ul specificat arată ca şi o legătură către altă pagină wiki. Doriţi să o transformaţi într-o legătură internă?',
	...
	'wikieditor-toolbar-tool-link-empty' => 'Nu aţi introdus nimic către care să stabilesc o legătură.',
	'wikieditor-toolbar-tool-file' => 'Fişier inserat',
	'wikieditor-toolbar-tool-file-example' => 'Exemplu.jpg',
	'wikieditor-toolbar-tool-reference' => 'Referinţă',
	'wikieditor-toolbar-tool-reference-example' => 'Introduceţi textul notei de subsol aici.',
	...
	'wikieditor-toolbar-group-baseline' => 'Linie de bază',
	'wikieditor-toolbar-tool-superscript' => 'Exponent',
...
| rând 2, celula 3',
	...
	'wikieditor-toolbar-tool-table-title' => 'Inseraţi tabelul',
	'wikieditor-toolbar-tool-table-dimensions-rows' => 'Linii',
	'wikieditor-toolbar-tool-table-dimensions-columns' => 'Coloane',
	'wikieditor-toolbar-tool-table-dimensions-header' => 'Adăugaţi titlu coloană acum',
	'wikieditor-toolbar-tool-table-wikitable' => 'Sil cu contur',
	'wikieditor-toolbar-tool-table-sortable' => 'Faceţi tabelul sortabil',
	'wikieditor-toolbar-tool-table-example' => 'Exemplu',
	'wikieditor-toolbar-tool-table-preview' => 'Previzualizare',
	'wikieditor-toolbar-tool-table-insert' => 'Inserare',
	...
	'wikieditor-toolbar-tool-table-invalidnumber' => 'Nu aţi introdus un număr valabil de rânduri sau coloane.',
	'wikieditor-toolbar-tool-table-zero' => 'Nu puteţi introduce un tabel cu zero rânduri sau coloane.',
	'wikieditor-toolbar-tool-replace' => 'Căutare şi înlocuire',
	'wikieditor-toolbar-tool-replace-title' => 'Căutare şi înlocuire',
	'wikieditor-toolbar-tool-replace-search' => 'Cautare:',
	'wikieditor-toolbar-tool-replace-replace' => 'Înlocuire cu:',
	'wikieditor-toolbar-tool-replace-case' => 'Înlocuieşte doar dacă este identic',
	'wikieditor-toolbar-tool-replace-regex' => 'Tratează sintagma ca o expresie regulată',
	'wikieditor-toolbar-tool-replace-button-findnext' => 'Găseşte următorul',
	'wikieditor-toolbar-tool-replace-button-replacenext' => 'Înlocuieşte următorul',
	'wikieditor-toolbar-tool-replace-button-replaceall' => 'Înlocuieşte toate',
	'wikieditor-toolbar-tool-replace-close' => 'Revocare',
	'wikieditor-toolbar-tool-replace-nomatch' => 'Căutarea dumneavoastră nu a generat niciun rezultat.',
	'wikieditor-toolbar-tool-replace-success' => '$1 înlocuire(i) efectuate.',
	'wikieditor-toolbar-tool-replace-emptysearch' => 'Nu aţi introdus niciun cuvânt după care să căutaţi',
	...
	'wikieditor-toolbar-help-heading-syntax' => 'Ceea ce scrieţi',
	'wikieditor-toolbar-help-heading-result' => 'Ceea ce obţineţi',
	...
	'wikieditor-toolbar-help-content-showreferences-description' => 'Arată referinţele',
	'wikieditor-toolbar-help-content-showreferences-result' => "<ol class='references'><li id='cite_note-test-0'><b><a title='' href='#'>^</a></b> <a rel='nofollow' title='http://www.example.org' class='external text' href='#'>Textul legăturii</a>, text adiţional.</li></ol>",
	'wikieditor-toolbar-help-content-signaturetimestamp-description' => 'Semnătură cu dată',
...
$messages['ru'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Введите название страницы',
...
$messages['sah'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Сирэй аатын суруй',
...
$messages['te'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'పేజీ శీర్షికని ఇవ్వండి',
...
$messages['th'] = array(
	...
	'wikieditor-toolbar-tool-italic' => 'ตัวเอียง',
	'wikieditor-toolbar-tool-italic-example' => 'ตัวอักษรเอียง',
	'wikieditor-toolbar-tool-ilink' => 'ลิงก์ภายใน',
	'wikieditor-toolbar-tool-ilink-example' => 'ชื่อลิงก์',
	'wikieditor-toolbar-tool-xlink' => 'ลิงก์ภายนอก (อย่าลืมขึ้นต้นด้วย http://)',
	'wikieditor-toolbar-tool-xlink-example' => 'http://www.example.com ชื่อลิงก์',
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'ใส่ชื่อหัวข้อของหน้านี้',
	'wikieditor-toolbar-tool-link-int-text' => 'แสดงตัวอักษร:',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => 'ใส่ตัวอักษรที่ควรจะปรากฎ',
	...
	'wikieditor-toolbar-tool-link-int-target-status-invalid' => 'ชื่อหัวข้อไม่ถูกต้อง',
	...
	'wikieditor-toolbar-tool-signature' => 'ลายเซ็นต์และลงวันที่',
	...
	'wikieditor-toolbar-group-list' => 'รายการ',
	'wikieditor-toolbar-tool-olist' => 'รายการมีหมายเลขขึ้นต้น',
	...
	'wikieditor-toolbar-tool-replace-button-replaceall' => 'แทนที่ทุกตัวที่พบ',
	'wikieditor-toolbar-tool-replace-close' => 'ยกเลิก',
...
$messages['tk'] = array(
	...
	'wikieditor-toolbar-group-list' => 'Sanaw',
	...
	'wikieditor-toolbar-group-size' => 'Ölçeg',
	...
	'wikieditor-toolbar-group-baseline' => 'Esasy setir',
...
| hatar 2, öýjük 3',
	...
	'wikieditor-toolbar-tool-replace-close' => 'Goýbolsun et',
	...
	'wikieditor-toolbar-help-content-heading1-description' => '1-nji derejeli at',
	'wikieditor-toolbar-help-content-heading1-syntax' => '= Adyň teksti =',
	'wikieditor-toolbar-help-content-heading1-result' => '<h1>Adyň teksti</h1>',
...
$messages['tr'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Sayfa başlığını girin',
	...
	'wikieditor-toolbar-tool-indent-example' => 'Girintili çizgi',
...
$messages['uk'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Введіть назву сторінки',
...
| рядок 2, комірка 3',
	...
	'wikieditor-toolbar-tool-replace-close' => 'Скасувати',
...
$messages['vec'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Inserissi el titolo de la pagina',
...
$messages['vi'] = array(
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => 'Hãy nhập tên trang',
...
$messages['vo'] = array(
	...
	'wikieditor-toolbar-group-list' => 'Lised',
...
$messages['wo'] = array(
	...
	'wikieditor-toolbar-group-list' => 'Lim',
	...
	'wikieditor-toolbar-group-size' => 'Dayoo',
	...
	'wikieditor-toolbar-group-baseline' => 'Rëdduw dàtt',
...
$messages['zh-hans'] = array(
	...
	'wikieditor-toolbar-dialogs-preference' => '使用对话框插入链接、表格等',
	...
	'wikieditor-toolbar-tool-link-int-target-tooltip' => '输入页面标题',
	'wikieditor-toolbar-tool-link-int-text' => '显示文本：',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => '输入应该显示的文字',
	...
	'wikieditor-toolbar-tool-link-lookslikeinternal' => '您输入的URL似乎指向另一个wiki页面。您是否希望将其改为内部链接？',
...
| 第二行第三个单元格',
	...
	'wikieditor-toolbar-tool-table-dimensions-header' => '设置标题行',
	'wikieditor-toolbar-tool-table-wikitable' => '设置边框格式',
...
$messages['zh-hant'] = array(
	...
	'wikieditor-toolbar-tool-link-title' => '插入鏈接',
	'wikieditor-toolbar-tool-link-int' => '鏈往wiki頁面',
	'wikieditor-toolbar-tool-link-int-target' => '目標頁面或網址：',
	'wikieditor-toolbar-tool-link-int-target-tooltip' => '輸入頁面標題',
	'wikieditor-toolbar-tool-link-int-text' => '顯示文本：',
	'wikieditor-toolbar-tool-link-int-text-tooltip' => '輸入應該顯示的文字',
	'wikieditor-toolbar-tool-link-ext' => '鏈往外部網頁',
	'wikieditor-toolbar-tool-link-ext-target' => '鏈接網址：',
	'wikieditor-toolbar-tool-link-ext-text' => '鏈接描述文本：',
	'wikieditor-toolbar-tool-link-insert' => '插入鏈接',
	'wikieditor-toolbar-tool-link-cancel' => '取消',
	'wikieditor-toolbar-tool-link-int-target-status-exists' => '頁面已存在',
	'wikieditor-toolbar-tool-link-int-target-status-notexists' => '頁面不存在',
	'wikieditor-toolbar-tool-link-int-target-status-invalid' => '無效標題',
	'wikieditor-toolbar-tool-link-int-target-status-external' => '外部鏈接',
	'wikieditor-toolbar-tool-link-int-target-status-loading' => '檢查頁面是否存在...',
	'wikieditor-toolbar-tool-link-int-invalid' => '您所指定的標題無效。',
	'wikieditor-toolbar-tool-link-lookslikeinternal' => '您輸入的URL似乎指向另一個wiki頁面。您是否希望將其改為內部鏈接？',
	'wikieditor-toolbar-tool-link-lookslikeinternal-int' => '內部鏈接',
	'wikieditor-toolbar-tool-link-lookslikeinternal-ext' => '外部鏈接',
	'wikieditor-toolbar-tool-link-empty' => '您沒有輸入鏈接內容。',
	'wikieditor-toolbar-tool-file' => '結合標題',
	'wikieditor-toolbar-tool-file-example' => 'Example.jpg',
	'wikieditor-toolbar-tool-reference' => '參考',
...
| 行 2, 格 2
| 行 2, 格 3',
	'wikieditor-toolbar-tool-table-example-header' => '標頭文本',
	'wikieditor-toolbar-tool-table-title' => '插入表格',
	'wikieditor-toolbar-tool-table-dimensions-rows' => '行',
	'wikieditor-toolbar-tool-table-dimensions-columns' => '列',
	'wikieditor-toolbar-tool-table-dimensions-header' => '設置標題行',
	'wikieditor-toolbar-tool-table-wikitable' => '設置邊框格式',
...
| 行 2, 格 3',
	...
	'wikieditor-toolbar-tool-table-insert' => '插入',
	'wikieditor-toolbar-tool-table-cancel' => '取消',
	'wikieditor-toolbar-tool-table-toomany' => '在這個對話框中無法插入超過$1個單元格的表格。',
	'wikieditor-toolbar-tool-table-invalidnumber' => '您輸入的行數或列數無效。',
	'wikieditor-toolbar-tool-table-zero' => '您不能插入一個零行或零列的表格。',
	'wikieditor-toolbar-tool-replace' => '查找和替換',
	'wikieditor-toolbar-tool-replace-title' => '查找和替換',
	'wikieditor-toolbar-tool-replace-search' => '查找：',
