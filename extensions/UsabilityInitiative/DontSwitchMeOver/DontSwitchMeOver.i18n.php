<?php
/**
 * Internationalization for DontSwitchMeOver extension
 *
 * @file
 * @ingroup Extensions
 */
...
$messages['be-tarask'] = array(
	'dontswitchmeover-desc' => 'Дадае карыстальнікам магчымасьць вызначыць, ці жадаюць яны захаваць цяперашняе афармленьне падчас зьмены стандартнага афармленьня.',
 ...
 */
$messages['de'] = array(
	'dontswitchmeover-desc' => 'Einstellung für Benutzer, die es ermöglicht, den Skin bei einer Änderung des Standardskins beizubehalten.',
	'dontswitchmeover-pref' => 'Änderung meines Skins nicht erlauben, wenn Standardskin geändert wird',
);
 ...
 */
$messages['dsb'] = array(
	'dontswitchmeover-desc' => 'Nastajenje za wužywarjow, aby pódało, lěc kśě swóje drastowe nastajenje składowaś, gaž standardna drasta se změnijo.',
 ...
 */
$messages['ia'] = array(
	'dontswitchmeover-desc' => 'Preferentia de usator que permitte preservar le configuration de apparentia si le apparentia predefinite es cambiate.',
	'dontswitchmeover-pref' => 'Non cambiar mi apparentia si le apparentia predefinite es cambiate',
);
 ...
 */
$messages['id'] = array(
	'dontswitchmeover-desc' => 'Preferensi pengguna untuk menentukan apakah mereka ingin menyimpan pengaturan kulit mereka ketika kulit baku berubah.',
 ...
 */
$messages['mk'] = array(
	'dontswitchmeover-desc' => 'Со ова корисниците можат да укажат дали сакаат да го задржат нивното руво кога се менува основното руво.',
	'dontswitchmeover-pref' => 'Не ми го менувај рувото кога ќе се смени основното руво.',
);
