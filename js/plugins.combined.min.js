...
function stopDrag(e){$().unbind('mousemove',drag).unbind('mouseup',stopDrag);context.modules.$toc.find('div').autoEllipse({'position':'right','tooltip':true});var mR=e.pageX-$('#wikiEditor-ui-bottom').offset().left;mR=$('#wikiEditor-ui-bottom').width()-mR;if(mR<50&&wgNavigableTOCCollapseEnable){collapse();}else{$('#wikiEditor-ui-text textarea').trigger('mouseup');}
return false;}
function collapse(){if($('#wikiEditor-ui-toolbar .tab-toc').size()==0){$contentsTab=$('<span class="tab tab-toc" rel="characters"><a class="" href="#">Show Contents</a></span>').hide().bind('click',expand);$($contentsTab).insertAfter('#wikiEditor-ui-toolbar .tabs');}
$('#wikiEditor-ui-toolbar .tab-toc').show('fast');$('#wikiEditor-ui-toc').animate({'width':'1px'},'fast',function(){$(this).hide();}).prev().animate({'marginRight':'1px'},'fast',function(){$(this).css('marginRight','-1px');});}
function expand(){$('#wikiEditor-ui-toolbar .tab-toc').hide('fast');$('#wikiEditor-ui-toc').show().animate({'width':$('#wikiEditor-ui-toc').data('openWidth')+'px'},'fast',function(){$('#wikiEditor-ui-text textarea').trigger('mouseup');}).prev().animate({'marginRight':$('#wikiEditor-ui-toc').data('openWidth')+'px'},'fast');}
function buildResizeControls(){var $resizeControlVertical=$('<div />').attr('id','wikiEditor-ui-toc-resize-vertical').bind('mousedown',function(){$('#wikiEditor-ui-toc').data('openWidth',$('#wikiEditor-ui-toc').width());$().bind('mousemove',drag).bind('mouseup',stopDrag);});var $resizeControlHorizontal=$('<div />').attr('id','wikiEditor-ui-toc-resize-horizontal').bind('mousedown',function(){$('#wikiEditor-ui-toc').data('openWidth',$('#wikiEditor-ui-toc').width());$().bind('mousemove',drag).bind('mouseup',stopDrag);});return $resizeControlVertical.add($resizeControlHorizontal);}
