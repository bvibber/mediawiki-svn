...
$messages['km'] = array(
	...
	'optin-success-out' => 'អ្នកបានចាកចេញពីបេតាដោយជោគជ័យហើយ។ អ្នកអាចសាកប្រើវាម្ដងទៀតនៅពេលណាក៏ដោយ ដោយចុចលើពាក្យ "{{int:optin-try}}" នៅផ្នែកខាងលើខាងស្ដាំនៃអេក្រង់របស់អ្នក។',
