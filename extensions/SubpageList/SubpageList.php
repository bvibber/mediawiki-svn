...
if( defined( 'MEDIAWIKI' ) ) {
	...
	$wgExtensionCredits['parserhook'][] = array(
		'name' => 'Subpage List',
		'version'     => '1.1',
		'url'         => 'http://www.mediawiki.org/wiki/Extension:Subpage_List',
		'author'      => 'Rob Church',
		'description' => 'Add a <nowiki><subpages /></nowiki> tag which produces a linked list of all subpages of the current page',
	);
