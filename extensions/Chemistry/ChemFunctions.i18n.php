...
$wgChemFunctions_Messages['de'] = array(
	...
	'ChemFunctions_SearchExplanation' => '',
	'ChemFunctions_DataList' => 'Nachfolgend finden Sie Links zu Seiten, die eventuell Informationen √ºber chemische Substanzen anbieten, nach denen Sie suchen:<br /><br />
...
$wgChemFunctions_Messages['nl'] = array(
	'chemicalsources' => 'Chemicali√´n bronnen',
	'ChemFunctions_ListPage' => 'Chemicali√´n bronnen',
	'ChemFunctions_SearchExplanation' => '',
...
$wgChemFunctions_Messages['sk'] = array(
	'chemicalsources' => 'Chemick√© zdroje',
	'ChemFunctions_ListPage' => 'Chemick√© zdroje',
	'ChemFunctions_SearchExplanation' => '',
	'ChemFunctions_DataList' => 'Ni≈æ≈°ie je zoznam odkazov na str√°nky, ktor√© m√¥≈æu poskytn√∫≈• inform√°cie o chemik√°lii, ktor√∫ pou≈æ√≠vate.<br /><br />
	* <a href="http://webbook.nist.gov/cgi/cbook.cgi?ID=$MIXCASNameFormula&amp;Units=SI">Zl√∫ƒçenina $MIXCASNameFormula na NIST</a><br />
	* <a href="http://ptcl.chem.ox.ac.uk/MSDS/">MSDS na Oxford University (UK) (ned√° sa vyhƒæad√°va≈•)</a><br />',
	'ChemFunctions_CAS' => 'CAS ƒç√≠slo',
	'ChemFunctions_EINECS' => 'Einecs',
	'ChemFunctions_CHEBI' => 'CHEBI',
	'ChemFunctions_PubChem' => 'PubChem',
	'ChemFunctions_SMILES' => 'SMILES',
	...
	'ChemFunctions_ECNumber' => 'ECNumber',
	'ChemFunctions_Formula' => 'Formula',
	'ChemFunctions_Name' => 'IUPAC n√°zov',
...
$wgChemFunctions_Messages['vi'] = array(
	'chemicalsources' => 'Ngu?n hÛa h?c',
	'ChemFunctions_ListPage' => 'Ngu?n hÛa h?c',
	'ChemFunctions_SearchExplanation' => '',
	'ChemFunctions_DataList' => '–‚y l‡ danh s·ch nh?ng website cÛ th? cung c?p thÙng tin v? ch?t hÛa h?c n‡y:<br /><br />
	* <a href="http://webbook.nist.gov/cgi/cbook.cgi?ID=$MIXCASNameFormula&Units=SI">Ch?t $MIXCASNameFormula t?i NIST</a><br />
	* <a href="http://ptcl.chem.ox.ac.uk/MSDS/">MSDS t?i –?i h?c Oxford (Anh)</a> (khÙng cÛ b? tÏm ki?m)<br />',
	...
	'ChemFunctions_DrugBank' => 'DrugBank',
	'ChemFunctions_ECNumber' => 'ECNumber',
	'ChemFunctions_Formula' => 'CÙng th?c',
	'ChemFunctions_Name' => 'TÍn IUPAC',
