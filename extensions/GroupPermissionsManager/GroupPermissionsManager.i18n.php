 ...
 */
$messages['he'] = array(
	'grouppermissions' => 'נהל את הרשאות הקבוצה',
	'sortpermissions' => 'סדר הרשאות',
	'removeunusedgroups' => 'הסר קבוצות שאינן בשימוש',
	'grouppermissions-desc' => 'נהל את הרשאות הקבוצות דרך [[Special:GroupPermissions|עמוד מיוחד]]',
	'grouppermissions-desc2' => 'מערכת הרשאות מורחבת',
	'grouppermissions-desc3' => 'מאפשר להתאים אישית את פעולות התוכן (לשוניות)',
	'grouppermissions-desc4' => 'מאפשר הוספת פריטים נוספים אל ארגז הכלים',
	'grouppermissions-desc-nsm' => 'נהל את מתחמי השמות דרך עמוד מיוחד',
	'grouppermissions-header' => 'תוכל להשתמש בעמוד זה כדי לשנות את ההגדרות החבויות של קבוצות המשתמשים השונות.',
	'grouppermissions-search' => 'קבוצה:',
	'grouppermissions-dologin' => 'התחברות',
	'grouppermissions-dosearch' => 'עבור',
	'grouppermissions-searchlabel' => 'חפש אחר קבוצות',
	'grouppermissions-deletelabel' => 'מחק קבוצה',
	'grouppermissions-error' => "ארעה שגיאה בלתי ידועה, אנא לחץ על לחצן ה'חזור' בדפדפן שלך ונסה שוב",
	'grouppermissions-change' => 'שנה את הרשאות הקבוצה',
	'grouppermissions-add' => 'הוסף קבוצה',
	'grouppermissions-delete' => 'מחק קבוצה',
	...
	'grouppermissions-nooldrev' => 'ארעה שגיאה בעת הנסיון לגניזת קובץ התצורה הנוכחי. לא יווצר ארכיון.',
	'grouppermissions-display' => '$1 ($2)',
	...
	'grouppermissions-log-add' => 'נוספה הקבוצה "$2"',
	'grouppermissions-log-change' => 'הרשאות הקבוצה "$2" שונו',
	'grouppermissions-log-delete' => 'נמחקה הקבוצה "$2"',
	'grouppermissions-log-name' => 'רשומת הרשאות הקבוצות',
	'grouppermissions-log-header' => 'עמוד זה עוקב אחר השינויים בהרשאות הבסיסיות של קבוצות המשתמשים.',
	'grouppermissions-needjs' => "אזהרה: ג'אווהסקריפט מבוטל בדפדפן שלך. יתכן וכמה מהתכונות לא יעבדו!",
	'grouppermissions-sp-header' => 'תוכל להשתמש בעמוד זה כדי לנהל את סידור ההרשאות ולהוסיף הרשאות חדשות. עבור עם הסמן מעל להרשאה כדי לקרוא את תיאורה',
	'grouppermissions-sp-sort' => 'סדר הרשאות',
	'grouppermissions-sp-save' => 'שמור',
	'grouppermissions-sp-success' => 'ההרשאות סודרו בהצלחה',
	'grouppermissions-sp-addtype' => 'הוסף סוג סידור',
	'grouppermissions-sp-addperm' => 'הוסף הרשאה',
	'grouppermissions-sp-remove' => 'הסר',
	'grouppermissions-sp-deltype' => 'מחק את סוג הסידור',
	'grouppermissions-rug-header' => 'תוכל להשתמש בעמוד זה כדי להסיר משתמשים מקבוצות (מחוקות) שאינן בשימוש.',
	'grouppermissions-rug-success' => 'המשתמשים הוסרו בהצלחה מהקבוצות שאינן בשימוש!',
	'grouppermissions-rug-confirm' => 'הסר משתמשים מקבוצות שאינן בשימוש',
	'right-grouppermissions' => 'ניהול הרשאות הקבוצות',
	'right-viewsource' => 'עיון במקור הוויקי של דפים מוגנים',
	'right-raw' => 'הצגת דפים גולמיים',
	'right-render' => 'הצגת עמודים מעובדים ללא ניווט',
	'right-info' => 'הצגת נתוני העמוד',
	'right-credits' => 'הצגת התודות של עמוד',
	'right-history' => 'הצגת הסטוריות העמוד',
	'right-search' => 'חיפוש בוויקי',
	'right-contributions' => 'עיון בעמודי התרומות',
	'right-recentchanges' => 'עיון בשינויים האחרונים',
	'right-edittalk' => 'עריכת עמודי השיחה',
	'right-edit-new' => 'עריכת עמודים (שאינם עמודי שיחה)',
	'right-readold' => 'הצגת תוכן של מהדורות ישנות והשינויים',
);
