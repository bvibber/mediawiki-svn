...
{{Identical|Enable dialogs for inserting links, tables and more}}",
	...
	'wikieditor-toolbar-tool-link-int-target-status-external' => 'Text show when the link target the user entered points to an external web site',
...
$messages['be-tarask'] = array(
	...
	'wikieditor-toolbar-tool-link-int-text-tooltip' => 'Увядзіце тэкст, які павінен быць адлюстраваны',
	...
	'wikieditor-toolbar-tool-link-int-target-status-external' => 'Зьнешняя спасылка',
