...
class UsabilityInitiativeHooks {
	...
	private static $styleFiles = array(
		'base_sets' => array(
			...
			'combined' => array(
				array( 'src' => 'css/combined.css', 'version' => 67 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
			'minified' => array(
				array( 'src' => 'css/combined.min.css', 'version' => 67 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
		)
	);
	...
	private static $scriptFiles = array(
		...
		'base_sets' => array(
			'raw' => array(
				...
				array( 'src' => 'js/plugins/jquery.wikiEditor.js', 'version' => 132 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.highlight.js', 'version' => 31 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.toolbar.js', 'version' => 49 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.dialogs.js', 'version' => 15 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.toc.js', 'version' => 87 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.preview.js', 'version' => 10 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.templateEditor.js', 'version' => 18 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.publish.js', 'version' => 2 ),
			),
			'combined' => array(
				array( 'src' => 'js/plugins.combined.js', 'version' => 254 ),
			),
			'minified' => array(
				array( 'src' => 'js/plugins.combined.min.js', 'version' => 254 ),
			),
		),
	);
