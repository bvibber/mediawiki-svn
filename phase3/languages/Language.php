...
'namespace_name_prefix'=>'There are pages which contain this name as a "pseudonamespace" (a text prefix which is not recognized as a real namespace). Use the pseudonamespace conversion form at the bottom to convert the pseudonamespace into a real one. You can create a temporary name first and change it later.',
...
'namespace_delete_not_empty'=>'The namespace still contains pages. Only empty namespaces can be removed.',
...
'pseudonamespace_trying_talk'=>'Looking for talk pages anyway.',
'pseudonamespace_talk_converted'=>'The associated discussion pages were converted.',
...
'pseudonamespace_target_talk_not_found'=>'The target namespace does not appear to have an associated talk namespace!',
'pseudonamespace_merge'=>'Merge into a namespace that contains pages (MAY BE IRREVERSIBLE)',
