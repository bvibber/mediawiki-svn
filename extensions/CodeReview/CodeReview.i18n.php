...
$messages['en'] = array(
	...
	'code-repo-not-found' => 'Repository <b>$1</b> does not exist!',
	...
	'code-status' => 'states',
	'code-tags' => 'tags',
	'code-authors-text' => 'Below is a list of repo authors in order of commit name. Local wiki accounts are shown in parentheses.',
...
$messages['be-tarask'] = array(
	...
	'code-status' => 'станы',
	'code-tags' => 'тэгі',
	'code-authors-text' => 'Ніжэй пададзены сьпіс аўтараў сховішча ўпарадкаваны па імёнах. Рахункі лякальнай вікі паказаныя ў дужках.',
...
$messages['bs'] = array(
	...
	'code-status' => 'statusi',
	'code-tags' => 'oznake',
	'code-authors-text' => 'Ispod je spisak autora repozitorijuma poredanih po imenima. Lokalni wiki računi su prikazani pod navodnicima.',
...
$messages['cs'] = array(
	...
	'code-repo-not-found' => 'Úložiště <b>$1</b> neexistuje!',
...
$messages['de'] = array(
	...
	'code-repo-not-found' => 'Repository <b>$1</b> existiert nicht!',
...
$messages['diq'] = array(
	...
	'code-repo-not-found' => 'Repositor <b>$1</b> cini yo!',
...
$messages['dsb'] = array(
	...
	'code-repo-not-found' => 'Repositorium <b>$1</b> njeeksistěrujo!',
...
$messages['es'] = array(
	...
	'code-status' => 'estados',
	'code-tags' => 'etiquetas',
	'code-authors-text' => 'Abajo está una lista de los autores de repositorios por orden de nombre de tarea. Cuentas de wiki locales se muestran entre paréntesis.',
...
$4',
	...
	'code-stats-header' => 'Estadísticas de repositorio para $1',
...
$messages['et'] = array(
	...
	'code-status' => 'olekud',
	'code-tags' => 'märgised',
	'code-authors-text' => 'Allpool on loetletud hoidla autorid järjestatuna kehtestajanime järgi. Kohaliku viki kontod on toodud sulgudes.',
...
$messages['frp'] = array(
	...
	'code-status' => 'ètats',
	'code-tags' => 'balises',
	'code-authors-text' => 'Vê-que una lista ux ôtors de dèpôts triyês per nom. Los comptos du vouiqui local sont montrâs entre-mié parentèses.',
...
$messages['gsw'] = array(
	...
	'code-status' => 'Status',
	'code-tags' => 'Tag',
	'code-authors-text' => 'Des isch d Lischt vu dr Autore, sortiert no Nämme. Benutzer vu däm Wiki wäre in Chlammere ufgfiert.',
...
$4',
	...
	'code-stats-header' => 'Repositoriumsstatischtik fir $1',
...
$messages['hsb'] = array(
	...
	'code-repo-not-found' => 'Repozitorij <b>$1</b> njeeksistuje!',
...
$messages['ja'] = array(
	...
	'code-status' => '状態',
	'code-tags' => 'タグ',
	'code-authors-text' => '以下はコミット名順のリポジトリ作成者の一覧です。ローカルのウィキにおけるアカウントを括弧内に示します。',
...
$4',
	'code-stats' => '統計',
	'code-stats-header' => '$1のレポジトリの統計情報',
...
$messages['lb'] = array(
	...
	'code-tags' => 'Tagen',
	'code-authors-text' => 'Ënnendrënner ass eng Lëscht vun de Repo-Auteuren an der Reiefolleg vun de rezenten Ännerungen. Lokal Wikikonte ginn tëschent Klamere gewisen.',
...
$messages['mk'] = array(
	...
	'code-tags' => 'ознаки',
	'code-authors-text' => 'Еве список на автори за складишта подредени по име. Сметките на локалните викија се прикажани во загради.',
...
$4',
	...
	'code-stats-header' => 'Складишни статистики за $1',
...
$messages['ml'] = array(
	...
	'code-status' => 'അവസ്ഥകൾ',
	'code-tags' => 'റ്റാഗുകൾ',
	'code-authors-text' => 'താഴെ ഉൾപ്പെടുത്തിയ പേരിന്റെ ക്രമത്തിൽ റെപ്പോ രചയിതാക്കളുടെ പട്ടിക കൊടുത്തിരിക്കുന്നു. പ്രാദേശിക വിക്കി അംഗത്വങ്ങൾ കോഷ്ഠകങ്ങൾക്കുള്ളിൽ കാണാം.',
...
$messages['pl'] = array(
	...
	'code-repo-not-found' => 'Repozytorium <b>$1</b> nie istnieje!',
	...
	'code-status' => 'statusy',
	'code-tags' => 'znaczniki',
	'code-authors-text' => 'Poniżej znajduje się lista autorów repozytorium w kolejności nazwy poprawki. Lokalne konta wiki są wyświetlane w nawiasach.',
...
$messages['pms'] = array(
	...
	'code-status' => 'stat',
	'code-tags' => 'tichëtte',
	'code-authors-text' => "Sota a-i é na lista dj'autor dël depòsit ant l'órdin dël nòm ëd salvatagi. Ij cont dla wiki local a son mostrà antra parèntes.",
...
$4',
	'code-stats' => 'estatísticas',
	'code-stats-header' => 'Estatísticas do repositório para $1',
...
$messages['pt-br'] = array(
	...
	'code-status' => 'estados',
	'code-tags' => 'etiquetas',
	'code-authors-text' => 'Abaixo encontra-se uma lista de autores do repositório ordenados por nome de efetivação. Contas da wiki local são mostradas entre parênteses.',
...
$messages['ru'] = array(
	...
	'code-tags' => 'метки',
	'code-authors-text' => 'Ниже находится список авторов хранилища, упорядоченный по именам. Учётные записи локальной вики показаны в скобках.',
...
$messages['sah'] = array(
	...
	'code-tags' => 'бэлиэлэр',
	'code-authors-text' => 'Ааптардар тиһиктэрэ ааттарынан наарданан бэриллэр. Олохтоох биикигэ бэлиэтэммит ааттара ускуобкаҕа бэриллэр.',
...
$messages['sr-ec'] = array(
	...
	'codereview-tests-failed' => 'Није прошло',
...
$messages['sv'] = array(
	...
	'code-repo-not-found' => 'Förrådet <b>$1</b> finns inte!',
...
$messages['uk'] = array(
	...
	'code-repo-not-found' => 'Сховища <b>$1</b> не існує!',
...
$messages['vi'] = array(
	...
	'code-tags' => 'thẻ',
	'code-authors-text' => 'Đây có danh sách tác giả trong kho, xếp theo tên thay đổi. Trong dấu ngoặc có tài khoản wiki địa phương.',
