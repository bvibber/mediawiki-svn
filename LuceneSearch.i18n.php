...
$wgLuceneSearchMessages['et'] = array(
	...
	'lucene-searchscore'    => 'Sobivus: $1%',
	'lucene-resultsize'     => '$1 ($2 sõna)',
...
$wgLuceneSearchMessages['fo'] = array(
	...
	'lucene-searchscore'    => 'Viðkomandi: $1%',
	'lucene-resultsize'     => '$1 ($2 orð)',
...
$wgLuceneSearchMessages['hak'] = array(
	...
	'lucene-searchscore'    => 'Kôan-lièn-thu：$1%',
	'lucene-resultsize'     => '$1 ($2-ke sṳ)',
...
$wgLuceneSearchMessages['he'] = array(
	...
	'lucene-searchscore'    => "קשר: $1%",
	'lucene-resultsize'     => "$1 ($2 מילים)",
...
$wgLuceneSearchMessages['id'] = array(
	...
	'lucene-searchscore'    => "Relevansi: $1%",
	'lucene-resultsize'     => "$1 ($2 kata)",
...
$wgLuceneSearchMessages['pms'] = array(
	...
	'lucene-searchscore'    => 'Arlevansa: $1%',
	'lucene-resultsize'     => '$1 ($2 paròle)',
...
$wgLuceneSearchMessages['ur'] = array(
	...
	'searchprev'            => 'پیچھے',
	'searchnext'            => 'آگے',
	'lucene-searchscore'    => 'مشابہت: $1%',
	'lucene-resultsize'     => '$1 ($2 الفاظ)',
...
$wgLuceneSearchMessages['yue'] = array(
	...
	'lucene-searchscore'    => "關聯度：$1%",
	'lucene-resultsize'     => "$1 ($2 個字)",
...
$wgLuceneSearchMessages['zh-hans'] = array(
	...
	'lucene-searchscore'    => "关联度：$1%",
	'lucene-resultsize'     => "$1 ($2 个字)",
