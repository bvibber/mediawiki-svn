...
function drag(e){var mR=e.pageX-$('#wikiEditor-ui-bottom').offset().left;mR=$('#wikiEditor-ui-bottom').width()-mR;if(mR<26||mR>$('#wikiEditor-ui-bottom').width()-250)return;$('#wikiEditor-ui-text').css('marginRight',mR+'px');$('#wikiEditor-ui-toc').css('width',mR+'px');}
function stopDrag(e){$().unbind('mousemove',drag).unbind('mouseup',stopDrag);context.modules.$toc.find('div').autoEllipse({'position':'right','tooltip':true});var mR=e.pageX-$('#wikiEditor-ui-bottom').offset().left;mR=$('#wikiEditor-ui-bottom').width()-mR;if(mR<50&&wgNavigableTOCCollapseEnable){collapse();}}
...
function expand(){$('#wikiEditor-ui-toolbar .tab-toc').hide('fast');$('#wikiEditor-ui-toc').show().animate({'width':$('#wikiEditor-ui-toc').data('openWidth')+'px'},'fast',function(){context.modules.$toc.find('div').autoEllipse({'position':'right','tooltip':true});}).prev().animate({'marginRight':$('#wikiEditor-ui-toc').data('openWidth')+'px'},'fast',function(){});}
