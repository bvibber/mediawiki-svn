...
$messages['en'] = array(
	...
	'code-status-new-desc' => 'Commits that have not yet been reviewed',
	'code-status-fixme-desc' => 'Commits that need cleanup',
	'code-status-resolved-desc' => 'Commits that originally needed cleanup, but are now fine',
	'code-status-ok-desc' => 'Commits that have been successfully reviewed',
	'code-status-deferred-desc' => 'Commits that will be looked at later',
...
$messages['ar'] = array(
	...
	'code-status-resolved-desc' => 'الكوميتات التي احتاجت أصلا إلى تنظيف، لكنها حسنة الآن',
	'code-status-ok-desc' => 'الكوميتات التي تمت مراجعتها بنجاح',
	'code-status-deferred-desc' => 'الكوميتات التي سيتم النظر إليها فيما بعد',
...
$messages['arz'] = array(
	...
	'code-status-resolved-desc' => 'الكوميتات التى احتاجت أصلا إلى تنظيف، لكنها حسنة الآن',
	'code-status-ok-desc' => 'الكوميتات التى تمت مراجعتها بنجاح',
	'code-status-deferred-desc' => 'الكوميتات التى سيتم النظر إليها فيما بعد',
...
$messages['fr'] = array(
	...
	'code-status-new-desc' => 'Publications qui n’ont pas été encore revues',
	'code-status-fixme-desc' => 'Publications qui nécessitent un toilettage',
	'code-status-resolved-desc' => "Publications qui ont nécessité un toilettage à l'origine, mais qui sont maintenant convenables",
	'code-status-ok-desc' => 'Publications qui ont été revues avec succès',
	'code-status-deferred-desc' => 'Publications qui seront vues plus tard',
...
$messages['nl'] = array(
	...
	'code-status-resolved-desc' => 'Commits die opvolging nodig hadden, maar nu in orde zijn',
	'code-status-ok-desc' => 'Commits die beoordeeld zijn',
	'code-status-deferred-desc' => 'Commits die later beoordeeld worden',
...
$messages['sk'] = array(
	...
	'code-status-new-desc' => 'Commity, ktoré zatiaľ neboli skontrolované',
	'code-status-fixme-desc' => 'Commity, ktoré vyžadujú úpravu',
	'code-status-resolved-desc' => 'Commity, ktoré pôvodne vyžadovali úpravu, ale teraz sú v poriadku',
	'code-status-ok-desc' => 'Commity, ktoré boli úspešne skontrolované',
	'code-status-deferred-desc' => 'Commity, ktoré budú neskôr skontrolované',
