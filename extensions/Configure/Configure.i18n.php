...
من فضلك قم بإنشائه أو غيره لاستخدام هذا الامتداد.',
	...
	'right-viewconfig' => 'رؤية إعدادت الويكي',
	'right-viewconfig-all' => 'رؤية كل إعدادات الويكي',
	'right-viewconfig-interwiki' => 'رؤية إعدادات الويكى الأجنبي',
	'viewconfig' => 'رؤية إعدادات الويكي',
);
 ...
 */
$messages['he'] = array(
	'configure' => 'הגדר את הוויקי',
	'configure-desc' => 'אפשר למשתמשים מורשים [[Special:Configure|להגדיר]] את הוויקי באמצעות מנשק רשת',
	'configure-desc-group' => 'קבוצות',
	'configure-desc-key' => 'מפתח',
	'configure-desc-ns' => 'מתחמי שם',
	'configure-desc-val' => 'ערך',
	'configure-edit-core' => 'מדיה־ויקי',
	'configure-edit-ext' => 'הרחבות',
	'configure-ext-doc' => 'עיין בתיעוד מקוון',
	'configure-ext-schemachange' => "'''אזהרה:''' הרחבה זו דורשת שעדכון מסד הנתונים יעבוד כראוי!",
	'configure-ext-settings' => 'הגדרות',
	'configure-ext-use-extension' => 'השתמש בהרחבה זו',
	'configure-ext-use' => 'השתמש',
	'configure-summary' => 'עמוד מיוחד זה מאפשר לך לשנות את הוויקי הזה, עיין ב[http://www.mediawiki.org/wiki/Manual:Configuration_settings הגדרות התצורה] למידע נוסף.',
	'configure-btn-save' => 'שמור הגדרות',
	'configure-directory-not-writable' => 'הספרייה משמשת לאיחסון ההגדרות, <tt>$1</tt>, אינה ניתנת לכתיבה.
אנא הפוך אותה לניתנת לכתיבה על ידי PHP לשימוש בהרחבה זו.',
	'configure-edit-old' => 'אזהרה: אתה עורך גירסה <strong>ישנה</strong> של התצורה.',
	'configure-error' => 'לא ניתן לשמור את התצורה',
	'configure-js-add' => 'הוסף רשומה חדשה',
	'configure-js-group-exists' => 'שגיאה: הקבוצה כבר קיימת.',
	'configure-js-prompt-group' => 'הזן את שם הקבוצה החדשה:',
	'configure-js-remove' => 'מחק',
	'configure-js-remove-row' => 'מחק רשומה זו',
	'configure-no-diff' => 'אין שוני בין הגרסאות הנבחרות.',
	'configure-no-directory' => 'התיקייה המשמשת לאיחסון ההגדרות, <tt>$1</tt>, אינה קיימת.
אנא צור אותה או שנה אותה לשימוש עם הרחבה זו.',
	'configure-no-old' => 'לא קיימת גירסה ישנה של התצורה.',
	'configure-no-setup' => 'יהיה עליך לקרוא ל־<code>efConfigureSetup()</code> מפורשות בקובץ ה־LocalSettings.php כדי להשתמש בהרחבה זו.',
	'configure-no-transwiki' => 'אינך מורשה לשנות הגדרות בוויקים אחרים',
	'configure-old' => 'גרסאות ישנות',
	'configure-old-versions' => 'רשימת הגרסאות הישנות של התצורה:',
	'configure-old-not-available' => 'גרסת ההגדרות הישנה שביקשת, $1, אינה זמינה',
	'configure-saved' => 'התצורה נשמרה',
	'configure-section-general' => 'הגדרות כלליות',
	'configure-section-paths' => 'נתיבים',
	'configure-section-db' => 'מסד הנתונים',
	'configure-section-db-notallowed' => 'אינך מורשה לשנות את הגדרות מסד הנתונים.',
	'configure-section-load-balancing' => 'איזון עומס',
	'configure-section-mysql' => 'מסויים ל־MySQL',
	'configure-section-postgres' => 'מסויים ל־PostgreSQL',
	'configure-section-sqlite' => 'מסויים ל־SQLite',
	'configure-section-email' => 'דוא"ל',
	'configure-section-enotif' => 'התראה בדוא"ל',
	'configure-section-localization' => 'התאמה מקומית',
	'configure-section-timezone' => 'אזור הזמן',
	'configure-section-zh-conversion' => 'המרת סינית',
	'configure-section-html' => 'HTML',
	'configure-section-debug' => 'ניפוי שגיאות',
	'configure-section-profiling' => 'הגדרת פרופילים',
	'configure-section-site' => 'התאמת האתר',
	'configure-section-ajax' => 'Ajax',
	'configure-section-css-js' => "CSS וג'אווהסקריפט",
	'configure-section-namespaces' => 'מתחמי שם',
	...
	'configure-section-groups-notallowed' => 'אינך מורשה לערוך את הגדרות הקבוצה.',
	'configure-section-block' => 'מקטעים',
	'configure-section-rates' => 'מגבלות דירוג',
	'configure-section-proxy' => 'מתווכים',
	'configure-section-squid' => 'Squids',
	'configure-section-cookie' => 'עוגיות',
	'configure-section-reduction' => 'הפחתה',
	'configure-section-upload' => 'העלאה',
	'configure-section-sharedupload' => 'העלאה משותפת',
	'configure-section-mime' => 'טיפוסי MIME',
	...
	'configure-select-wiki-available' => 'ערכים מורשים: $1',
	'configure-select-wiki-desc' => 'בחר את הוויקי אותו תרצה להגדיר.',
	'configure-select-wiki-submit' => 'אימות',
	'configure-setting-not-available' => 'הגדרה זו אינה זמינה בגירסה זו של מדיה־ויקי',
	'configure-transwiki-not-in-range' => 'הוויקי הנבחר, $1, אינו בערכים המורשים ($2).',
	'configure-view' => 'צפה',
	'configure-view-all-versions' => 'רשימת הגרסאות המלאה',
	'configure-view-not-allowed' => 'אינך מורשה לעיין בהגדרה זו',
	'extensions' => 'הגדר את ההרחבות',
	'right-configure' => 'הגדרת הוויקי',
	'right-configure-all' => 'הגדרת כל תצורת הוויקי',
	'right-configure-interwiki' => 'הגדר תצורת וויקי זר',
	'right-extensions' => 'הגדר את ההרחבות',
	'right-extensions-all' => 'תצורת הרחבות מתקדמת',
	'right-extensions-interwiki' => 'הגדרת הרחבות לוויקי זר',
	'right-viewconfig' => 'עיון בתצורת הוויקי',
	'right-viewconfig-all' => 'עיון בתצורת הוויקי כולה',
	'right-viewconfig-interwiki' => 'עיון בתצורת ויקי זר',
	'viewconfig' => 'צפה בתצורת הוויקי',
);
...
Per favor permitte que PHP scribe in illo pro poter usar iste extension.',
	'configure-edit-old' => 'Attention: tu modifica ora un <strong>ancian</strong> version del configuration.',
...
Per favor crea lo o cambia lo pro poter usar iste extension.',
	...
	'configure-select-wiki-available' => 'Valores autorisate: $1',
...
[http://www.mediawiki.org/wiki/Manual:Configuration_settings Konfigurationsoptione] foar moor Information.',
	...
	'configure-section-squid' => 'Squids',
	'configure-section-cookie' => 'Cookies',
	'configure-section-reduction' => 'Ienschränkengen',
	...
	'configure-select-wiki-available' => 'Ferlööwede Wäide: $1',
