...
Name:		TSperl-Mail-DomainKeys
Summary:	Mail::DomainKeys module for Perl
Version:	1.0
Source:		http://search.cpan.org/CPAN/authors/id/A/AN/ANTHONYU/Mail-DomainKeys-%{version}.tar.gz
...
Requires: TSperl
Requires: TSperl-Crypt-OpenSSL-RSA
BuildRequires: TSperl
BuildRequires: TSperl-Crypt-OpenSSL-RSA

%prep
%setup -q -n Mail-DomainKeys-%version
