...
class SkinTemplate extends Skin {
	...
	function outputPage( &$out ) {
		...
		*/
		...
		$tpl->setRef('footer_links', $this->buildFooterLinks( $tpl->data ));
	...
	/**
	 * build array of urls for the footer
	 * @return array
	 * @private
	 */
	function buildFooterLinks( &$data ) {
		$names = array(
		...
		foreach( $names as $aLink ) {
			if( isset( $data[$aLink] ) && $data[$aLink] ) {
				$footer_links[] = array(
					'id' => $aLink,
					'html' => $data[$aLink],
				);
