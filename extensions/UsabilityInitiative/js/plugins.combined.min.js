...
if(!($(oldParent).children().length==1&&$(oldParent.firstChild).is('br'))){while(oldParent.firstChild){startNode.parentNode.insertBefore(oldParent.firstChild,afterStart);}}}else{if(lastP!=t.inP){startNode.parentNode.appendChild(startNode.ownerDocument.createElement('br'));}
if(!($(oldParent).children().length==1&&$(oldParent.firstChild).is('br'))){while(oldParent.firstChild){startNode.parentNode.appendChild(oldParent.firstChild);}}}
