//omtk embed supports the binPlayer/omtk-fk lib
// for more about omtk-flash see http://omtk.org/flash/index.html
...
var omtkEmbed={
	...
	getEmbedHTML : function (){	
		...
		swfobject.embedSWF(
			mv_embed_path + "binPlayers/omtk-fx/omtkp.swf", "omtk_player", 
			"1", "1", 
    ...
    getEmbedObj:function(){
    	...
    	/*return '<OBJECT width="1" height="1" >'+		
    				'<param name="movie" value="' + player_path + '">'+	
					'<PARAM name="wmode" value="transparent"></PARAM>'+
					'<PARAM name="quality" value="high"></PARAM>'+
					'<PARAM name="allowscriptaccess" value="always"></PARAM>' + 
					'<EMBED id="' + this.pid + '" src="' + player_path + '" type="application/x-shockwave-flash" wmode="transparent" width="1" height="1">' +
					'</EMBED>' +
				'</OBJECT>';*/
		return '<object id="omtk_player" align="middle" width="1" height="1" type="application/x-shockwave-flash" name="omtk_player" data="omtkp.swf" style="visibility: visible;">' +
    ...
    postEmbedJS:function(){
    	...
    	var wtf = document.getElementById("omtk_player");
    	wtf.play(mv_embed_path + 'example_usage/' + this.src);
