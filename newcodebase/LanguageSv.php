...
#
/* private */ $wgValidSpecialPagesSv = array(
	"Userlogin"		=> "",
	"Userlogout"	=> "",
...
Se $1.",
"developertitle" => "Developerbehörighet krävs",
...
"cannotdelete"	=> "Kunde inte radera sidan, eller filen som 
specificerades.",
...
"welcomecreation" => "<h2>Välkommen WIKIng, $1!</h2><p>Ditt konto har skapats. Glöm inte att anpassa dina Wikipediainställningar.",
...
"loginproblem"	=> "<b>Det var svårt att logga in dig .</b><br>Pröva igen, en WIKIng ger inte upp!",
...
"showingresults" => "Nedan visas <b>$1</b> resultat som startar med 
nummer <b>$2</b>.",
...
[[Wikipedia:Välkommen wiking|Välkommen wiking]]!
...
"rcnotefrom"	=> "Nedanför är ändringerne fra <b>$2</b> indtil <b>$1</b> vist.",
"rclistfrom"	=> "Vis nye ändringer startende fra $1",
...
# What links here
#
"whatlinkshere"	=> "Vilka länkar hit",
"notargettitle" => "Inget mål",
"notargettext"	=> "Du har inte specificerad en sida eller användare
...
"movepagetext"	=> "Formuläret nedan byter namn på sidan och flyttar hela dess historia till det nya namnet. Den gamla sidan blir en omdirigeringssida till den nya. Länkar till den gamla sidan kommer inte att ändras. Om det finns en diskussionssida kommer den inte att flyttas.
<b>OBS!</b>
Detta kan innebära en drastisk ändring på en populär sida; var säker på att du inser konsekvenserna i förväg.",
"movearticle"	=> "Flyta sida",
...
"talkexists"	=> "Sidan  flyttades korrekt, men den tilhörande 
diskussionssidan kunde inte flyttas, eftersom det redan existerar en sida
med denna nya titel. Du måste sammanfoga dem manuellt.",
...
"talkpagenotmoved" => "Sidans diskussionssida flyttades
<strong>inte</strong>.",
