...
Bearbeitungen eines Benutzers anzeigen zu lassen.",
	...
	"editcount-toolbox" => "Bearbeitungsanzahl des Benutzers",
	"editcount-total" => "Gesamt",
...
$weECMessages['pl'] = array(
	...
	"editcount-noedits" => "Nie znaleziono zadnych edycji $1.",
	"editcount-notuser" => "$1 nie jest poprawna nazwa uzytkownika.",
	"editcount-percent" => "Procent wszystkich edycji",
	"editcount-percentsym" => "%",
	"editcount-show" => "Pokaz ilosc",
	"editcount-toolbox" => "Liczba edycji uzytkownika",
	"editcount-total" => "Razem",
