...
$messages['en'] = array(
	'clientside-desc' => 'Provides functions for generating code in client-side formats such as HTML, CSS and JavaScript',
);
 ...
 */
$messages['gl'] = array(
	'clientside-desc' => 'Proporciona funcións para xerar código en formatos como HTML, CSS e JavaScript',
);
 ...
 */
$messages['gsw'] = array(
	'clientside-desc' => 'Stellt Funktione z Verfiegig fir d Codeprogrammierig in Client-basierte Format wie HTML, CSS un JavaScript',
);
 ...
 */
$messages['sah'] = array(
	'clientside-desc' => 'HTML, CSS уонна JavaScript курдук клиент формааттарыгар куоду айар (генерациялыыр) кыаҕы биэрэр',
);
