...
$.fn.rb_menu = function(options) {
  ...
  return this.each(function() {
    var $menu = $(this);
    var $menuItems = $menu.find('.mw-checkuser-items');
    var $toggle = $menu.find('.mw-checkuser-toggle');

  	// add 'hover' class to trigger for css styling
  	$toggle.hover(
  	  function() {
  		  $toggle.addClass('mw-checkuser-toggle-hover');
  	  },
  	  function() {
  		  $toggle.removeClass('mw-checkuser-toggle-hover');
  	  }
  	);
