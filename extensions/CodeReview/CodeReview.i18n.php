...
$messages['be-tarask'] = array(
	...
	'code-authors' => 'аўтары',
	'code-tags' => 'тэгі',
	'code-authors-text' => 'Ніжэй знаходзіцца сьпіс аўтараў хранілішча ў парадку апошняга даданага рэдагаваньня.',
...
$4',
	...
	'right-repoadmin' => 'Кіраваньне хранілішчамі кодаў',
	'right-codereview-add-tag' => 'Дадаць новыя тэгі для апісаньня зьменаў',
	'right-codereview-remove-tag' => 'Выдаленьне тэгаў якія апісваюць зьмены',
	'right-codereview-post-comment' => 'Дадаць камэнтары да вэрсіяў',
	'right-codereview-set-status' => 'Зьмяніць статус вэрсіяў',
	'right-codereview-link-user' => 'Сувязь аўтараў з уліковымі рахункамі ўдзельнікаў',
