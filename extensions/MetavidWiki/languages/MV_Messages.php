...
$messages['ar'] = array(
	...
	'mvd_default_mismatchtext'       => 'يوجد خطأ في ملف إعداداتك، $mvMVDTypeDefaultDisp ينبغي أن يكون مجموعة فرعية ل $mvMVDTypeAllAvailable',
...
$messages['fr'] = array(
	...
	'mvd_default_mismatchtext'       => 'Une erreur s\'est glissée dans votre fichier de configuration, $mvMVDTypeDefaultDisp devrait être un sous-paramétrage de $mvMVDTypeAllAvailable.',
...
$messages['hsb'] = array(
	...
	'anno_en_desc'                   => 'Jendźelske kategorizacije a přispomnjenki. Tute naworštowanje hodźi so wužiwać, zo by wotrězki wideja \\"woznamjeniło\\"/kategorizował abo komentarowe informacije přidał, kotrež rěčany tekst njejsu.',
...
$messages['nl'] = array(
	...
	'mvd_default_mismatchtext'       => 'Er staat een fout in uw instellingenbestand. $mvMVDTypeDefaultDisp hoort een subset te zijn van $mvMVDTypeAllAvailable',
...
Alebo môžete <a href="$3">Pridať stream</a>.',
	...
	'anno_en_desc'                   => 'Anglická kategorizácia a poznámky. Toto preloženie je možné použiť na „značkovanie“/kategorizáciu úsekov videa alebo na pridanie popisnej informácie, ktorá nie je hovorený text.',
