...
<a href="http://commons.wikimedia.org/wiki/Commons:Firefogg#Supported_File_Types">Дапамога</a>.',
	...
	'mv_crop' => 'Сьціснуць выяву',
	'mv_apply_crop' => 'Ужыць сьціск выявы',
	'mv_reset_crop' => 'Адмяніць сьціск',
	'mv_insert_image_page' => 'Уставіць на старонку',
	'mv_preview_insert' => 'Перадпрагляд устаўкі',
	'mv_cancel_image_insert' => 'Адмяніць устаўку',
	'sc_fileopts' => 'Адсекчы падрябязнасьці рэдагаваньня',
	'sc_inoutpoints' => 'Устаноўка пунктаў уводу-вываду',
	...
	'mv_custom_title' => 'Спэцыяльная назва',
	'mv_edit_properties' => 'Рэдагаваць уласьцівасьці',
	'mv_other_properties' => 'Іншыя ўласьцівасьці',
	'mv_resource_page' => 'Крынічная старонка',
	'mv_set_in_out_points' => 'Устанавіць пункты уводу-вываду',
	'menu_clipedit' => 'Рэдагаваць выбраную крыніцу',
	'menu_cliplib' => 'Дадаць крыніцу',
	'menu_transition' => 'Эфекты пераходаў',
	'menu_resource_overview' => 'Агляд крыніцы',
	'menu_options' => 'Опцыі',
	'loading_timeline' => 'Стан загрузкі <blink>...</blink>',
	'loading_user_rights' => 'Загрузка правоў удзельніка <blink>...</blink>',
	'no_edit_permissions' => 'Вы ня маеце дазволу захоўваць зьмены ў гэтай пасьлядоўнасьці',
	'edit_clip' => 'Рэдагаваць адсячэньне',
	'edit_save' => 'Захаваць зьмены',
	'edit_cancel' => 'Адмяніць рэдагаваньне',
	'edit_cancel_confirm' => 'Вы ўпэўнены што жадаеце адмяніць Ваша рэдагааньне?
Усе зьмены будуць страчаны.',
	'zoom_in' => 'Павялічыць маштаб',
	'zoom_out' => 'Паменшыць маштаб',
	'expand_track' => 'Пашырыць канал',
	'colapse_track' => 'Выдаленьне канала',
	'pixle2sec' => 'піксэляў за сэкунду',
	'rmclip' => 'Выдаліць кліп',
	'no_selected_resource' => '<h3>Крыніца ня вызначана</h3>
Выбярыце кліп для актывізацыі рэдагаваньня крыніцы',
	'error_edit_multiple' => '<h3>Выбрана некалькі крыніцаў</h3>
Выбярыце адзін кліп для яго рэдагаваньня',
...
<a href="http://commons.wikimedia.org/wiki/Commons:Firefogg#Supported_File_Types">Plus d’aide.</a>',
	...
	'edit_cancel_confirm' => 'Êtes-vous sûr de vouloir annuler votre édition ?
