 ...
 * @author DCLXVI
 */
$wgLanguageManagerMessages['bg'] = array(
	'ow_save'                         => 'Съхранение',
	'ow_history'                      => 'История',
...
$wgLanguageManagerMessages['br'] = array(
	...
	'ow_noedit'                             => 'N\'oc\'h ket aotreet da zegas kemmoù war pajennoù an diaz "$1". Sellit ouzh [[Project:Permission policy|ar reolennoù kemmañ]].',
...
$wgLanguageManagerMessages['de'] = array(
	...
	'ow_noedit'                             => 'Du hast nicht die Erlaubnis Seiten im Dataset "$1" zu editieren. Siehe [[Project:Permission policy|unsere Richtlinien]].',
 ...
 * @author Ascánder
 */
$wgLanguageManagerMessages['es'] = array(
	'ow_save'                          => 'Guardar',
	'ow_history'                       => 'Historial',
	'ow_datasets'                      => 'Selección de la base',
	'ow_noedit'                        => 'No tienes permiso de modificar las páginas de la base "$1". Mira [[Project:Permission policy|nuestras reglas de modificación]].',
...
/** Suomi (Suomi)
 */
$wgLanguageManagerMessages['fi'] = array(
 ...
 * @author Sopho
 */
$wgLanguageManagerMessages['ka'] = array(
	'ow_history'                  => 'ისტორია',
...
$wgLanguageManagerMessages['nl'] = array(
	...
	'ow_noedit'                             => 'U heeft geen rechten om pagina\'s te bewerken in de dataset "$1". Zie [[Project:Permission policy|ons bewerkingsbeleid]].',
...
$wgLanguageManagerMessages['pt'] = array(
	...
	'ow_noedit'                             => 'Não está autorizado a editar páginas no conjunto de dados "$1". Por favor, veja [[Project:Política de permissões|a nossa política de edição]].',
 ...
 * @author Millosh
 */
$wgLanguageManagerMessages['sr-ec'] = array(
	'ow_save'                               => 'Сачувај',
	'ow_history'                            => 'Историја',
	'ow_datasets'                           => 'Одабир скупа података',
	'ow_noedit'                             => 'Није ти дозвољено да мењаш стране у скупу података "$1". Види [[Project:Permission policy|нашу уређивачку политику]].',
...
/** Volapük (Volapük)
 */
$wgLanguageManagerMessages['vo'] = array(
	'ow_history'                      => 'Jenotem',
