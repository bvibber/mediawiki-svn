...
"userrights-help"            => "אתם עורכים את ההרשאות של המשתמש $1.<br />
אנא בחרו קבוצות שברצונכם שהמשתמש יתווסף אליהן או יוסר מהן.<br />
קבוצות שלא נבחרו לא ישתנו. באפשרותכם לבטל בחירה של קבוצה באמצעות לחיצה על הכפתור השמאלי של העכבר ועל Ctrl מעליה.<br />
מספר קבוצות עשויות להיות מוסתרות אם אינכם מורשים להעניק או לבטל אותן.",
