...
class UsabilityInitiativeHooks {
	...
	private static $styleFiles = array(
		'base_sets' => array(
			...
			'combined' => array(
				array( 'src' => 'css/combined.css', 'version' => 55 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
			'minified' => array(
				array( 'src' => 'css/combined.min.css', 'version' => 55 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
		)
	);
	...
	private static $scriptFiles = array(
		...
		'base_sets' => array(
			...
			'combined' => array(
				array( 'src' => 'js/plugins.combined.js', 'version' => 174 ),
			),
			'minified' => array(
				array( 'src' => 'js/plugins.combined.min.js', 'version' => 174 ),
			),
		),
	);
