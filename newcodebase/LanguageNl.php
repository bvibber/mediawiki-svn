...
"recentchangeslinked" => "Controleer links",
"rclsub"		=> "(naar pagina's verwezen vanuit \"$1\")",
"debug"			=> "Bugreparatie",
...
"lockdbtext"	=> "Waarschuwing: De database blokkeren heeft tot gevolg dat alle gebruikers niet meer in staat zijn de pagina's te bewerken, hun voorkeuren te wijzigen of iets anders te doen waarvoor er wijzigingen in de database nodig zijn.",
