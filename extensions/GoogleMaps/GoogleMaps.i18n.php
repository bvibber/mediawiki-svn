...
$wgGoogleMapsMessages['mk'] = array(
	...
	'gm-map' => 'Карта',
	'gm-note' => 'Белешка: запаметете да го копирате она што сакате да го зачувате на страницата (подолу) пред да стиснете на „Вчитај карта“, „Зачувај“ или „Преглед“!',
...
$wgGoogleMapsMessages['rue'] = array(
	...
	'gm-map' => 'Мапа',
	'gm-note' => 'Познамка: Перевірте  ся, же на сторінцї ниже копіруєте тото, што хочете уложыти передтым, як стиснете "Начітати мапу", "Уложыти" або "Нагляд" !',
