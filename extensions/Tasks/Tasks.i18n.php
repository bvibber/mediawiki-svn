...
$messages['arz'] = array(
	...
	'tasks_sidebar_title' => 'المهمات المفتوحة',
	'tasks_here' => 'هنا',
	'tasks_returnto' => 'انت ح تتحول دلوقتى. لو ما اتحولتش في خلال ثواني ، دوس على $1.',
...
$messages['be-tarask'] = array(
	...
	'tasks_existing_table_header' => 'Заданьне|Даты|Пачатковае апісаньне|Назначана/Дзеяньні/Старонка',
	'tasks_noone' => 'ніхто',
	'tasks_assign_me' => 'Узяць заданьне',
	'tasks_assign_to' => 'Прызначыць удзельніку',
	'tasks_unassign_me' => 'Выдаліць маё прыдначэньне',
	'tasks_close' => 'Скончыць заданьне',
	'tasks_wontfix' => 'Ня будзе выканана',
	...
	'tasks_reopen' => 'Зноў адчыніць заданьне',
	...
	'tasks_closedby' => 'Зачынена ўдзельнікам $1',
	'tasks_assigned_myself_log' => 'Самапрызначэньне на заданьне «$1»',
	'tasks_discussion_page_for' => 'Гэта заданьне для старонкі «$1». Сьпіс усіх заданьняў для гэтай старонкі знаходзіцца $2.',
	...
	'tasks_plain_text_only' => '(просты тэкст, не болей 256 сымбаляў)',
	'tasks_help_page' => 'Заданьні',
	'tasks_more_like_it' => 'болей',
	'tasks_task_types' => '1:cleanup:Ачысьціць|2:wikify:Вікіфікаваць|3:rewrite:Перапісаць|4:delete:Выдаліць|5:create:Стварыць|6:write:Напісаць|7:check:Спраўдзіць',
	'tasks_significance_order' => 'перапісаць<выдаліць',
	'tasks_event_on_creation' => 'спраўдзіць',
	'tasks_event_on_creation_anon' => 'спраўдзіць',
	'tasks_on_creation_comment' => 'Заданьне створана аўтаматычна пад час стварэньня старонкі',
	'tasks_link_your_assignments' => 'бягучыя прызначэньні',
	'tasks_see_your_assignments' => 'Зараз у Вас $1 {{PLURAL:$1|адчыненае заданьне|адчыненых заданьня|адчыненых заданьняў}}. Глядзі Ваш $2.',
	'tasks_my_assignments' => '{{PLURAL:$1|Ваша бягучае заданьне|Вашы бягучыя заданьні}}',
	'tasks_table_header_page' => 'Старонка',
	'tasks_you_have_no_assignments' => 'К Вас няма бягучых заданьняў',
	'tasks_search_form_title' => 'Пошук',
	'tasks_search_tasks' => 'Заданьні',
	'tasks_search_status' => 'Статус',
	'tasks_search_no_tasks_chosen_note' => '(Адсутнасьць тут выбару прывядзе да пошуку ва ўсіх тыпах заданьняў.)',
	'tasks_search_results' => 'Вынікі пошуку',
	'tasks_previous' => 'Папярэдняе',
	'tasks_next' => 'Наступнае',
	'tasks_sort' => 'Сартыроўка',
	'tasks_ascending' => 'З наістарэйшых',
	'tasks_status_open' => 'Адчынена',
	'tasks_status_assigned' => 'Прызначана',
	'tasks_status_closed' => 'Зачынена',
...
$messages['dsb'] = array(
	...
	'tasks_significance_order' => 'pśepisaś<lašowaś',
...
$messages['hsb'] = array(
	...
	'tasks_significance_order' => 'přepisać<wušmórnyć',
...
Fals du nit in n poor Sekunden fääre laited wädst, klik $1.',
	...
	'tasks_significance_order' => 'uurschrieuwe<läskje',
