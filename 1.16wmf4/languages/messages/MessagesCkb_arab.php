...
لە کرداری "<tt>$2</tt>".
MySQL ئەم ھەڵەی گەڕاندووتەوە "<tt>$3: $4</tt>".',
'dberrortextcl'        => 'هەڵەیەکی ڕستەنووسی لە داواکاریی بنکە‌ی‌دراو ڕووی‌داوە.
دوایین تێکۆشان بۆ داواکاری بنکەی‌دراو:
"$1"
لە کرداری "$2".
MySQL ئەم ھەڵەی گەڕاندووەتەوە "$3: $4"',
...
لێ نەکرابێت.",
'revdelete-confirm'           => 'تکایە بڕوامان پێ بدە کە دەتەوێ ئەوە بکەی و لە ئەنجامەکانی ئەوە ئاگاداریت و بە پێی [[{{MediaWiki:Policy-url}}|سیاسەتنامە]] ئەنجامی ئەدەی.',
...
بۆ بەکارهێنانی وەشانی تەواوی پەڕگە
* '''<tt><nowiki>[[</nowiki>{{ns:file}}<nowiki>:File.png|200px|thumb|left|alt text]]</nowiki></tt>'''
بۆ بەکارهێنانی نووسە بە پانتایی 200 پیکسەل لە چوارچێوەیەک لە  پەراوێزی چەپ بە 'alt text' وەک پێناسە
* '''<tt><nowiki>[[</nowiki>{{ns:media}}<nowiki>:File.ogg]]</nowiki></tt>'''
بۆ بەستەر پێ‌دان بە پەڕگەیەک بێ نیشان‌دانی خۆی پەڕگەکە",
...
[[$1|thumb]]",
'filepageexists'              => "لاپەڕەی ناساندن بۆ ئەم پەڕگە لە پێش‌دا لە '''<tt>[[:$1]]</tt>''' درووست‌کراوە، بەڵام پەڕگەیەک بەو ناوە ئێستا نادۆزرێتەوە.
ئەو پوختەی کە نووسیوتە لە لاپەڕەی ناساندن بەرچاو ناکەوێت.
...
'activeusers-count'    => '$1 نوێترین‌ {{PLURAL:$1|گۆڕانکاری|گۆڕانکاریەکان}}',
...
'addedwatchtext'       => 'پەڕەی "[[:$1]]" خرایە سەر [[Special:Watchlist|لیستی چاودێڕیەکەت]].
گۆڕانکارییەکانی داھاتووی ئەم پەڕە و پەڕەی وتووێژەکەی، لەوێدا بە ڕیزدەکرێ و پەڕەکە لە [[Special:RecentChanges|لیستی دواییین گۆڕانکارییەکان‌دا]]  ئەستوورکراو دەردەکەوێت بۆ ئەوەی ئاسانتر دەسکەوێت.',
