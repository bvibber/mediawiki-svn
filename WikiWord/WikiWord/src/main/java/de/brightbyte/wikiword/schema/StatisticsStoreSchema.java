...
public class StatisticsStoreSchema extends WikiWordStoreSchema {
	...
	private void init(boolean global, TweakSet tweaks) {
		...
		degreeTable.addField( new DatabaseField(this, "lhs", "REAL", "NOT NULL DEFAULT 0", true, KeyType.INDEX ) ); //local hierarchy score
		degreeTable.addField( new DatabaseField(this, "idf", "REAL", "NOT NULL DEFAULT 0", true, KeyType.INDEX ) ); //inverse document frequency
