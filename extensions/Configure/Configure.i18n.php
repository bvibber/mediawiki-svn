...
Veuillez le rendre modifiable par PHP pour que cette extension fonctionne.',
	...
	'configure-condition-name-7' => 'Age minimum depuis la première modification (en secondes)',
	...
	'configure-condition-description-7' => 'Age minimum du compte de $1 {{PLURAL:$1|seconde|secondes}} depuis la première modification',
...
$messages['it'] = array(
	...
	'configure-viewconfig-default-diff' => 'Cambi rispetto ai settaggi predefiniti',
	...
	'configure-customised' => "''Questo settaggio è stato personalizzato''",
	...
	'configure-db-error' => 'Il database che hai indicato per mantenere la configurazione ($1) non esiste.
Per favore crealo e applica configure.sql oppure correggine il nome.',
	'configure-db-table-error' => 'Il database da te indicato non contiene le tabelle richieste. Per favore, applica configure.sql in quel database.',
...
Fai in modo che possa essere scritta da PHP per poter usare questa estensione.',
	...
	'configure-js-image-error' => 'Si è verificato un errore nella ricerca della URL. Per favore controlla che il file esista.',
	...
	'configure-js-search-legend' => 'Impostazioni di ricerca',
...
Creala o cambiala per poter usare questa estensione.',
	...
	'configure-no-setup' => 'Per usare questa estensione, devi richiamare esplicitamente <code>efConfigureSetup()</code> nel file LocalSettings.php.',
	...
	'configure-select-wiki-view-desc' => 'Scegli un wiki di cui vuoi vedere le versioni.',
	'configure-select-wiki-view-all' => 'Tutti i wiki',
...
et Appachtemang. Do kresß en Vör-Aansich jezeich, wann De uß dämm Feld jeihß.',
	...
	'configure-section-db-notallowed' => 'Do has nit dat Rääsch, aan de Datebangk ier Enstellunge jet ze ändere.',
	...
	'configure-section-groups-notallowed' => 'Do häs nit dat Rääsch, Enstellunge för Jruppe ze ändere.',
...
Opprett ho eller endra ho for å nytta denne utvidinga.',
	...
	'configure-section-groups-notallowed' => 'Du har ikkje løyve til å endra gruppeinnstillingar.',
	...
	'configure-condition-description-5' => 'Brukaren si IP-adressa er $1',
...
Pakilikha ito o baguhin ito upang magamit ang ganitong karugtong.',
	...
	'configure-section-db-notallowed' => 'Wala kang pahintulot na baguhin ang mga katakdaan ng kalipunan ng dato.',
	...
	'configure-section-groups-notallowed' => 'Wala kang pahintulot na baguhin ang mga katakdaang pampangkat.',
