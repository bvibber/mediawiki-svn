...
abstract class Report extends SpecialPage {
	...
	public static function getReports() {
		return array(
			...
			'FewestRevisionsReport',
			'LargestCategoriesReport',
			'LongPagesReport',
			'MostCategoriesReport',
			'MostLinkedPagesReport',
			'MostRevisionsReport',
			'MostUsedImagesReport',
			'MostUsedTemplatesReport',
			'OrphanedPagesReport',
			'PopularPagesReport',
			'RedirectReport',
			'ShortPagesReport',
