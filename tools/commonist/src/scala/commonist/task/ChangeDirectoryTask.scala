...
class ChangeDirectoryTask(mainWindow:MainWindow, imageListUI:ImageListUI, statusUI:StatusUI, thumbnails:Thumbnails, directory:File) extends Task {
	...
	override protected def execute() {
		...
		val listed	= directory 
				.listFiles { file:File => file.isFile && !file.isHidden }
