...
$messages['zh-hans'] = array(
	...
	'coll-book_creator_intro' => "<big>使用''图书创建器''你可以创建包含你选择的wiki页面的图书。你可以以不同格式（如PDF、ODF）导出本图书或订购印刷图书。</big>",
	...
	'coll-unknown_subpage_text' => '[[Special:Book|图书]]的本子页面不存在',
...
本列表将在你单击“添加”或“删除”按钮后更新。',
	...
	'coll-suggest_undo_tooltip' => '撤销该动作',
	'coll-suggest_undo' => '撤销',
	'coll-load_local_book' => '单击“确定”继续创建你的图书%TITLE%（已含%NUMPAGES%wiki页）。单击“取消”删除你的图书，生成空白图书。',
