...
* bots met interwiki-voorvoegsels of naamruimtes se name.',
	...
	'lqt_hist_reply_created' => 'Nuwe antwoord geplaas',
	...
	'lqt_hist_edited_subject' => 'Gewysigde onderwerp',
	'lqt_hist_merged_from' => "Die antwoord is na 'n ander onderwerp geskuif",
	'lqt_hist_merged_to' => "Die antwoord is vanuit 'n ander onderwerp geskuif",
...
$messages['ar'] = array(
	...
	'lqt_hist_comment_edited' => 'عُدّل نص التعليق',
	'lqt_hist_summary_changed' => 'غُيّر الملخص',
	'lqt_hist_reply_created' => 'أُنشئ رد جديد',
	'lqt_hist_thread_created' => 'أُنشئ نقاش جديد',
	...
	'lqt_hist_edited_subject' => 'موضوع مُعدّل',
	'lqt_hist_merged_from' => 'نُقل الرد إلى نقاش آخر',
	'lqt_hist_merged_to' => 'نُقل الرد من نقاش آخر',
...
هذه العملية لا يمكن الرجوع عنها.',
	'lqt-marked-read' => "تم تعليم مجموعة الرسائل '''$1''' مقروءة.",
	'lqt-count-marked-read' => 'تم تعليم {{PLURAL:$1||رسالة واحدة|رسالتين|$1 رسائل|$1 رسالة}} مقروءة.',
	'lqt-email-undo' => 'ارجع',
...
$messages['arc'] = array(
	...
	'lqt-newmessages-n' => 'ܐܓܪ̈ܬܐ ܚܕܬ̈ܐ ($1)',
	'lqt_newmessages' => 'ܐܓܪ̈ܬܐ ܚܕܬ̈ܐ',
);
...
$messages['bn'] = array(
	...
	'lqt_hist_comment_edited' => 'মন্তব্য লেখা সম্পাদিত',
	'lqt_hist_summary_changed' => 'সারাংশ পরিবর্তন হয়েছে',
	'lqt_hist_reply_created' => 'নতুন উত্তর তৈরি করা হয়েছে',
	...
	'lqt_hist_edited_subject' => 'সম্পাদিত বিষয়',
	'lqt_hist_merged_from' => 'উত্তরটি অন্য থ্রেডে স্থানান্তর করো',
	'lqt_hist_merged_to' => 'উত্তরটি অন্য থ্রেড হতে এখানে স্থানান্তর করো',
...
* cayê nameyan u gıreyê benatewikiyan de pêverdiyayo.',
	...
	'lqt_change_subject_edited' => 'muhtewaya no gıreyi vuriya',
...
Şıma eşkêni $2 bıwazi.',
	...
	'lqt-any-date' => 'kam yew (kamci) tarix beno wa bıbo',
	'lqt-only-date' => 'têna nê tarixi:',
	'lqt-date-from' => 'no tarix ra',
	'lqt-date-to' => 'no tarix',
	'lqt-title' => 'sername',
	'lqt-summary' => 'xulasa',
	'lqt-older' => 'verınêr',
	'lqt-newer' => 'neweyer',
...
no operasyon tepiya geriyeno.',
	...
	'lqt-archive-subtitle' => 'arşiwê werêameyişi',
	'lqt-archive-intro' => 'pelê arşiwi qey [[$1]]i yo .',
...
* jo konfilikt z interwikijowymi prefiksami abo mjenja mjenjowych rumow.',
	...
	'lqt_hist_merged_to' => 'Wótegrono z drugeje nitki pśesunjone',
...
* Vastuolus interviki eesliidetega või nimeruuminimedega',
	...
	'lqt_change_subject_edited' => 'Selle lõime teema muudeti.',
...
* haber un conflito cos prefixos interwiki ou os nomes dos espazos de nomes.',
	...
	'lqt_hist_edited_subject' => 'Modificouse o asunto',
...
* Konflik dengan awalan interwiki atau nama ruang nama.',
	...
	'lqt_subject_change_forbidden' => 'Anda tidak dapat mengganti subjek utas ini karena Anda tidak diizinkan untuk memindahkan halaman.',
	...
	'lqt_hist_edited_subject' => 'Perihal disunting',
	'lqt_hist_merged_from' => 'Balasan dipindah ke utas lain',
	'lqt_hist_merged_to' => 'Balasan dipindah dari utas lain',
	...
	'lqt_change_subject_edited' => 'Subjek utas ini telah diubah',
...
* Essere in conflitto con prefissi interwiki o nomi di namespace.",
	...
	'lqt_hist_comment_edited' => 'Commento modificato',
	...
	'lqt_hist_edited_subject' => 'Oggetto modificato',
...
* Et künnt sesch met enem Nahme för_e Appachtemang biiße.',
	...
	'lqt_hist_comment_edited' => 'Dä Täx vun dä Aanmärkung wood jeändert',
	...
	'lqt_hist_merged_from' => 'Di Antwoot es en ene andere {{int:lqt-history-thread}} jeschuve woode',
	'lqt_hist_merged_to' => 'Di Antwoot es vun enem andere {{int:lqt-history-thread}} noh heh jeschuve woode',
	...
	'lqt_change_subject_edited' => 'De Övverschreff vu heh dämm {{int:lqt-history-thread}} es jeändert woode',
...
* Се коси со интервики префикси или називи на именски простори.',
	...
	'lqt_subject_change_forbidden' => 'Не можете да го смените насловот на оваа нишка бидејќи не ви е дозволено да преместување страници.',
	'lqt_in_response_to' => 'Во одговор на $1 од $2, погоре:',
	'lqt_edited_notice' => 'Уредил',
	'lqt_reply' => 'Одговори',
	'lqt_delete' => 'Избриши',
	'lqt_undelete' => 'Врати',
	...
	'lqt_hist_comment_edited' => 'Уреден е текстот на коментарот',
	'lqt_hist_summary_changed' => 'Описот е променет',
	'lqt_hist_reply_created' => 'Создаден е нов одговор',
	...
	'lqt_hist_edited_subject' => 'Уреди наслов',
	'lqt_hist_merged_from' => 'Одговорот е преместен на друга нишка',
	'lqt_hist_merged_to' => 'Одговорот е преместен од друга нишка',
	...
	'lqt_change_subject_edited' => 'Насловот на нишката беше променет',
...
Наместо ова, можете да $2.',
	...
	'lqt-any-date' => 'Било кој датум',
	'lqt-only-date' => 'Само овие датуми:',
	'lqt-date-from' => 'Од',
	'lqt-date-to' => 'За',
	'lqt-title' => 'Наслов',
	'lqt-summary' => 'Опис',
...
Оваа операција е неповратна.',
	...
	'lqt-archive-subtitle' => 'Архив на разговори',
	'lqt-archive-intro' => 'Ова е архивот на разговорот за [[$1]].',
...
*അന്തർവിക്കി പൂർവ്വപദങ്ങളുമായോ നാമമേഖലകളുടെ പേരുകളുമായോ ആശയക്കുഴപ്പം സൃഷ്ടിക്കുന്നതാണ്.',
	...
	'lqt_newer' => '←പുതിയത്',
	'lqt_older' => 'പഴയത്→',
	'lqt_hist_comment_edited' => 'കുറിപ്പിന്റെ എഴുത്ത് തിരുത്തി',
...
* I konflikt med interwiki-forstavingar eller namn på namnerom',
	...
	'lqt_hist_edited_subject' => 'Endra enmne',
	'lqt_hist_merged_from' => 'Svar flytta til ein annan tråd',
	'lqt_hist_merged_to' => 'Svar flytta frå ein annan tråd',
	'lqt_hist_split_from' => 'Kløyv til ein ny tråd',
...
* koliduje z prefiksami interwiki lub przestrzeniami nazw.',
	...
	'lqt_in_response_to' => 'W odpowiedzi na $1 napisanej przez $2, powyżej:',
...
Ten wątek jest częścią $2.',
	...
	'lqt-any-date' => 'Każda data',
	'lqt-only-date' => 'Tylko w tych dniach:',
	'lqt-date-from' => 'Od',
	'lqt-date-to' => 'Do',
	'lqt-title' => 'Tytuł',
...
Ta operacja jest odwracalna.',
	...
	'lqt-archive-subtitle' => 'Archiwum dyskusji',
	'lqt-archive-intro' => 'To jest archiwum dyskusji strony [[$1]].',
	'lqt-history-time' => 'Data',
...
* Entrar em conflito com os prefixos das ligações interwikis ou nomes dos espaços nominais.',
	...
	'lqt_hist_merged_to' => 'Resposta movida de outro tópico',
...
* Estar em conflito com os prefixos das ligações interprojeto ou nomes dos espaços nominais.',
	...
	'lqt_subject_change_forbidden' => 'Você não pode alterar o assunto deste tópico porque você não está autorizado a mover páginas.',
...
* Xung đột với tiền tố liên wiki hay tên của không gian tên.',
	...
	'lqt_change_deleted' => '[$1 Luồng này] hay trả lời trong nó đã bị xóa',
	...
	'lqt_change_merged_from' => '[$1 Trả lời] trong luồng này được di chuyển đến luồng khác',
