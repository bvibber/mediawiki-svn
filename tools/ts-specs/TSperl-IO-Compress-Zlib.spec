...
Name:		TSperl-IO-Compress-Zlib
Summary:	IO::Compress::Zlib module for Perl
Version:	2.015
Source:		http://search.cpan.org/CPAN/authors/id/P/PM/PMQS/IO-Compress-Zlib-2.015.tar.gz
...
Requires: TSperl-Compress-Raw-Zlib
BuildRequires: TSperl
BuildRequires: TSperl-IO-Compress-Base
BuildRequires: TSperl-Compress-Raw-Zlib
