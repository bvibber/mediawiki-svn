...
class UsabilityInitiativeHooks {
	...
	private static $styleFiles = array(
		'base_sets' => array(
			...
			'combined' => array(
				array( 'src' => 'css/combined.css', 'version' => 75 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
			'minified' => array(
				array( 'src' => 'css/combined.min.css', 'version' => 75 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
		)
	);
	...
	private static $scriptFiles = array(
		...
		'base_sets' => array(
			'raw' => array(
				...
				array( 'src' => 'js/plugins/jquery.wikiEditor.highlight.js', 'version' => 38 ),
				...
				array( 'src' => 'js/plugins/jquery.wikiEditor.templateEditor.js', 'version' => 45 ),
				array( 'src' => 'js/plugins/jquery.wikiEditor.publish.js', 'version' => 3 ),
			),
			'combined' => array(
				array( 'src' => 'js/plugins.combined.js', 'version' => 316 ),
			),
			'minified' => array(
				array( 'src' => 'js/plugins.combined.min.js', 'version' => 316 ),
			),
		),
	);
