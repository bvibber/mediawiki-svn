...
$messages['be-tarask'] = array(
	'mibbit' => 'Чат Mibbit',
	'mibbit-desc' => 'Дадае [[Special:Mibbit|спэцыяльную старонку]] якая дазваляе зносіцца зь іншымі вікі-ўдзельнікамі ў рэжыме рэальнага часу',
	'mibbit-header' => 'Гэта спэцыяльная старонка дазваляе Вам узаемадзейнічаць у рэальным часе з іншымі вікі-удзельнікамі.
Каб далучыцца, проста націсьніце кнопку «Далучыцца».
Калі вы ўвайшлі ў сыстэму, Ваша імя ўдзельніка будзе выкарыстана па змаўчаньню.
Ананімныя ўдзельнікі атрымаюць аўтаматычна створаныя імёны, але іх можна будзе зьмяніць.',
	'right-mibbit' => 'Дазволена карыстацца чатам Mibbit',
);
