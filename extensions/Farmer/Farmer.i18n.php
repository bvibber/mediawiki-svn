...
Таксама будзе выкарысоўвацца ў прасторы назваў праекта і інтэрвікі-прыстаўка.',
...
Яно будзе выкарыстоўвацца ў сьпісе вікі.',
	...
	'farmer-notaccessible-test' => 'Гэта мажлівасьць даступна толькі на мацярынскай вікі фэрмы',
	'farmer-permissiondenied' => 'Доступ забаронены',
	'farmer-permissiondenied-text' => 'У Вас няма правоў выдаляць вікі з фэрмы',
	'farmer-permissiondenied-text1' => 'Вы ня маеце дазволу на доступ да гэтай старонкі',
	'farmer-deleting' => 'Вікі «$1» была выдалена',
	...
	'farmer-delete-text' => 'Калі ласка, выбярыце вікі якую Вы жадаеце выдаліць са сьпісу',
	...
	'farmer-basic-title1-text' => 'Вашая вікі ня мае загалоўка. Усталюйце яго <b>зараз</b>',
	'farmer-basic-description' => 'Апісаньне',
	'farmer-basic-description-text' => 'Увядзіце ніжэй апісаньне Вашай вікі',
	'farmer-basic-permission' => 'Правы',
	'farmer-basic-permission-text' => 'Карыстаючыся формай ніжэй, можна кіраваць правамі ўдзельнікаў гэтай вікі.',
...
Isto será amosado na lista dos wikis.',
	...
	'farmer-basic-permission-upload' => 'Cargar os ficheiros',
