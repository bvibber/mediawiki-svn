...
$messages['en'] = array(
	...
	'whitelistfor' => "<span style=\"text-align: center;\">Current information for <b>$1</b></span>",
...
You have to [[Special:UserRights|add users to the group]] before you can add pages to a user\'s white list.',
	...
	'whitelistnocalendar' => "<span class=\"error\">It looks like [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], a prerequisite for this extension, was not installed properly!</span>",
...
$messages['aln'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;"> informatat aktuale për <b>$1</b> </span>',
	...
	'whitelistnocalendar' => '<span class="error">Ajo duket si http://www.mediawiki.org/wiki/Extension:Usage_Statistics [Extension: UsageStatistics], një parakusht për këtë shtrirje, nuk është instaluar!</span>',
...
$messages['ar'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">المعلومات الحالية ل<b>$1</b></span>',
...
استخدم إما * أو % كحرف خاص',
  ...
  [[Special:UserRights|  يجب أن تضيف مستخدمين إلى هذه المجموعة]] قبل ان تستطيع إضافة صفحات إلى قائمة المستخدم البيضاء',
	...
	'whitelistnocalendar' => '<span class="error">يبدو أن [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics]، متطلب لهذه الامتداد، لم يتم تركيبه بشكل صحيح!</span>',
...
لازم [[Special:UserRights|تضيف يوزرز للجروب]] قبل ما تقدر تضيف صفحات لـ الليستة البيضا بتاعة اى يوزر.',
	...
	'whitelistpagelist' => 'صفحات {{SITENAME}} ل$1',
	'whitelistnocalendar' => '<span class="error"> الظاهر ان[http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics]، المطلوب للامتداد دا،ما اتستبش صح!</span>',
	'whitelistoverview' => '== مراجعة التغييرات ل$1 ==',
	'whitelistoverviewcd' => "* تغيير التاريخ إلى '''$1''' ل[[:$2|$2]]",
	'whitelistoverviewsa' => "* ضبط الدخول إلى '''$1''' ل[[:$2|$2]]",
	'whitelistoverviewrm' => '* إزالة الوصول إلى [[:$1|$1]]',
...
$messages['be-tarask'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Цяперашняя інфармацыя для <b>$1</b></span>',
...
Вам неабходна [[Special:UserRights|дадаць удзельнікаў у групу]] перад тым, як Вам можна будзе дадаваць старонкі ў белы сьпіс удзельнікаў.',
	...
	'whitelistnocalendar' => '<span class="error">Верагодна пашырэньне [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], якое патрабуецца для працы гэтага пашырэньня, не было ўсталявана адпаведным чынам!</span>',
...
$messages['bg'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Текуща информация за <b>$1</b></span>',
	...
	'whitelistnocalendar' => '<span class="error">Изглежда разширението [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], което е необходимо, не е инсталирано както трябва!</span>',
...
$messages['br'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Titouroù hegerz evit <b>$1</b></span>',
...
Ret eo deoc'h [[Special:UserRights|ouzhpennañ an implijer d'ar strollad]] a-raok gellout ouzhpennañ pajennoù da roll gwenn un implijer bennak.",
	...
	'whitelistnocalendar' => '<span class="error">Evit doare, n\'eo ket bet staliet ent reizh ar vodulenn [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], anezhi un astenn rekis a-raok ar staliañ!</span>',
...
$messages['bs'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Trenutne informacije za <b>$1</b></span>',
...
Morate da [[Special:UserRights|dodate korisnike u grupu]] prije nego što mognete dodavati stranice na dopušteni spisak korisnika.',
	...
	'whitelistnocalendar' => '<span class="error">Izgleda da [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Ekstenzija:Statisike korištenja], koja je neophodna za ovo proširenje, nije pravilno instalisana!</span>',
...
$messages['cs'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktuální informace pro <b>$1<b></span>',
...
Musíte [[Special:UserRights|do této skupiny přidat uživatel]] předtím, než budete moci přidávat stránky na bílou listinu uživatele.',
	...
	'whitelistnocalendar' => '<span class="error">Zdá sa, že není správně nainstalované rozšíření [http://www.mediawiki.org/wiki/Extension:Usage_Statistics UsageStatistics], které toto rozšíření vyžaduje.</span>',
...
$messages['de'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktuelle Information für <b>$1</b></span>',
...
Du musst [[Special:UserRights|Benutzer zu der Gruppe hinzufügen]] bevor du Seiten auf die Beobachtungsliste eines Benutzers setzen kannst.',
	...
	'whitelistnocalendar' => '<span class="error">[http://www.mediawiki.org/wiki/Extension:Usage_Statistics Die Extension:UsageStatistics], eine Vorraussetzung für diese Extension, wurde nicht installiert oder kann nicht gefunden werden!</span>',
...
$messages['dsb'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktualne informacije za <b>$1</b></span>',
...
Musyš [[Special:UserRights|kupce wužywarjow pśidaś]], pjerwjej až móžoš boki běłej lisćinje wužywarja pśidaś.',
	...
	'whitelistnocalendar' => '<span class="error">Zda se, až [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], wuměnjenje za toś to rozšyrjenje, njejo se pórědnje instalěrowalo!</span>',
...
$messages['el'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Τωρινές πληροφορίες για το <b>$1</b></span>',
...
Πρέπει να [[Special:UserRights|προσθέσετε χρήστες στην ομάδα]] πριν προσθέσετε σελίδες σε μια άσπρη λίστα ενός χρήστη.',
	...
	'whitelistnocalendar' => '<span class="error">Φαίνεται ότι το [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], προαπαιτούμενο για αυτή την επέκταση, δεν έχει εγκατασταθεί σωστά!</span>',
...
$messages['eo'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Nuna informo por <b>$1</b></span>',
...
$messages['es'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informacion actual para <b>$1</b></span>',
	'whitelisttablemodify' => 'Modifica',
...
Tienes que [[Special:UserRights|añadir usuarios al grupo]] antes de poder añadir páginas a una lista blanca de usuario.',
	...
	'whitelistnocalendar' => '<span class="error">¡Aparentemente la [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], requisito necesario para esta extensión, no ha sido instalada correctamente!</span>',
...
$messages['fr'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informations actuelles pour <b>$1</b></span>',
...
Vous devez [[Special:UserRights|ajouter l’utilisateur au groupe]] avant que vous puissiez ajouter des pages à la liste blanche d’un utilisateur.',
	...
	'whitelistnocalendar' => '<span class="error">Il semble que le module [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], une extension prérequise, n’ait pas été installé convenablement !</span>',
...
$messages['frp'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Enformacions d’ora por <b>$1</b></span>',
	...
	'whitelistnewpagesfor' => 'Apond de pâges novèles a la lista blanche de <b>$1</b><br />
Utilisar seye lo caractèro * ou ben %',
...
$messages['gl'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Información actual para <b>$1</b></span>',
...
Ten que [[Special:UserRights|engadir usuarios ao grupo]] antes de poder engadir páxinas á lista branca dun usuario.',
	...
	'whitelistnocalendar' => '<span class="error">Parece que [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], un requirimento previo para esta extensión, non foi instalada adecuadamente!</span>',
...
$messages['gsw'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktuälli Information fir <b>$1</b></span>',
...
Du muesch [[Special:UserRights|Benutzer zue dr Gruppe zuefiege]], voreb du Syte uf d Beobachtigslischt vun eme Benutzer chasch setze.',
	...
	'whitelistnocalendar' => '<span class="error">[http://www.mediawiki.org/wiki/Extension:Usage_Statistics D Extension:UsageStatistics], e Vorruussetzig fir die Extension, isch nit installiert wore oder cha nit gfunde wäre!</span>',
...
$messages['he'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">המידע הנוכחי אודות <b>$1</b></span>',
...
יהיה עליכם [[Special:UserRights|להוסיף משתמשים לקבוצה]] לפני שתוכלו להוסיף דפים לרשימה הלבנה של המשתמש.',
	...
	'whitelistnocalendar' => '<span class="error">נראה ש־[http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], דרישת קדם להרחבה זו, לא הותקנה כראוי!</span>',
...
$messages['hr'] = array(
	...
	'mywhitelistpages' => 'Moje stranice',
	'whitelistfor' => '<span style="text-align: center;">Trenutačne informacije za <b>$1</b></span>',
	'whitelisttablemodify' => 'Izmijeni',
	'whitelisttablemodifyall' => 'Sve',
...
Dyrbiš [[Special:UserRights|wužiwarjow skupinje přidać]], prjedy hač móžeš strony běłej lisćinje wužiwarja přidać.',
	...
	'whitelistnocalendar' => '<span class="error">Zda so, zo [http://www.mediawiki.org/wiki/Extension:Usage_Statistics rozšěrjenje:UsageStatistics], předpokład za tute rozšěrjenje, njeje so porjadnje instalował!</span>',
...
$messages['hu'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktuális információk ehhez: <b>$1</b></span>',
...
[[Special:UserRights|Felhasználókat kell adnod a csoporthoz]], mielőtt lapokat adhatnál a felhasználó engedélylistájához.',
	...
	'whitelistnocalendar' => '<span class="error">Úgy tűnik, hogy a [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics] – ami ennek a kiterjesztésnek előfeltétele – nincs megfelelően telepítve!</span>',
...
$messages['ia'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informationes actual pro <b>$1</b></span>',
	'whitelisttablemodify' => 'Modificar',
...
Tu debe [[Special:UserRights|adder usatores al gruppo]] ante que tu pote adder paginas al lista blanc de un usator.',
	...
	'whitelistnocalendar' => '<span class="error">Pare que [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], un prerequisito pro iste extension, non ha essite installate correctemente!</span>',
...
$messages['id'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informasi terkini untuk <b>$1</b></span>',
...
Anda harus [[Special:UserRights|menambahkan pengguna dalam kelompok itu]] sebelum Anda dapat menambahkan halaman ke daftar putih seorang pengguna.',
	...
	'whitelistnocalendar' => '<span class="error">Tampaknya [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], prasyarat bagi ekstensi ini tidak terinstal dengan benar!</span>',
...
$messages['it'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informazioni correnti per <b>$1</b> </span>',
	'whitelisttablemodify' => 'Modifica',
...
Devi [[Special:UserRights|aggiungere utenti al gruppo]] prima di poter aggiungere pagine alla whitelist di un utente.',
	...
	'whitelistnocalendar' => '<span class="error">Sembra che [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], un prerequisito per questa estensione, non è stata installata correttamente!</span>',
...
$messages['ja'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">現在の <b>$1</b> の情報</span>',
...
ワイルドカードとして * または % 記号を使います',
	...
	'whitelistnocalendar' => '<span class="error">本拡張機能の前提条件である、[http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics] のインストールが正しく行われていないようです。</span>',
...
$messages['jv'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informasi saiki kanggo <b>$1</b></span>',
...
Panjenengan kudu [[Special:UserRights|nambahaké panganggo jroning klompok]] sadurungé bisa nambah kaca ing dhaptar-putih panganggo.',
	...
	'whitelistnocalendar' => '<span class="error">Kaya-kaya [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], prasyarat kanggo èkstènsi iki, ora dipasang kanthi bener!</span>',
...
$messages['km'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">ព័ត៌មាន​បច្ចុប្បន្ន​សម្រាប់ <b>$1</b></span>',
...
$messages['ksh'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktoelle Enfomazjuhne för <b>$1</b></span>',
...
Sigge en de Oppaßleß fun esu enem Metmaacher don kanns.',
	...
	'whitelistnocalendar' => '<span class="error">Dä [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Zosatz <i lang="en">UsageStatistics</i>], weed för der [http://www.mediawiki.org/wiki/Extension:WhiteList Zosatz  <i lang="en">WhiteList</i>] jebruch, eß ävver nit enstalleett, udder wood nit jefonge!</span>',
...
$messages['lb'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktuell Informatioun fir <b>$1</b></span>',
...
Dir musst [[Special:UserRights|Benotzer an de Grupp derbäisetzen]] ier Dir Säiten anengem Benotzer seng white list derbäisetze kënnt.',
	...
	'whitelistnocalendar' => '<span class="error">Et gesäit aus wéi wann d\'[http://www.mediawiki.org/wiki/Extension:Usage_Statistics Erweiderung:Benotzerstatistiken], eng Viraussetzung fir dës Erweiderung, net richteg instqaléiert ass!</span>',
...
$messages['mk'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Моментални информации за <b>$1</b></span>',
...
$messages['ml'] = array(
	...
	'whitelistpagelist' => '{{SITENAME}} സം‌രംഭത്തിൽ $1ന്റെ താളുകൾ',
...
$messages['mr'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;"><b>$1</b>बद्दलची सध्याची माहिती</span>',
...
$messages['nl'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Huidige informatie voor <b>$1<b></span>',
...
$messages['nn'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Noverande informasjon for <b>$1</b></span>',
...
Du må [[Special:UserRights|legge brukarar til gruppa]] før du kan legge sider til ein brukar si kviteliste.',
	...
	'whitelistnocalendar' => '<span class="error">Det virkar som om [http://mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], ein føresetnad for denne utvidinga, ikkje har vorte installert skikkeleg.</span>',
...
$messages['oc'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Entresenhas actualas per <b>$1</b></span>',
	'whitelisttablemodify' => 'Modificar',
	'whitelisttablemodifyall' => 'Tot',
...
Vos cal [[Special:UserRights|apondre l’utilizaire al grop]] abans que posquèssetz apondre de paginas a la lista blanca d’un utilizaire.",
	...
	'whitelistnocalendar' => '<span class="error">Sembla que lo modul [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], una extension prerequesa, siá pas estada installada coma caliá !</span>',
...
$messages['pl'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktualne informacje na temat <b>$1<b></span>',
...
Musisz [[Special:UserRights|dodać użytkowników do tej grupy]] zanim będziesz mógł dodawać uprawnienia do stron użytkownikom.',
	...
	'whitelistnocalendar' => '<span class="error">Prawdopodobnie, wymagane do pracy tego modułu rozszerzenie [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics] nie zostało poprawnie zainstalowane.</span>',
...
$messages['pms'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Anformassion corente për <b>$1</b></span>',
...
A dev [[Special:UserRights|gionté j'utent ant la partìa]] prima ch'a peula gionté dle pàgine a la lista bianca ëd n'utent.",
	...
	'whitelistnocalendar' => '<span class="error">A smija che [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], un prerequisì për costa estension, a sia pa stàit anstalà për da bin!</span>',
...
$messages['pt'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Informação actual para <b>$1</b></span>',
	'whitelisttablemodify' => 'Modificar',
...
Tem de [[Special:UserRights|adicionar utilizadores ao grupo]] antes de poder adicionar páginas à lista branca de um utilizador.',
	...
	'whitelistnocalendar' => '<span class="error">Parece que [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], um pré-requisito para esta extensão, não foi instalada devidamente!</span>',
...
$messages['pt-br'] = array(
	...
	'whitelist' => 'Páginas na lista branca',
	'mywhitelistpages' => 'Minhas páginas',
	'whitelistfor' => '<span style="text-align: center;">Informação atual para <b>$1</b></span>',
	'whitelisttablemodify' => 'Modificar',
	'whitelisttablemodifyall' => 'Todos',
...
$messages['ru'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Актуальная информация для <b>$1</b></span>',
...
Прежде чем вы сможете добавить страницы участников в белый список, вы должны [[Special:UserRights|добавить участников в эту группу]].',
	...
	'whitelistnocalendar' => '<span class="error">По всей видимости, не было установлено расширение [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], от которого зависит данное расширение.</span>',
...
$messages['rue'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Актуална інформація про <b>$1</b></span>',
...
$messages['si'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">දැනට <b>$1</b></span>  සඳහා පවතින තොරතුරු',
...
ඔබ පරිශීලකයෙකුගේ ධවල ලැයිස්තුවට පිටු එකතු කිරීමට පෙර [[Special:UserRights|කණ්ඩායමට පරිශීලකයන් එකතු කිරීම]] ට ඔබට සිදුවේ.',
	...
	'whitelistnocalendar' => '<span class="error">මෙම දිඟුවට පූර්ව අවශ්‍යතාවයක් වූ  [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], නිවැරදිව පිහිටුවා නැති ලෙසින් පෙනේ!</span>',
...
$messages['sk'] = array(
	...
	'mywhitelistpages' => 'Moje stránky',
	'whitelistfor' => '<span style="text-align: center;">Aktuálne informácie pre <b>$1<b></span>',
...
Musíte [[Special:UserRights|pridať používateľov do tejto skupiny]] predtým, než budete môcť pridávať stránky na bielu listinu používateľa.',
	...
	'whitelistnocalendar' => '<span class="error">Zdá sa, že nie je správne nainštalované rozšírenie [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], ktoré toto rozšírenie vyžaduje.</span>',
...
$messages['stq'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktuelle Information foar <b>$1</b></span>',
...
Du moast [[Special:UserRights|Benutsere tou ju Gruppe bietouföigje]] eer du Sieden ap ju Beooboachtengslieste fon n Benutser sätte koast.',
	...
	'whitelistnocalendar' => '<span class="error">[http://www.mediawiki.org/wiki/Extension:Usage_Statistics Ju Extension:UsageStatistics], ne Bedingenge foar disse Extension, wuud nit installierd of kon nit fuunen wäide!</span>',
...
$messages['sv'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Nuvarande information för <b>$1<b></span>',
...
Du måste [[Special:UserRights|lägga till användare till gruppen]] innan du kan lägga till sidor till en användares vitlista.',
	...
	'whitelistnocalendar' => '<span class="error">Det verkar som [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics], en förutsättning för detta programtillägg, inte har installerats ordentligt!</span>',
...
$messages['szl'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktualne informacyje na tymat <b>$1</b></span>',
...
Muśisz [[Special:UserRights|dodać użytkowńikůw do tyj grupy]] ńim bydźesz můg dodować zajty do whitelisty użytkowńika.',
	...
	'whitelistnocalendar' => '<span class="error">Prawdopodobńy, wymogane do pracy tygo moduła rozszerzyńy [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Extension:UsageStatistics] ńy zostało poprowńy zainsztalowane.</span>',
...
$messages['te'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;"><b>$1</b> కొరకు ప్రస్తుత సమాచారం</span>',
...
$messages['tg-cyrl'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Иттилооти кунунӣ барои <b>$1</b></span>',
...
$messages['tg-latn'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Ittilooti kununī baroi <b>$1</b></span>',
...
$messages['tl'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Pangkasalukuyang kabatiran para sa/kay <b>$1</b></span>',
...
Kailangan mong [[Special:UserRights|magdagdag ng mga tagagamit sa pangkat]] bago ka makapagdag ng mga pahina sa "puting talaan" ng isang tagagamit.',
	...
	'whitelistnocalendar' => '<span class="error">Tila hindi nainstala/nailuklok ng tama ang [http://www.mediawiki.org/wiki/Extension:Usage_Statistics Karugtong:PaggamitEstadistika], na isang pangangailangan para sa karugtong (ekstensyon) na ito!</span>',
...
$messages['tr'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;"><b>$1</b> için mevcut bilgiler</span>',
...
$messages['uk'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Актуальна інформація для <b>$1</b></span>',
	'whitelisttablemodify' => 'Змінити',
...
$messages['vep'] = array(
	...
	'whitelistfor' => '<span style="text-align: center;">Aktualine informacii <b>$1</b>-kävutajan täht</span>',
