...
Name:		TSperl-Pod-Simple
Summary:	Pod::Simple module for Perl
Version:	3.07
Source:		http://search.cpan.org/CPAN/authors/id/A/AR/ARANDAL/Pod-Simple-%{version}.tar.gz
...
Requires: TSperl
Requires: TSperl-Pod-Escapes
BuildRequires: TSperl
BuildRequires: TSperl-Pod-Escapes
