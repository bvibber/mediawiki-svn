...
Выберыце калекцыю для экспарту. У моўным тэкставым полі, увядзіце сьпіс кодаў моваў ISO 639-3, падзелены коскамі. Пачніце з моваў з якіх Вы будзеце рабіць пераклад (пастаўце колькі пажадаеце) і скончыце мовамі, на якія Вы будзеце перакладаць. Потым націсьніце кнопку 'Стварыць' для стварыньня файла.</p>",
...
Калі ласка, паглядзіце [[{{MediaWiki:Ow editing policy url}}|нашы правілы рэдагаваньня]].',
	...
	'transaction' => 'ВікіЗьвесткі: Журнал апэрацый',
...
Калі ласка, зьвяжыцеся з адміністратарам сэрвэра.',
	...
	'ow_class_attr_type_xlate' => 'Тэкст, якія магчыма перакласьці',
...
$wdMessages['es'] = array(
	...
	'ow_importtsv_not_allowed' => 'No tiene permiso para hacer una exportación TSV',
	...
	'conceptmapping' => 'Wikidata: concepto de cartografía',
...
$wdMessages['fr'] = array(
	...
	'ow_importtsv_header' => "<p>Importer des definitions et des traductions depuis un fichier délimité par des tabulation qui peut être exporté depuis OpenOffice.org, Excel ou un autre logiciel.</p>
...
<p>Si la case « Test d'importation » est cochée, les actions seront rapportées, mais aucune modification ne sera effectuée. Vous êtes encouragé à faire un test avant l'import réel.</p>",
	...
	'ow_importtsv_import_failed' => "L'import a échoué",
	'ow_importtsv_file' => 'Fichier TSV :',
...
Soyez sûr que votre application a sauvegardé ou exporté le fichier correctement.</p>',
...
Les colonnes doivent être nomées « definition_iso » ou « translations_iso »,  
où iso est code de langue.</p>',
	'ow_importtsv_test_run_title' => "Test d'importation pour les données TSV",
	'ow_importtsv_nothing_added' => "Rien n'a été ajouté.",
	'ow_importtsv_nothing_added_test' => "Rien n'a été ajouté (vous avez fait un test d'importation).",
	'ow_importtsv_results' => '$1 {{PLURAL:$1|définition|définitions}} et $2 {{PLURAL:$2|traduction|traductions}} ont été ajoutées.',
...
Veuillez voir [[{{MediaWiki:Ow editing policy url}}|nos règles d'édition]].",
	...
	'ow_transaction_first_dm' => 'Première signification définie',
	'ow_transaction_second_dm' => 'Deuxième signification définie',
	'ow_transaction_summary' => 'Résumé',
	'conceptmapping' => 'Schéma conceptuel',
	'ow_conceptmapping_title' => 'Schéma conceptuel',
...
<li>&action=help  Voir l’aide complète.</li>
	...
	'ow_PopupAnnotation' => 'Annotation',
	'ow_RecordLifeSpan' => 'Enregistrer la durée de vie',
	'ow_Relations' => 'Relations',
	...
	'ow_history_transaction' => 'Transaction :',
	'ow_history_show_life_span' => "Afficher l'enregistrement de la durée de vie :",
	'ow_class_attr_type_dm' => 'Signification définie',
	...
	'needstranslation' => "Wikidata : L'expression nécessite une traduction",
...
Don ens noh dä Webaddress loore.',
	...
	'ow_AlternativeDefinition' => 'Bedüggdeniß eijmol anders explezeet',
	'ow_AlternativeDefinitions' => 'Bedüggdeniß paamol anders explezeet',
	...
	'ow_NewExactMeaning' => 'Neu akoraate Bedüggdeneß',
	'ow_OptionAttribute' => 'Eijeschaff',
	'ow_OtherDefinedMeaning' => 'Ander Bedüggdeniß',
...
Bes esu joot, un saach dat enem Wiki-Köbes, udder ennem Administrator fun däm Server.',
	'ow_class_attr_type_dm' => 'Faßjelaate un Beschrevve Bedüggdeniß',
...
<p>Se a caixa 'Testar execução' estiver seleccionada, quaisquer acções que fossem executadas são reportadas, mas nenhuma modificação é efectivamente feita. Você é encorajado a fazer um teste de execução antes de uma importação efectiva.</p>",
	'ow_importtsv_not_allowed' => 'Você não tem permissões para fazer uma importação de TSV.',
