...
$messages['ru'] = array(
	...
	'sortpermissions' => 'Сортировка разрешений',
	...
	'grouppermissions-desc4' => 'Позволить добавлять дополнительные элементы в Toolbox',
	...
	'grouppermissions-log-header' => 'Это страница, отслеживающая изменения в нижележащих разрешениях групп участников.',
	'grouppermissions-needjs' => 'Внимание. В вашем браузере отключён JavaScript. Некоторые функции могут не работать!',
	'grouppermissions-sp-header' => 'Вы можете использовать эту страницу для управления разрешениями исортировкой и добавлением новых разрешений. Наведите курсор мыши на разрешение, чтобы прочитать его описание',
