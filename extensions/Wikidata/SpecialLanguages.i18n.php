...
$wgLanguageManagerMessages['fr'] = array(
	...
	'ow_datasets'                           => 'Sélection de la base',
	'ow_noedit'                             => 'Vous n’avez pas la permission de modifier les pages dans la base "$1". Voyez [[Project:Permission policy|nos règles d’édition]].',
	'ow_noedit_title'                       => 'Pas de permission pour modifier',
	'ow_uipref_datasets'                    => 'Vue par défault',
	'ow_uiprefs'                            => 'Wikidata',
	'ow_none_selected'                      => '<Rien n’est sélectionné>',
	'ow_conceptmapping_help'                => '<p>actions possibles : <ul> <li>&action=insert&<data_context_prefix>=<defined_id>&... insérer un lien</li> <li>&action=get&concept=<concept_id> retrouver un lien/li> <li>&action=list_sets retourner une liste de préfixes de contextes de donnée possibles, et ce à quoi ils réfèrent.</li> <li>&action=get_associated&dm=<defined_meaning_id>&dc=<dataset_context_prefix> pour un sens défini dans un concept, retourner tous les autres</li> <li>&action=help Afficher l’aide.</li> </ul></p>',
	'ow_conceptmapping_uitext'              => '<p>Lier des concepts permet d’identifier les sens définis d’un jeu de données qui sont identique à des sens définis d’autres jeux de données.</p>',
	'ow_conceptmapping_no_action_specified' => 'Erreur, impossible de faire "$1".',
	'ow_dm_OK'                              => 'OK',
	'ow_dm_not_present'                     => 'Non présent',
	'ow_dm_not_found'                       => 'Non trouvé dans la base de données ou malformé',
	'ow_mapping_successful'                 => 'Tous les champs marqués par [OK] ont été liés<br>',
	'ow_mapping_unsuccessful'               => 'Il faut qu’il y ait au moins deux SensDéfinis avant de pouvoir les lier.',
	'ow_will_insert'                        => 'Insèrera le texte suivant :',
	'ow_contents_of_mapping'                => 'Ensemble des liens',
	'ow_available_contexts'                 => 'Contextes disponibles',
	'ow_add_concept_link'                   => "Lier vers d'autres concepts",
	'ow_concept_panel'                      => 'Gestion des concepts',
	'ow_dm_badtitle'                        => 'Cette page ne pointe vers aucun SensDéfini (concept). Vérifiez l’URL.',
	'ow_dm_missing'                         => 'Cette page pointe vers un SensDéfini (concept) non-existant. Vérifiez l’URL.',
	'ow_AlternativeDefinition'              => 'Définition alternative',
	'ow_AlternativeDefinitions'             => 'Définitions alternatives',
	'ow_Annotation'                         => 'Annotation',
	'ow_ApproximateMeanings'                => 'Sens approchés',
	'ow_ClassAttributeAttribute'            => 'Attribut',
