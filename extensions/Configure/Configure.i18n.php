...
$messages['ru'] = array(
	...
	'configure-ext-settings' => 'Настройки',
	'configure-ext-settings-dep-errors' => 'Это расширение не может быть включено со {{PLURAL:$1|следующей настройкой|следуюшими настройками}} с неприемлимым значением:',
...
Пожалуйста, создайте её и примените configure.sql или измените её имя.',
	'configure-db-table-error' => 'База данных, указанная вами, не имеет требуемых таблиц. Пожалуйста, примените configure.sql к этой базе данных.',
...
Пожалуйста, создайте её или используйте другую директорию.',
	...
	'configure-boolop-description-and' => 'Все условия должны быть правдой',
	'configure-boolop-description-or' => 'По крайней мере, одно условие должно быть правдой',
	'configure-boolop-description-xor' => 'Только одно условие должно быть правдой',
	'configure-boolop-description-not' => 'Условия не должны быть правдой',
