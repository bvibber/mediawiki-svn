...
{
	function SpecialWhosOnline() {
		SpecialPage::SpecialPage('WhosOnline');
	}
...
// simple special page name localization
function wfWhosOnlineLoadMessages() {
	...
	foreach($messages as $lang => $msg) {
		$wgMessageCache->addMessage('whosonline', $msg, $lang);
	}
}
