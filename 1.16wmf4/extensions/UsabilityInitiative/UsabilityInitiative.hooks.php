...
class UsabilityInitiativeHooks {
	...
	private static $styleFiles = array(
		'base_sets' => array(
			...
			'combined' => array(
				array( 'src' => 'css/combined.css', 'version' => 93 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
			'minified' => array(
				array( 'src' => 'css/combined.min.css', 'version' => 93 ),
				array( 'src' => 'css/vector/jquery-ui-1.7.2.css', 'version' => '1.7.2y' ),
			),
		)
	);
	...
	private static $scriptFiles = array(
		...
		'base_sets' => array(
			'raw' => array(
				...
				array( 'src' => 'js/plugins/jquery.autoEllipsis.js', 'version' => 10 ),
			...
			'combined' => array(
				array( 'src' => 'js/plugins.combined.js', 'version' => 407 ),
			),
			'minified' => array(
				array( 'src' => 'js/plugins.combined.min.js', 'version' => 407 ),
			),
		),
	);
