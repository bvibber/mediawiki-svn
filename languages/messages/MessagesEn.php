...
function on or the specified revision does not exist.',
...
'imghistlegend' => 'Legend: (cur) = this is the current file, (rev) = revert to this old version.
...
If a new page with the same name has been created since the deletion, the restored revisions will appear 
in the prior history.', 
...
'undelete-header' => 'See [[Special:Log/delete|the deletion log]] for recently deleted pages or revisions.',
