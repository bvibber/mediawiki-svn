...
* [[Special:Boardvote/dump|نسخة متخزنة من سجل الانتخابات]]',
	'boardvote_intro' => '<p>اهلا و سهلا بيك في انتخابات 2008 لمجلس امناء الويكيميديا.
احنا بنصوت لشخص واحد علشان يمثل اليوزرز في مشاريع الويكيميديا الكتيرة.
و هم ح يساعدو في تقرير الاتجاه اللي مشاريع الويكيميديا ح تمشى فيه في المستقبل, واحد واحد و كمجموعة, و ح يوصلو الاهتمامات و الانتقادات <em>بتاعتك</em> لملجلس الامناء.
المترشحين ح يقررو ازاي يوفرو الفلوس اللازمة للمشاريع و كمان ازاي يصرفوها.</p>

<p>لو سمحت تقرا الكلمات بتاعة المترشحين وردودهم على الاستفسارات كويس قبل ما تصوت.
المترشحين كلهم اصلا يوزرز محترمين, وساهمو بكتير من وقتهم و مجهودهم علشان يخلو المشاريع دي بيئه مناسبة و ملتزمة بنشر المعرفة الانسانية بلا حدود و البحث عنها.</p>

<p>لو سمحت تقيم المترشحين زي ما تحب عن طريق كتابة الارقام جنب الصناديق(1 = احسن مترشح, 2 = المترشح التاني, ...).
انت ممكن تدي نفس التقييم لاكتر من مترشح و كمان ممكن تسيبهم من غير تقييم خالص.
احنا ح نفترض انك بتفضل كل المترشحين اللي انت قيمتهم على المترشحين اللي ما اتقيموش، وانك مش فارق معاك باقى المرشحين اللي ما اتقيموش خالص .</p>

<p>الفوز في الانتخابات ح يتحسب بطريقة شولسيه. علشان تعرف معلومات اكتر, بص على صفحات الانتخابات الرسمية.</p>
...
<li><a href="http://en.wikipedia.org/wiki/Schulze_method" class="external">طريقة شولسيه</a></li></ul>',
	'boardvote_intro_change' => '<p>انت صوتت قبل كدا.بس ممكن تعدل التصويت بتاعك عن طريق الاستمارة اللي تحت.لو سمحت ترتب المترشحين على حسب تفضيلك ليهم,بحيث تدي اصغر رقم لاكتر واحد انت بترشحه.ممكن تدي نفس الرقم المتفضل لاكتر من مترشح و كمان ممكن تسيب اي مترشح من غير رقم خالص.</p>',
...
<pre>$2</pre>
دي هي النسخة المتشفرة اللي طلعت.[[Special:Boardvote/dump|عرض علنى]]
<pre>$3</pre>
[[Special:Boardvote/entry|رجوع]]',
