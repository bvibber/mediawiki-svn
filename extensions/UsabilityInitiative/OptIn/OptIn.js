...
$( document ).ready( function() {
	...
	/*
	 * We should probably refactor the code above and make it a jquery plugin 
		$.browser.name // String like "firefox"
		$.browser.versionNumber // Floating point number like 3.5
		$.os.name // String like "mac"
		// More info about usage: http://jquery.thewikies.com/browser
	*/
});