...
struct radix {
	...
	typedef pair<prefix, T> value_type;
...
private:
	...
	template<typename iterT> iterT _search(string const &) const;
	...
	template<typename iterT> iterT _search_exact(string const &) const;
...
iterT
radix<T>::_search(string const &s) const
{
...
template<typename iterT>
iterT
radix<T>::_search_exact(string const &s) const
{
...
template<typename T>
pair<typename radix<T>::iterator, bool>
radix<T>::insert (string const &s, T const &value)
{
