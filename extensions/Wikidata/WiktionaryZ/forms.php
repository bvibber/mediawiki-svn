...
function getSuggest($name, $query, $idField, $labelField) {
	...
	$result = '<div class="suggest"><input type="hidden" id="'. $name .'-suggest-query" value="'. $query .'"/><input type="hidden" id="'. $name .'" name="'. $name .'" value=""/><a id="'. $name .'-suggest-link" href="#" onclick="suggestLinkClicked(this);" title="Click to change selection">No selection</a></div>'.
               ...
               '<div><table><tr><td><input type="text" id="'. $name .'-suggest-text" autocomplete="off" onkeyup="suggestTextChanged(this)" style="width: 300px"></input></td><td><a id="'. $name .'-suggest-close" href="#" onclick="suggestCloseClicked(this)">[X]</a></td></tr></table></div>' .
