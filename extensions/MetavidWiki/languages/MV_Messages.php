...
Выберыце адну частку файла, каб рэдагаваньня яе',
	...
	'mv_error_stream_missing' => '<span class="error">Памылка: Не існуе відэа-файлаў зьвязаных з гэтым струменем.</span><br />
Калі ласка, паведаміце пра гэта адміністратару сайта.',
...
Альбо можаце <a href="$3">дадаць струмень</a>.',
	'mv_user_cant_edit' => 'Вы можаце $1 для рэдагаваньня, $2',
...
Enfommazjuhne als Aanmerkunge dobei don, die nit jekallt sin.',
	...
	'mv_sequence_edit_visual_editor' => 'Op dat Belscherremprojramm zom Beärbeide ömschallde',
...
Молимо Вас да пријавите ово администратору сајта.',
	...
	'mv_user_cant_edit' => 'Мораћете бити $1 да бисте правили измене, $2',
