...
'editingsection'=>'(секция)',
'editingcomment'=>'(комментарий)',
...
'val_max_topics' => 'Достигнут максимум ($1) вопросов для оценки.',
'val_no_topics_defined' => 'Вопросы для оценки не определены',
'val_no_topics_defined_text' => 'Нет вопросов для оценки. Перейдите на страницу [[Special:Validate]], и попросите администратора запустить функцию «Manage», чтобы добавить хотябы одну тему для оценки и возможный диапозон оценок.',
