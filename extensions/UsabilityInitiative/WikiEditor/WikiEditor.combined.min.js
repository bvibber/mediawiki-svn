...
$j(this).val($j(this).prev('label').text()).addClass('wikieditor-toolbar-dialog-hint').prev('label').css('display','none');}).focus(function(){if($j(this).val()==$j(this).prev('label').text())
$j(this).val('').removeClass('wikieditor-toolbar-dialog-hint');}).bind('blur change',function(){if($j(this).val()=='')
$j(this).val($j(this).prev('label').text()).addClass('wikieditor-toolbar-dialog-hint');});$j('#wikieditor-toolbar-link-int-target').bind('change keydown paste cut',function(){setTimeout(function(){if(isExternalLink($j('#wikieditor-toolbar-link-int-target').val()))
