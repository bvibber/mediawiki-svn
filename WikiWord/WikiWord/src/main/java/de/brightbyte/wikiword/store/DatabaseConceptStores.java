...
public class DatabaseConceptStores {
	...
	public static DatabaseWikiWordConceptStore<? extends WikiWordConcept> createConceptStore(DataSource db, DatasetIdentifier dataset, TweakSet tweaks, boolean allowCorpus, boolean allowThesaurus) throws PersistenceException {
		//XXX: UGLY HACK!
		try {
			...
			DatabaseWikiWordConceptStore<? extends WikiWordConcept> store;
