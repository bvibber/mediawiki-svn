...
$messages['ba'] = array(
	...
	'optin-title-feedback' => 'Баһалама ебәреү',
...
Һеҙ яңы интерфейс тураһында нимә уйлауығыҙҙы беҙҙең белгебеҙ килер ине, шуға күрә әгәр һеҙ түбәндә килтерелгән һорауҙарға яуап бирһәгеҙ, беҙ рәхмәтле булыр инек.',
	'optin-feedback-back' => 'Әгәр һорауҙарға яуап бирергә теләмәһәгеҙ, һеҙ $1 битенә ҡайта алаһығыҙ.',
	'optin-success-in' => 'Хәҙер һеҙ бета-версияны һынауҙа ҡатнашаһығыҙ. Программанан һеҙ теләгән ваҡытта, биттең өҫкө өлөшөндәге «{{int:optin-leave}}» һылтанмаһына баҫып, сыға алаһығыҙ.',
	'optin-leave-cancel' => 'Әгәр бета-версияны артабан ҡулланырға теләһәгеҙ, $1 битенә кире ҡайта алаһығыҙ.',
	'optin-success-out' => 'Һеҙ бета-версияны һынауҙы уңышлы тамамланығыҙ. Биттең өҫкө уң яҡ өлөшөндә урынлашҡан «{{int:optin-try}}» һылтанмаһына баҫып, һеҙ был версияны ҡабаттан һынап ҡарай алаһығыҙ.',
	'optin-success-feedback' => 'Баһаламағыҙ өсөн рәхмәт!',
	'optin-accept-short' => 'Киттек!',
	'optin-accept-long' => 'Бета-версияны һынарға',
	'optin-accept-long-anon' => 'Танылыу үтергә һәм бета-версияны һынарға',
	'optin-deny-short' => 'Юҡ, рәхмәт',
	'optin-deny-long' => 'Алдағы биткә ҡайтырға',
	'optin-submit-out' => 'Бета-версиянан сығырға',
	'optin-submit-feedback' => 'Баһалама ебәрергә',
	'optin-survey-yes' => 'Эйе',
	'optin-survey-no' => 'Юҡ',
...
তুমি যে-কোনো সময় পাতার গজর "{{int:optin-leave}}" লিংকহানাত ক্লিক করিয়া আগাকার অঙতাত যানা পাররাই।',
	'optin-leave-cancel' => 'নুৱা বৈশিষ্টহানি ব্যবহার করানি মনেইলে $1-হাত আলথকে যানা পাররাই।',
	'optin-success-out' => 'তর বেটা বেলিয়া যানা সুসারে ইল।
তি যে-কোনো সময় পাতাহার গজর "{{int:optin-try}}" লিংকর মা ক্লিক করিয়া বারো বেটাত আলথকে যানা পারর।',
	...
	'optin-survey-no' => 'না',
	'optin-survey-intro' => 'বেটাল হতনা করানির কা থাকাত।
আমার নুৱা ইন্টারফেসর বারে তর অনুভূতি আমি হারপানি মনারাঙ। আমি তুমারে উৎসাহ দেরাঙ, "[[#leave|{{int:optin-submit-out}}]]" লিংকহানাত ক্লিক করানির আগে তলর ঐচ্ছিক জরিপ ফর্মহান পূরণ করিক।',
	...
	'optin-improvements2' => '== কিতা কিতা উন্নয়ন করলাঙতা? ==
[[File:UsabilityToolbar.png|left|link=|এপাগার সালকরিসি পতানির টুলবারর স্ক্রিনশট আহান]]
[[File:UsabilityDialogs.png|left|link=|নুৱাকরে ডায়ালগ বাক্সরমা ইকা তিলকরানির স্ক্রিনশট আহান]]
;সালকরিসি টুলবার
নুৱা বারো সালকরিসি পতানির টুলবার ইকা পতানিহান নুঙি করে দিল।
নুৱা বারো সালকরিসি আইকন টুলহানি কিজাত কাম করের আরাকউ হবা বারো সেঙকরে সংজ্ঞায়িত করিসে।
উচ্চপর্যায়র পতানির কা লেপকরিসি তুপহান থিপকরিয়া থনা অসে। অহানে দরকারী সরঞ্জামঅতা নুঙি করে পানা একরের অসারে উচ্চপর্যায়র সরঞ্জামঅতা ক্লিক আকহান্নই নিকালানি একরের।
;ডায়ালগ
যেপাগা ইকা পাতার লিংক তিলকরানি নাইলে টেবিল তিলকররাই, অহাত লেপকরিসি আইকনর মা ক্লিক করলে ডায়ালগ বাক্স আগ নিকুলতই, যেহান নুঙি করিয়া ফর্ম পূরণর মা নিবন্ধ তিলকরানি বারো সাধারণ টেবিল তিলকরানিত পাঙকরতই।
;বারো আরাকউ
অতা বুলতেউ আরকউ কতহান উন্নয়নর লগে ফাঙনা করেদেরাঙ। অতার মা আসেতাই, সালকরিসি নেভিগেশন, খেইকরা ট্যাব, বিসারানির উন্নত সিজিল, বারো আরাকউ আবকচা।
== যেসাদে মিহিতাউ ==
ইউজাবিলিটি ইনিশিয়েটিভর বারে আরাকউ হারপিতে আমার [http://usability.wikimedia.org/wiki/Wikipedia_Usability_Initiative হোমপেজ]হান চেইক।
<div style="clear:both"></div>',
);
...
ھەرکاتێ کە بتەوێ دەتوانی بە کرتەکردنە سەر بەستەری "{{int:optin-try}}" لە سەرەوەی پەڕەکەدا، دیسان تاقی بکەیتەوە.',
	...
	'optin-survey-question-whyoptout' => 'بۆچی بێتا بەجێ دێڵیت؟ (تکایە ھەموو ئەوانەی دەگونجێن ھەڵبژێرە.)',
	...
	'optin-survey-answer-changes-edittools' => 'پەرەپێدان و پێشخستنی ئامێرەکانی دەستکاری.',
	'optin-survey-answer-changes-upload' => 'باشترکردنی بارکردنی کارستە و میدیاکان',
);
...
شما می‌توانید در هر زمان دیگر با کلیک کردن بر روی پیوند «{{int:optin-try}}» در بالای صفحه دوباره آن را امتحان کنید.',
	...
	'optin-survey-no' => 'نه',
	'optin-survey-intro' => 'تشکر از شما برای استفاده کردن از نسخهٔ آزمایشی
ما علاقه‌مندیم که بدانیم نظر شما در رابطه با واسط جدید چیست، به همین خاطر متشکر خواهیم شد اگر نظرخواهی اختیاری زیر را با کلیک بر «[[#leave|{{int:optin-submit-out}}]]» پاسخ دهید.',
	...
	'optin-survey-answer-whyoptout-didntlike-look' => 'من شیوهٔ نمایش آن را دوست ندارم.',
	...
	'optin-survey-question-explain' => 'لطفاً برای جواب‌تان در بالا به تفصیل توضیح دهید:',
	'optin-survey-question-techfail' => 'آیا در طول استفاده از بتا، به نقص فنی برخورده‌اید؟',
	'optin-survey-question-techfail-ifyes' => 'اگر بله، لطفاً واکاوی کرده یا شرح دهید',
	'optin-survey-question-usedtoolbar' => 'آیا از نوارابزار بسط‌پذیر برای ویرایش یک صفحه اسفاده کرده‌اید؟',
	'optin-survey-question-usedtoolbar-ifyes' => 'اگر بله، از چه چیز آن خوشتان آمد؟ از چه چیز آن خوشتان نیامد؟',
	'optin-survey-question-usedtoolbar-ifno' => 'اگر نه، چرا نه؟ آیا در آینده خواهید کرد؟ لطفاً شرح دهید.',
	...
	'optin-survey-answer-changes-nav' => 'ناوبری کلی وبگاه را برای استفاده آسان‌تر کن.',
...
$messages['krc'] = array(
	...
	'optin-intro' => 'Юзабилити башламчылыкъны юсю бла Википедияны хайырланыў тынчыракъ болурча талай иш этилгенди.
Бета-версияны сынаргъа сюемисиз?',
...
या नविन चेहरामोहर्‍याबद्दल आपणास काय वाटते हे आम्हास जाणुन घ्यायचे आहे,म्हणुन खालील ऎच्छीक सर्वेक्षण आपण भरुन दिल्यास आम्हाला ते आवडेल.',
	...
	'optin-success-out' => 'आपण बीटा यशस्वीरित्या त्यागली आहे.पानाचे वरचे बाजूस असणार्‍या "{{int:optin-try}}" या दुव्यावर टिचकी मारुन आपण यास कधीही परत वापरु शकता.',
	...
	'optin-survey-question-browser' => 'तुम्ही कोणता न्याहाळक (ब्राऊजर) वापरता ?',
 ...
 */
$messages['rue'] = array(
	'optin' => 'Участь в ініціатіви хосновательности',
	'optin-desc' => 'Доволює хоснователям спробовати Бета-верзію, найновше вылїпшіня хосновательности створена Ініціатівов хосновательности,',
	...
	'optin-intro' => 'Ініціатіва хосновательности Вікіпедії твердо робила на вылїпшіню хосновательности Вікіпедії.
Не хочете спробовати нашу Бета-верзію?',
	'optin-feedback-intro' => 'Дякуєме, же пробуєте Бета-верзію.
Хотїли бы сьме знати, што собі думаєте о нашім новім інтерфейсу, также оцїниме, кідь выповните волительне звідованя зображене ниже.',
	'optin-feedback-back' => 'Покы ся не хочете нашого звідованя зучастнити, можете ся вернути на сторінку $1.',
	'optin-success-in' => 'Теперь ся зучастните тестованя Бета-верзії.
З тестованя ся можете хоцьколи одголосити кликнутём на одказ „{{int:optin-leave}}“ во верхнїй части образовкы.',
	'optin-leave-cancel' => 'Покы хочете і далей хосновати Бета-верзію, можете ся вернути на сторінку $1.',
	'optin-success-out' => 'Успішно сьте опустили Бета-верзію.
Хоцьколи єй будете мочі знову спробовати кликнутём на одказ „{{int:optin-try}}“ во верьхнїй части образовкы.',
	'optin-success-feedback' => 'Дякуєме за ваш назор!',
	'optin-accept-short' => 'Іду до того!',
	'optin-accept-long' => 'Спробовати Бета-верзію',
	'optin-accept-long-anon' => 'Приголосити ся і спробовати Бета-верзію',
	'optin-deny-short' => 'Ніт, дякую',
	'optin-deny-long' => 'Вернути ся на попередню сторінку',
	'optin-submit-out' => 'Опустити Бета-верзію',
	'optin-submit-feedback' => 'Одослати назор',
	'optin-survey-yes' => 'Гей',
	'optin-survey-no' => 'Ніт',
	'optin-survey-intro' => 'Дякуєме, же пробуєте Бета-верзію.
Хотїли бы сьме знати, што собі о нашім новім інтерфейсу думаєте, также оціниме, кідь перед кликнутём на „[[#leave|{{int:optin-submit-out}}]]“ выповните неповинне звідованя зображене ниже.',
	'optin-survey-question-likedislike' => 'Што ся вам на Бета-верзії любило? Што ся вам на Бета-верзії не любило?',
	'optin-survey-question-whyoptout' => 'Чом хочете опустити Бета-верзію? (Выберте вшыткы релевантны причіны)',
	...
	'optin-survey-question-techfail' => 'Зазначіли сьте при хоснованю Бета-верзії даякы технічны тяжкости?',
	'optin-survey-question-techfail-ifyes' => 'Кідь гей, просиме уточните або поясните:',
	'optin-survey-question-usedtoolbar' => 'Хосновали сьте новый розгортовачій панел інштрументів про едітованя сторінок?',
	'optin-survey-question-usedtoolbar-ifyes' => 'Кідь гей, што ся вам на тім любило? Што ся вам на тім не любило?',
	'optin-survey-question-usedtoolbar-ifno' => 'Кідь нїт, так чом? Спробуєте то даколи в будучности? Просиме, поясните.',
	'optin-survey-question-different' => 'Што сьме могли зробити лїпше, жебы сьте не перестали хосновати Бета-верзію?',
	'optin-survey-question-feedback' => 'Просиме, напиште нам хоцьякы далшы коментарї, старости ці ідеї, котры нам хочете дати знати - хоцьяка одозва поможе:',
	...
	'optin-survey-question-changes' => 'Якы зміны бы сьте в будучности в Бета-верзії {{GENDER:|хотїв видїти|хотїла видїти|хотїли видїти}} (выберте вшыткы релевантны можности)?',
	'optin-survey-answer-changes-nav' => 'Зробити цілу навіґацію сайту простїшов в хоснованю.',
	'optin-survey-answer-changes-edittools' => 'Росшырити і здоконалити інштрументы едітованя.',
	'optin-survey-answer-changes-upload' => 'Здоконалити начітаваня файлів.',
	'optin-survey-answer-changes-richtext' => 'Вытворїня едітачных інштрументів аналоґічных текстовым едіторам.',
	'optin-survey-answer-changes-lookfeel' => 'Модернізовати взгляд і хованя сайту.',
	'optin-survey-answer-changes-predictability' => 'Здоконалити передвидательность выконности.',
	'optin-survey-answer-changes-custom' => 'Доволити веце хосновательскых наставлїнь.',
	'optin-survey-answer-changes-other' => 'Інше:',
	'optin-improvements2' => '== Што сьме вылїпшыли? ==
[[File:UsabilityToolbar.png|left|link=|Снимок образовкы зображуючій вылїпшеный едітачный панел інштрументів]]
[[File:UsabilityDialogs.png|left|link=|Снимок образовкы новый діалоґовых окен]]
;Вылїпшіня панелів інштрументів
Вылїпшеный панел інштрументів злегчує едітацію статей.
Новы і вылїпшены іконкы ясно означують, што котрый інштрумент робить.
Розгортуючі части панела зменшують безлад, притім менше хоснованы інштрументы суть доступны єдным кликом.
;Діалоґ
При вытваряню одказів або таблиць ся кликнутём на іконку інштрументу отворить діалоґове окно, котре вам посередництвом простого формулара поможе з творбов одказів і таблиць.
;І далшы
Пририхтовали сьме много далшых вылїпшінь, як є здоконалена навіґація, каскадовы заложкы, вылїпшене гляданя і іншы.
== Як ся запоїти ==
Кідь ся хочете о Ініціатіви хосновательности дізнати веце, навщівте [http://usability.wikimedia.org/wiki/Wikipedia_Usability_Initiative наш сайт].
<div style="clear:both"></div>',
);
...
Волели бисмо да знамо шта мислите о нашем новом интерфејсу, тако да би нам значило да испуните необавезну анкету испод пре него што кликнете „[[#leave|{{int:optin-submit-out}}]]“.',
	...
	'optin-survey-question-feedback' => 'Слободно нам пишите, ако имате било каквих других коментара, примедби или размишљања — свака повратна информација је добродошла!',
