<?PHP
	...
	class wikipediaquery {
		private $http;
		private $api;
		public $queryurl = 'http://rped.org/beta2/query.php'; //Obsolete, but kept for compatibility purposes.
	...
	class wikipediaapi {
		...
		private $edittoken;
		private $tokencache;
		public $apiurl = 'http://rped.org/beta2/api.php';
...
//				$data['revisions']['currentuser'] = $x['query']['userinfo']['currentuser']['name'];
	...
	class wikipediaindex {
		private $http;
		public $indexurl = 'http://rped.org/beta2/index.php';
