...
Sòn a sarà visualisà ant la lista dle wiki.",
	...
	'farmer-delete-text' => "Për piasì selession-a da la lista sota la wiki ch'it veule scanselé",
	'farmer-delete-form' => 'Selession-a na wiki',
	'farmer-delete-form-submit' => 'Scansela',
	'farmer-listofwikis' => 'Lista ëd wiki',
	'farmer-mainpage' => 'Pàgina Prinsipal',
	'farmer-basic-title' => 'Pràmetr base',
	'farmer-basic-title1' => 'Tìtol',
	'farmer-basic-title1-text' => "Toa wiki a l'ha pa un tìtol. Ampòstne un <b>adess</b>",
	'farmer-basic-description' => 'Descrission',
	'farmer-basic-description-text' => 'Ampòsta la descrission ëd toa wiki sota',
	'farmer-basic-permission' => 'Përmess',
	'farmer-basic-permission-text' => "An dovrand la forma sota, a l'é possìbil modifiché përmess për j'utent dë sta wiki-sì.",
	'farmer-basic-permission-visitor' => 'Përmess për minca visitador',
	'farmer-basic-permission-visitor-text' => "Ij përmess sota a saran aplicà a minca përson-a ch'a vìsita sta wiki-sì",
	'farmer-yes' => 'É!',
	'farmer-no' => 'Nò',
	'farmer-basic-permission-user' => 'Përmess për utent intrà',
	'farmer-basic-permission-user-text' => "Ij përmess sota a saran aplicà për minca përson--a che a l'é intrà an sta wiki-sì",
	'farmer-setpermission' => 'Ampòsta përmess',
	'farmer-defaultskin' => 'Strat ëd default',
	'farmer-defaultskin-button' => 'Ampòsta strat ëd default',
	'farmer-extensions' => 'Estension ative',
	'farmer-extensions-button' => 'Ampòsta estension ative',
	'farmer-extensions-extension-denied' => "It l'has pa ij përmess ëd dovré sta possibilità-sì.
It deuve esse un mémber ëd la partìa farmeradmin",
	'farmer-extensions-invalid' => 'Estension pa bon-a',
	'farmer-extensions-invalid-text' => "I podoma pa gionté l'estension përchè ël file selessionà për l'anclusion a peul pa esse trovà",
	'farmer-extensions-available' => 'Estension disponìbij',
	'farmer-extensions-noavailable' => 'Pa gnun-e estension registrà',
	'farmer-extensions-register' => 'Registra estension',
	'farmer-extensions-register-text1' => "Dòvra la forma sota për registré na neuva estension con la fatorìa.
Na vira che n'estension a l'é registrà, tute le wiki a podran dovrela.",
	'farmer-extensions-register-text2' => "Për ël paràmetr ''Anclud file'', ansëriss ël nòm dël file PHP com it veule an LocalSettings.php.",
	'farmer-extensions-register-text3' => "S'ël nòm file a conten '''\$root''', cola variàbil a sarà rimpiassà con la directory radis MediaWiki.",
	'farmer-extensions-register-text4' => "Al moment ij përcors d'anclud a son:",
	'farmer-extensions-register-name' => 'Nòm',
	'farmer-extensions-register-includefile' => 'Anclud file',
	'farmer-error-exists' => 'As peul pa creesse wiki. A esist già: $1',
	'farmer-error-noextwrite' => "As peul pa scrivse file d'estension:",
	'farmer-log-name' => 'Registr ëd fatorìa wiki',
	'farmer-log-header' => "Sto sì a l'é un registr fàit për la fatorìa wiki.",
	'farmer-log-create' => 'Creà la wiki "$2"',
	'farmer-log-delete' => 'scanselà la wiki "$2"',
	'right-farmeradmin' => 'Gëstiss la fatorìa wiki',
	'right-createwiki' => 'Crea wiki ant la fatorìa wiki',
);
